package("dav1d", function()
    ...
    add_urls(
        "https://downloads.videolan.org/pub/videolan/dav1d/$(version)/dav1d-$(version).tar.xz",
        "https://code.videolan.org/videolan/dav1d.git")

    add_versions("1.4.3",
                 "42fe524bcc82ea3a830057178faace22923a79bad3d819a4962d8cfc54c36f19")
    add_versions("1.1.0",
                 "fb57aae7875f28c30fb3dbae4a3683d27e2f91dde09ce5c60c22cef9bc58dfd1")
    add_versions("0.9.0",
                 "cfae88e8067c9b2e5b96d95a7a00155c353376fe9b992a96b4336e0eab19f9f6")
    ...
    on_install("!android and !wasm", function(package)
        ...
        table.insert(configs, "-Denable_tools=" ..
                         (package:config("tools") and "true" or "false"))
    ...
    on_test(function(package)
        ...
        assert(package:has_cfuncs("dav1d_default_settings",
