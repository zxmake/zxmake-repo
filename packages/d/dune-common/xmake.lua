package("dune-common", function()
    ...
    add_urls(
        "https://dune-project.org/download/$(version)/dune-common-$(version).tar.gz")
    add_versions("2.8.0",
                 "c9110b3fa350547c5e962c961905c6c67680471199ca41ed680489a0f30ffce9")
    ...
    on_install("macosx", "linux", function(package)
        ...
        table.insert(configs, "-DDUNE_ENABLE_PYTHONBINDINGS=" ..
