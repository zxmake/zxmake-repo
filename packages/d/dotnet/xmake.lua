package("dotnet", function()
    ...
    if is_host("windows") then
        if is_arch("x64") then
            ...
            set_urls(
                "https://download.visualstudio.microsoft.com/download/pr/$(version).zip",
                {
            ...
            add_versions("7.0.4",
                         "1cc74b279cffe42f757b3adeeeec87e351f0fb806016167ffb6b3842d4d6bcd5")
            add_versions("7.0.15",
                         "a158307a32caee886e24a2cc5114c3fba230f8c6173a1b707dc112ff377607b7")
            add_versions("8.0.1",
                         "2fa8eb34ce5a03a6fc606b35cfd6ff1d1ac36dfd35a4772d6a6ec1939de46244")
            add_versions("8.0.6",
                         "eb32b4332b10ad526ad64f58a6e904d16855e49bb38c51c863033c53ecea4a7d")
        elseif is_arch("arm64") then
            ...
            add_versions("7.0.4",
                         "5b2d8d381fc52379d25f5ccfa0882476b6003060682abf19fd96151a08d4298b")
            add_versions("7.0.15",
                         "272156f0cfc4752eaae580196eb0f3287c1c758c99a116a70062a2083cafa0bd")
            add_versions("8.0.1",
                         "feca0648fa200fd19ea3cb00266a76488d76880243b5c57bf9ecf9d91892ddfe")
            add_versions("8.0.6",
                         "9e77515ecc64e4a891109cc5da2a7bf57f4d534e0654b36636ada9bae79e487a")
        else
            local versions = {
            ...
            add_versions("7.0.4",
                         "8541bc89a12dac90ba1d6a7c1b6875b9314fc8af04602210be07daa16cfd5e9a")
            add_versions("7.0.15",
                         "77907f8db16228b04421bb8c63e89fa2c6d7e728c1e5cd0187b87d4aafa0acc0")
            add_versions("8.0.1",
                         "af9feebee04bc25ac2a0f98dc37c8808da4a9c7586c55de8aafafab2d2ad8b98")
            add_versions("8.0.6",
                         "04029a8f88f395a03497ae4542712eaec6d651f9eb4dc5727143b6c54fa7bda2")
        end
    elseif is_host("linux") then
        if is_arch("x64", "x86_64") then
            ...
            set_urls(
                "https://download.visualstudio.microsoft.com/download/pr/$(version).tar.gz",
                {
                    version = function(version)
                        return versions[tostring(version)]
                    end
            ...
            add_versions("7.0.4",
                         "405f15e437582be260460f48eda9dfe613fd87b2557667f20d6ecfa34b09c221")
            add_versions("7.0.15",
                         "db1f6226039313ceda561de803298fc6df0a0f34e1b214629225bb20e2c03e90")
            add_versions("8.0.1",
                         "3c61ffcee8947e0ead6196799d058e671b00bc6b983983f2bde5d29f702de2fe")
            add_versions("8.0.6",
                         "d237cf0e8865f51eb9634df32a8bcfb1dd95dac95c0d16b5d599df867ab16c27")
        elseif is_arch("arm64", "arm64-v8a") then
            ...
            add_versions("7.0.4",
                         "5a5d29f3f7515f6df888047eeb9571a2fa06b728a97e30536b1473d2abce0b32")
            add_versions("7.0.15",
                         "83b18606c055b528856ad5642828627542d339510f33155ff126bb2522a5c68d")
            add_versions("8.0.1",
                         "6e6d9c0d20e9b87247638eff4e66eccf04078ca956cecb9be53f155f44a2c508")
            add_versions("8.0.6",
                         "0e90d60a1759567fcfaf9b9efd1734603493a6ad562e40620e1d2df8ab120f8c")
        end
    elseif is_host("macosx") then
        if is_arch("x64", "x86_64") then
            ...
            add_versions("7.0.4",
                         "1531bfa7bf384f8b5c433d87af170f7839b130ea9c20b617aaf41742a13eefa9")
            add_versions("7.0.15",
                         "f8ff3c54f633e3f8dc0208c97b43a6ad53442a6139dbb11e6957129a7a20bf79")
            add_versions("8.0.1",
                         "cad53a19dd0ad86c814bbf24f8449e068ffbc3749a285e41b7b6e6004fa3881f")
            add_versions("8.0.6",
                         "0bd66f52ddf92efdbed459362fb807b30360a1f854144c84789e12607a35ea75")
        elseif is_arch("arm64") then
            local versions = {
            ...
            add_versions("7.0.4",
                         "7f8201d42d31d6985288d0e31a32aa3b1dff40fceb8cb202993c0b72883bcebb")
            add_versions("7.0.15",
                         "b1b822bc2e7041f7ed6708ec8a41d417f6fa1c962b051681cf36a91d6929fefa")
            add_versions("8.0.1",
                         "aa56166e43f19ab9a71bf1203a9028920f2f555d985f8f1fe0ed0fe221b109bd")
            add_versions("8.0.6",
                         "86a5a398a4f9c093a43687b93ac4c3a487b44e4193cc7155620a37dbc4476b87")
        end
    end

    on_install("windows|x86", "windows|x64", "windows|arm64", "linux|x64",
               "linux|x86_64", "linux|arm64", "linux|arm64-v8a",
               "macosx|x86_64", "macosx|x64", "macosx|arm64", function(package)
        local version_str = package:version_str()
        local out_path = "packs"
        if package:is_plat("windows") then
            local arch = package:is_arch("x64") and "x64" or
                             (package:is_arch("arm64") and "arm64" or "x86")
            out_path = path.join(out_path,
                                 "Microsoft.NETCore.App.Host.win-" .. arch,
                                 version_str, "runtimes", "win-" .. arch,
                                 "native")
        ...
        elseif package:is_plat("linux") then
            local arch = package:is_arch("arm64", "arm64-v8a") and "arm64" or
                             "x64"
            out_path = path.join(out_path,
                                 "Microsoft.NETCore.App.Host.linux-" .. arch,
                                 version_str, "runtimes", "linux-" .. arch,
                                 "native")
        ...
        elseif package:is_plat("macosx") then
            ...
            out_path = path.join(out_path,
                                 "Microsoft.NETCore.App.Host.osx-" .. arch,
                                 version_str, "runtimes", "osx-" .. arch,
                                 "native")
