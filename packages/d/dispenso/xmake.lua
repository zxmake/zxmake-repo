package("dispenso", function()
    ...
    add_urls(
        "https://github.com/facebookincubator/dispenso/archive/refs/tags/$(version).tar.gz",
        "https://github.com/facebookincubator/dispenso.git")

    add_versions("v1.3.0",
                 "824afe8d0d36bfd9bc9b1cbe9be89e7f3ed642a3612766d1c99d5f8dfc647c63")
    add_versions("v1.2.0",
                 "a44d9cf2f9234f5cbdbe4050fd26e63f3266b64955731651adf04dbb7f6b31df")
    add_versions("v1.1.0",
    ...
    on_install("windows|x64", "linux", "macosx", "bsd", "mingw", "msys",
        ...
        io.replace("dispenso/CMakeLists.txt", "Synchronization",
                   "Synchronization winmm", {plain = true})
