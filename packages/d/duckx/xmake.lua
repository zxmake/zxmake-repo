package("duckx", function()
    ...
    on_install("windows", "linux", "macosx", "mingw", function(package)
        ...
        io.replace("include/duckx.hpp", "<constants.hpp>", [["constants.hpp"]],
                   {plain = true})
        io.replace("include/duckx.hpp", "<duckxiterator.hpp>",
                   [["duckxiterator.hpp"]], {plain = true})
        io.replace("src/duckx.cpp", "zip_total_entries", "zip_entries_total",
                   {plain = true})
