package("davix", function()
    ...
    add_urls(
        "https://github.com/cern-fts/davix/releases/download/R_$(version).tar.gz",
        {
    ...
    add_versions("0.8.5",
                 "f9ce21bcc2ed248f7825059d17577876616258c35177d74fad8f854a818a87f9")
    ...
    on_install("macosx", "linux", function(package)
        local configs = {
            "-DDAVIX_TESTS=OFF", "-DEMBEDDED_LIBCURL=OFF", "-DLIB_SUFFIX="
        }
        table.insert(configs, "-DCMAKE_BUILD_TYPE=" ..
                         (package:debug() and "Debug" or "Release"))
        table.insert(configs, "-DSHARED_LIBRARY=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DSTATIC_LIBRARY=" ..
