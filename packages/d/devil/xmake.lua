package("devil", function()
    ...
    add_urls(
        "https://sourceforge.net/projects/openil/files/DevIL/$(version)/DevIL-$(version).zip")
    add_versions("1.8.0",
                 "451337f392c65bfb83698a781370534dc63d7bafca21e9b37178df0518f7e895")

    add_patches("1.8.0",
                path.join(os.scriptdir(), "patches", "1.8.0", "jp2.patch"),
                "cbee7e2a42b1a687fe7a2e6397611088fc2c16f897076e39db4a2be87fba5c51")
    add_patches("1.8.0",
                path.join(os.scriptdir(), "patches", "1.8.0", "static.patch"),
                "28a4fc42e9cc735a3291d87a1cb818ea9ed07f27afa2b52353d5a1d15fc8a6f5")
    ...
    for config, depopt in pairs(configdepopts) do
        add_configs(config, {
            description = "Build with " .. depopt[2] .. " support.",
            default = (config == "png"),
            type = "boolean"
        })
    end
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        for config, depopt in pairs(configdepopts) do
            table.insert(configs,
                         "-DCMAKE_DISABLE_FIND_PACKAGE_" .. depopt[2] .. "=" ..
