package("duilib_ultimate", function()
    set_homepage("https://github.com/qdtroy/DuiLib_Ultimate")
    set_description(
        "DuiLib_Ultimate is the Optimized version for duilib library")
    set_license("MIT")

    add_urls(
        "https://github.com/qdtroy/DuiLib_Ultimate/archive/refs/tags/$(version).tar.gz",
        "https://github.com/qdtroy/DuiLib_Ultimate.git")

    add_versions("0.3",
                 "4a650267e98d8b19818bdeb7675dcf1403017732b961620678e1d2d81f81db91")
