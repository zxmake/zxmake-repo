package("debugbreak", function()
    ...
    add_urls(
        "https://github.com/scottt/debugbreak/archive/refs/tags/$(version).tar.gz",
        "https://github.com/scottt/debugbreak.git")
    add_versions("v1.0",
                 "62089680cc1cd0857519e2865b274ed7534bfa7ddfce19d72ffee41d4921ae2f")
