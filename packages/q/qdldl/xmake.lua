package("qdldl", function()
    set_homepage("https://github.com/osqp/qdldl")
    set_description("A free LDL factorisation routine")
    set_license("Apache-2.0")

    add_urls(
        "https://github.com/osqp/qdldl/archive/refs/tags/$(version).tar.gz",
        "https://github.com/osqp/qdldl.git")

    add_versions("v0.1.7",
                 "631ae65f367859fa1efade1656e4ba22b7da789c06e010cceb8b29656bf65757")
    ...
    on_install(function(package)
        ...
        local configs = {
            "-DQDLDL_BUILD_DEMO_EXE=OFF", "-DCMAKE_POLICY_DEFAULT_CMP0057=NEW"
        }
        ...
        table.insert(configs, "-DQDLDL_BUILD_SHARED_LIB=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DQDLDL_BUILD_STATIC_LIB=" ..
