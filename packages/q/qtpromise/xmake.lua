package("qtpromise", function()
    ...
    add_urls(
        "https://github.com/simonbrunel/qtpromise/archive/refs/tags/$(version).tar.gz",
        "https://github.com/simonbrunel/qtpromise.git")

    add_versions("v0.7.0",
                 "dda94ad274f667c6f78f1aa0fcd4fc76190d290703c6c3183c2a8413177abc3f")
