package("miniball", function()
    set_kind("library", {headeronly = true})
    set_homepage(
        "https://people.inf.ethz.ch/gaertner/subdir/software/miniball.html")
    set_description(
        "For computing the smallest enclosing balls of points in arbitrary dimensions")
    set_license("GPL-3.0")

    add_urls(
        "https://github.com/xmake-mirror/miniball/archive/refs/tags/$(version).tar.gz",
        "https://github.com/xmake-mirror/miniball.git")
    add_versions("v3.0",
                 "8a7eedbae5619bc2b9ca9a249539008026f274886b0aeb3bb9796698b8763ba0")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = {"Miniball.hpp", "list", "vector"}
        }))
    end)
end)
