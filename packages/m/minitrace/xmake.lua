package("minitrace", function()
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DMTR_BUILD_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DMTR_ENABLED=" ..
                         (package:config("mtr") and "ON" or "OFF"))
