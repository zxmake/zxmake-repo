package("mongo-c-driver", function()
    ...
    add_versions("1.20.1",
                 "3a856e1c40b02fc5160cb7b39594d654f3076eeb671829b867971e7d35ed497c")
    add_versions("1.19.0",
                 "3e545964ee82ee60afe4213852208e6174297b19d6b837eca3c711af34a4b107")
    ...
    on_install("windows", "linux", "macosx", function(package)
        local configs = {
            "-DENABLE_AUTOMATIC_INIT_AND_CLEANUP=OFF", "-DENABLE_ICU=OFF",
        ...
        table.insert(configs, "-DENABLE_STATIC=" ..
                         (package:config("shared") and "OFF" or "BUILD_ONLY"))
        table.insert(configs, "-DENABLE_STATIC_BUILD=" ..
                         (package:config("shared") and "OFF" or "BUILD_ONLY"))
