package("mysqlpp", function()
    ...
    set_urls(
        "https://tangentsoft.com/mysqlpp/releases/mysql++-$(version).tar.gz")
    add_versions("3.3.0",
                 "449cbc46556cc2cc9f9d6736904169a8df6415f6960528ee658998f96ca0e7cf")
    ...
    on_install("windows", "mingw", function(package)
        ...
        os.cp(path.join("lib", "*.h"),
              package:installdir(path.join("include", "mysql++")))
    end)
