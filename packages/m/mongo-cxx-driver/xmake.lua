package("mongo-cxx-driver", function()
    ...
    add_urls(
        "https://github.com/mongodb/mongo-cxx-driver/archive/r$(version).zip")
    add_versions("3.6.6",
                 "4413de483c5070b48dc5b5c8ee3e32c8e7a2b74b892fe2a55ef78fb758bc01e0")
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        import("package.tools.cmake").install(package, configs, {
            cmake_build = true,
            config = (package:debug() and "Debug" or "Release")
        })
    end)
    ...
    on_test(function(package)
        assert(package:has_cxxfuncs("mongocxx::instance{nullptr}", {
            ...
            includes = "mongocxx/instance.hpp"
        }))
    end)
end)
