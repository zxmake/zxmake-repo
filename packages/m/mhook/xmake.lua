package("mhook", function()
    ...
    add_versions("2.5.1",
                 "37e7d65422a770b0a28835b4fe557823278f7118ff4a399d7acf345c8db318e5")

    add_patches("2.5.1",
                "https://github.com/apriorit/mhook/commit/5ccb00a9c89280bfff7ce595873a9923415172a7.patch",
    ...
    on_test(function(package)
        assert(package:has_cxxfuncs("Mhook_SetHookEx", {
            includes = {"windows.h", "mhook-lib/mhook.h"}
        }))
    end)
end)
