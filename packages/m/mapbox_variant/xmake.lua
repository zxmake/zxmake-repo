package("mapbox_variant", function()
    ...
    set_urls(
        "https://github.com/mapbox/variant/archive/f87fcbda9daf13fba47a6a889696b0ad23fc098d.tar.gz",
        "https://github.com/mapbox/variant/archive/refs/tags/$(version).tar.gz",
        "https://github.com/mapbox/variant.git")

    add_versions("2020.12.02",
                 "1c158fb10da5605060950eb8d2a87a3313d29e558576e35fd445653d863a0103")
    add_versions("v1.2.0",
                 "7059f4420d504c4bc96f8a462a0f6d029c5be914ba55cc030a0a773366dd7bc8")
