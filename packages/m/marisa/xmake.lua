package("marisa", function()
    ...
    add_versions("v0.2.6",
                 "8dc0b79ff9948be80fd09df6d2cc70134367339ec7d6496857bc47cf421df1af")

    add_deps("cmake")

    on_install("windows", "mingw", "linux", "macosx", "bsd", function(package)
        os.cp(path.join(package:scriptdir(), "port", "CMakeLists.txt"),
              "CMakeLists.txt")
    ...
    on_test(function(package)
        assert(package:has_cxxtypes("marisa::Trie", {
