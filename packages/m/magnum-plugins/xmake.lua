package("magnum-plugins", function()
    ...
    add_urls(
        "https://github.com/mosra/magnum-plugins/archive/refs/tags/$(version).zip",
        "https://github.com/mosra/magnum-plugins.git")
    add_versions("v2020.06",
                 "8e1e98674ef3f0276f68abbdfecef1d72ae95b5a812b78c1ff45dba10fc72e3f")
    ...
    add_configs("openddl", {
        description = "Build the OpenDdl library.",
        default = false,
        type = "boolean"
    })
    ...
    local plugins = {
        ...
        "drwavimporter", "faad2audioimporter", "freetypefont",
        "glslangshaderconverter", "harfbuzzfont", "icoimporter",
        "jpegimageconverter", "jpegimporter", "meshoptimizersceneconverter",
        "miniexrimageconverter", "openexrimageconverter", "openexrimporter",
        "opengeximporter", "pngimageconverter", "pngimporter",
    ...
    on_install("windows", "linux", "macosx", function(package)
        ...
        table.insert(configs, "-DWITH_OPENDDL=" ..
                         (package:config("openddl") and "ON" or "OFF"))
        for _, plugin in ipairs(plugins) do
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "Magnum/versionPlugins.h"
        }))
    end)
end)
