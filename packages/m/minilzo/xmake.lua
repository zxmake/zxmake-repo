package("minilzo", function()
    ...
    add_urls(
        "http://www.oberhumer.com/opensource/lzo/download/minilzo-$(version).tar.gz")
    add_versions("2.10",
                 "eb4ce543aad19533c83550746e0e9d7bcf716b35a42429e3ba17d60fa0f3e47a")
