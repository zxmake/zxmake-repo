package("makeself", function()
    ...
    add_urls(
        "https://github.com/megastep/makeself/archive/refs/tags/$(version).tar.gz",
        {
    ...
    add_versions("2.5.0",
                 "705d0376db9109a8ef1d4f3876c9997ee6bed454a23619e1dbc03d25033e46ea")
