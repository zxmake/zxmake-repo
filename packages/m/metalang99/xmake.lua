package("metalang99", function()
    ...
    add_urls(
        "https://github.com/Hirrolot/metalang99/archive/refs/tags/v$(version).tar.gz",
        "https://github.com/Hirrolot/metalang99.git")

    add_versions("1.13.2",
                 "912c6d91b872d34d2b6580d25afc38faccacf6c57462ab1c862010ff4afbf790")
    add_versions("1.13.3",
                 "91fe8d4edcc2e7f91c5b567a2b90f2e30c2373f1ebbabcf209ea0d74f63bc1e9")
