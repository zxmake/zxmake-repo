package("hidapi", function()
    ...
    add_urls(
        "https://github.com/libusb/hidapi/archive/refs/tags/hidapi-$(version).tar.gz",
        "https://github.com/libusb/hidapi.git")

    add_versions("0.14.0",
                 "a5714234abe6e1f53647dd8cba7d69f65f71c558b7896ed218864ffcf405bcbd")
    ...
    on_install("windows|x86", "windows|x64", "linux", "macosx", "mingw",
        ...
        local configs = {
            "-DHIDAPI_WITH_TESTS=OFF", "-DHIDAPI_BUILD_PP_DATA_DUMP=OFF",
        ...
        table.insert(configs, "-DHIDAPI_ENABLE_ASAN=" ..
