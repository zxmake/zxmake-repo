package("hdrhistogram_c", function()
    ...
    on_install("linux", "windows", "macosx", function(package)
        ...
        table.insert(configs, "-DHDR_HISTOGRAM_BUILD_STATIC=" ..
                         (package:config("shared") and "OFF" or "ON"))
        table.insert(configs, "-DHDR_HISTOGRAM_INSTALL_STATIC=" ..
                         (package:config("shared") and "OFF" or "ON"))
        table.insert(configs, "-DHDR_HISTOGRAM_BUILD_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DHDR_HISTOGRAM_INSTALL_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
    ...
    on_test(function(package)
        assert(
            package:has_cfuncs("hdr_init", {includes = "hdr/hdr_histogram.h"}))
    end)
end)
