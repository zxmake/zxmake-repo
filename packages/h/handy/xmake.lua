package("handy", function()
    set_homepage("https://github.com/yedf2/handy")
    set_description("A simple C++11 network server framework")
    set_license("BSD-2-Clause")

    add_urls(
        "https://github.com/yedf2/handy/archive/refs/tags/$(version).tar.gz",
        "https://github.com/yedf2/handy.git")
    add_versions("0.2.0",
                 "831d9e7cdf94d19fbc8438e75dc6c63fa75777ff2f83ac48df981c22e924a2d1")
    ...
    on_install("linux", "macosx", "iphoneos", function(package)
        ...
        table.insert(configs, "-DBUILD_HANDY_SHARED_LIBRARY=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DBUILD_HANDY_STATIC_LIBRARY=" ..
