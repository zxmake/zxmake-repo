package("hopscotch-map", function()
    ...
    add_versions("v2.3.1",
                 "0a77f4835379e74bb7a1c043f3b3c498272acca1c70b03dd5a0444fddf28b316")
    add_versions("v2.3.0",
                 "56ce4ff67215656065ee1a08948533baf9447c4440196ea5133c024856006938")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = {"tsl/hopscotch_map.h", "tsl/hopscotch_set.h"}
        }))
    end)
end)
