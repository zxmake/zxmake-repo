package("xcb-util-image", function()
    ...
    add_versions("0.3.8",
                 "3d7f6e3e7e73ca0d42154d360ad61a1e16fc62f6bb000f4e69c0d00305d1e00b")
    add_versions("0.3.9",
                 "ac7fa09eddc9ecda6fd872d32b6dc23d451a1c6c201873dfe7cac8362c87acf3")
    add_versions("0.4.0",
                 "cb2c86190cf6216260b7357a57d9100811bb6f78c24576a3a5bfef6ad3740a42")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("xcb_image_create",
                                  {includes = "xcb/xcb_image.h"}))
    end)
end)
