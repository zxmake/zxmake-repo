package("xtrans", function()
    ...
    add_versions("1.4.0",
                 "48ed850ce772fef1b44ca23639b0a57e38884045ed2cbb18ab137ef33ec713f9")
    ...
    on_install("macosx", "linux", "bsd", function(package)
        ...
        io.replace("Xtranslcl.c", "# include <sys/stropts.h>",
                   "# include <sys/ioctl.h>")
        import("package.tools.autoconf").install(package, configs)
    end)

    on_test(function(package)
        assert(package:has_ctypes("Xtransaddr",
                                  {includes = "X11/Xtrans/Xtrans.h"}))
    end)
end)
