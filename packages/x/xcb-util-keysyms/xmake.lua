package("xcb-util-keysyms", function()
    ...
    add_versions("0.3.8",
                 "99fcf9273f9866c1682bcf8a51df41296fe239e0f1df14f55350a33fd0e948b0")
    add_versions("0.3.9",
                 "9fda86f6a26be8872f33c10f47505c40c9305758d320b170aa976b7201533a42")
    add_versions("0.4.0",
                 "0807cf078fbe38489a41d755095c58239e1b67299f14460dec2ec811e96caa96")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("xcb_key_symbols_get_keycode",
                                  {includes = "xcb/xcb_keysyms.h"}))
    end)
end)
