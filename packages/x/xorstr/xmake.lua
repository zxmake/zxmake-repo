package("xorstr", function()
    ...
    add_urls(
        "https://github.com/JustasMasiulis/xorstr/archive/8ab293225374e16cbae9a54b6a1bed3ee0bf9681.tar.gz",
        "https://github.com/JustasMasiulis/xorstr.git")

    add_versions("2021.11.19",
                 "b52220a50c33f8b13e6aaa2fcd14f31a44d96ba721b014ab921c30b5e3cb61eb")
