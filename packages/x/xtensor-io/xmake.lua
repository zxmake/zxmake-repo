package("xtensor-io", function()
    ...
    add_urls(
        "https://github.com/xtensor-stack/xtensor-io/archive/refs/tags/$(version).tar.gz",
        "https://github.com/xtensor-stack/xtensor-io.git")
    add_versions("0.13.0",
                 "470bedee082adb0ef25ef7b54f9cfd3684e27b8489c42cf7980e0d90c14d04da")
