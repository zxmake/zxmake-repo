package("xframe", function()
    ...
    add_urls(
        "https://github.com/xtensor-stack/xframe/archive/refs/tags/$(version).tar.gz",
        "https://github.com/xtensor-stack/xframe.git")
    add_versions("0.3.0",
                 "1e8755b7a8b54dd8b7c7b65d99cc896e587ebf563c937f4aae1f73ad4f4c6be1")
    add_versions("0.2.0",
                 "0149f8dd5f38a6783544abca8abaadba45bab321fdcc0db0dd8b11148e1d741f")
