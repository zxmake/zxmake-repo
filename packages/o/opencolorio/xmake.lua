package("opencolorio", function()
    ...
    add_urls(
        "https://github.com/AcademySoftwareFoundation/OpenColorIO/archive/refs/tags/$(version).tar.gz",
    ...
    add_versions("v2.1.1",
                 "16ebc3e0f21f72dbe90fe60437eb864f4d4de9c255ef8e212f837824fc9b8d9c")
    ...
    on_install("windows", "macosx", "linux", function(package)
        local configs = {
            "-DOCIO_BUILD_APPS=OFF", "-DOCIO_BUILD_OPENFX=OFF",
