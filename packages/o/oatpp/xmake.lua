package("oatpp", function()
    ...
    add_urls(
        "https://github.com/oatpp/oatpp/archive/refs/tags/$(version).tar.gz",
        "https://github.com/oatpp/oatpp.git")

    add_versions("1.0.0",
                 "9ba7c75e3ada8ec894ec10beae712e775774a835fd3de89d8c34e17740202619")
    add_versions("1.2.5",
                 "36276e8b23e68ece1e6093c3f06fc80e3d42a5f4e47cdeef5e7e63f36eeddaad")
    add_versions("1.3.0",
                 "e1f80fa8fd7a74da6737e7fee1a4db68b4d7085a3f40e7d550752d6ff5714583")
    ...
    on_load(function(package)
        ...
        package:add("includedirs",
                    path.join("include", "oatpp-" .. version, "oatpp"))
