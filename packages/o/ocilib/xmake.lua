package("ocilib", function()
    ...
    add_urls(
        "https://github.com/vrogier/ocilib/archive/refs/tags/$(version).tar.gz",
        "https://github.com/vrogier/ocilib.git")

    add_versions("v4.7.6",
                 "43f5093cac645518ad5bc8d6f48f5b77e12372ef84dc87ddb3a54c40e425bd26")

    add_configs("unicode", {
        description = "Enable Unicode",
        default = true,
        type = "boolean"
    })
    ...
    on_install(function(package)
        ...
        io.replace("include/ocilibcpp/detail/core/SmartHandle.hpp",
                   ".Set<SmartHandle*>", ".template Set<SmartHandle*>",
                   {plain = true})
