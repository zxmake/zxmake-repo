package("oatpp-websocket", function()
    ...
    add_urls(
        "https://github.com/oatpp/oatpp-websocket/archive/refs/tags/$(version).tar.gz",
        "https://github.com/oatpp/oatpp-websocket.git")

    add_versions("1.0.0",
                 "2e4ed596d1e8c15f0b9c6d5ba994b8fde623a6dfd256a17c8f99d86427115981")
    add_versions("1.2.5",
                 "b930034aaed40715ccc9b9df094292ea6e2a44f31bf830d1e15db5255ece9184")
    add_versions("1.3.0",
                 "8215765238c595e296c9ea961670064ff9c44e3e0f9accda59d81b10cc29873b")
    ...
    on_load(function(package)
        package:add("includedirs", path.join("include",
                                             "oatpp-" .. package:version_str(),
                                             "oatpp-websocket"))
        package:add("linkdirs",
                    path.join("lib", "oatpp-" .. package:version_str()))
    end)
    ...
    on_install("linux", "macosx", "windows|x64", function(package)
        ...
        if package:is_plat("windows") then
            table.insert(configs, "-DOATPP_MSVC_LINK_STATIC_RUNTIME=" ..
