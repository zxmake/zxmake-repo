package("openldap", function()
    ...
    add_versions("2.5.7",
                 "ea9757001bc36295037f0030ede16810a1bb7438bbe8f871a35cc2a2b439d9ab")

    add_configs("tls", {
        description = "Set TLS/SSL support library.",
        default = "openssl",
        type = "string",
        values = {"openssl", "gnutls"}
    })
    add_configs("sasl", {
    ...
    on_install("linux", "macosx", function(package)
        ...
        table.insert(configs, "--with-cyrus-sasl=" ..
                         (package:config("sasl") and "yes" or "no"))
