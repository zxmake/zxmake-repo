package("opencl-clhpp", function()
    ...
    add_urls("https://github.com/KhronosGroup/OpenCL-$(version)", {
    ...
    on_test(function(package)
        assert(package:has_cxxtypes("cl::Platform", {
            configs = {languages = "c++14"},
            includes = (package:version():ge("2.0") and "CL/opencl.hpp" or
                "CL/cl.hpp")
        }))
    end)
end)
