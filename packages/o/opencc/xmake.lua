package("opencc", function()
    ...
    add_versions("1.1.2",
                 "b4a53564d0de446bf28c8539a8a17005a3e2b1877647b68003039e77f8f7d9c2")

    add_patches("1.1.2", path.join(os.scriptdir(), "patches", "1.1.2",
                                   "fix-static.patch"),
                "a51b58d5d092a057461bc8c7661546cde5c39af3c1f4438abc1d89e1a1df7122")
    ...
    on_install("windows", "mingw@windows,msys", "linux", "macosx", "bsd",
               function(package)
    ...
    on_test("windows", "mingw@windows,msys", "linux", "macosx", "bsd",
            function(package)
