package("openexr", function()
    ...
    add_urls(
        "https://github.com/AcademySoftwareFoundation/openexr/archive/refs/tags/$(version).tar.gz",
        "https://github.com/AcademySoftwareFoundation/openexr.git")
    add_versions("v3.3.0",
                 "58b00f50d2012f3107573c4b7371f70516d2972c2b301a50925e1b4a60a7be6f")
    add_versions("v3.2.4",
                 "81e6518f2c4656fdeaf18a018f135e96a96e7f66dbe1c1f05860dd94772176cc")
    add_versions("v3.2.3",
                 "f3f6c4165694d5c09e478a791eae69847cadb1333a2948ca222aa09f145eba63")
    add_versions("v2.5.3",
                 "6a6525e6e3907715c6a55887716d7e42d09b54d2457323fcee35a0376960bebf")
    add_versions("v2.5.5",
                 "59e98361cb31456a9634378d0f653a2b9554b8900f233450f2396ff495ea76b3")
    add_versions("v2.5.7",
                 "36ecb2290cba6fc92b2ec9357f8dc0e364b4f9a90d727bf9a57c84760695272d")
    add_versions("v3.1.0",
    ...
    add_versions("v3.1.4",
                 "cb019c3c69ada47fe340f7fa6c8b863ca0515804dc60bdb25c942c1da886930b")
    add_versions("v3.1.5",
    ...
    add_configs("build_both", {
        description = "Build both static library and shared library. (deprecated)",
        default = false,
        type = "boolean"
    })
    ...
    on_load("windows", "macosx", "linux", "mingw@windows", "mingw@msys",
            function(package)
        ...
        if ver:ge("3.0") then
            ...
            links = {
                "OpenEXRUtil", "OpenEXR", "OpenEXRCore", "IlmThread", "Iex"
            }
        else
            links = {
                "IlmImfUtil", "IlmImf", "IlmThread", "Imath", "Half", "IexMath",
                "Iex"
            }
        end
    ...
    on_install("macosx", "linux", "windows|x64", "windows|x86", "mingw@windows",
               "mingw@msys", function(package)
        local configs = {
            "-DBUILD_TESTING=OFF", "-DINSTALL_OPENEXR_EXAMPLES=OFF",
            "-DINSTALL_OPENEXR_DOCS=OFF", "-DOPENEXR_BUILD_UTILS=ON"
        }
        ...
        if package:version():ge("3.0") then
            if package:is_plat("windows") and package:version():le("3.1.4") then
                ...
                if vs_toolset then
                    ...
                    assert(tonumber(toolsetver) < 14.31,
                           "This version is incompatible with MSVC 14.31.")
                end
            end
