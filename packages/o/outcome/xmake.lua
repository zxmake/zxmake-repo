package("outcome", function()
    ...
    local hashes = {["v2.2.4"] = "90032f99503b4620f21d8160dc3af06fa343541f"}
    add_urls("https://github.com/ned14/outcome/releases/download/$(version)", {
        version = function(version)
            return format("%s/outcome-v2-all-sources-%s.tar.xz", version,
                          hashes[tostring(version)])
        end
    })
