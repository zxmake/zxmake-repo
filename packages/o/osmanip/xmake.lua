package("osmanip", function()
    ...
    add_urls(
        "https://github.com/JustWhit3/osmanip/archive/refs/tags/$(version).tar.gz",
        "https://github.com/JustWhit3/osmanip.git")
    add_versions("v4.6.1",
                 "5454cb0caced1fb9af90666001f2874786a33e6830024cb41c99a5b4ab966f1c")
    ...
    on_install(function(package)
        ...
        io.replace("CMakeLists.txt", "add_subdirectory( deps )", "",
                   {plain = true})
