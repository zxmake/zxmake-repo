package("openfbx", function()
    set_homepage("https://github.com/nem0/OpenFBX")
    set_description("Lightweight open source FBX importer")
    set_license("MIT")

    add_urls(
        "https://github.com/nem0/OpenFBX/archive/refs/tags/$(version).tar.gz",
        "https://github.com/nem0/OpenFBX.git")

    add_versions("v0.9",
                 "d6495e05d469bf2c51b860bb0518db6fb2ccf1df9a542a6b1c0f618202641e94")
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset and package:is_arch("arm.*") then
                ...
                assert(minor and minor >= 30,
                       "package(openfbx) deps(libdeflate/arm) requires vs_toolset >= 14.3")
            end
        end)
    end
