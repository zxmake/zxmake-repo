package("ois", function()
    ...
    add_versions("v1.5.1",
                 "614f6ef6d69cf6d84f1b50efff46a6c1acce426933e5f0dcf29862ea8332af73")
    ...
    elseif is_plat("windows", "mingw") then
        add_syslinks("dinput8", "dxguid", "ole32", "oleaut32", "user32", "uuid",
                     "xinput", "winmm")
    end

    on_install("windows", "linux", "macosx", function(package)
        local configs = {
            "-DOIS_BUILD_DEMOS=OFF", "-DCMAKE_POLICY_DEFAULT_CMP0057=NEW"
        }
        table.insert(configs, "-DCMAKE_BUILD_TYPE=" ..
                         (package:is_debug() and "Debug" or "Release"))
        table.insert(configs, "-DOIS_BUILD_SHARED_LIBS=" ..
