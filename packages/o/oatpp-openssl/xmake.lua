package("oatpp-openssl", function()
    ...
    add_urls(
        "https://github.com/oatpp/oatpp-openssl/archive/5925e8ba856fa71cda8937c4cb357508d4fdb3fb.tar.gz",
        "https://github.com/oatpp/oatpp-openssl.git")

    add_versions("1.3.0",
                 "540ab736ca8f7b8a89c23ad51655e038b59c6df8a08a60b95125843c9643a405")
