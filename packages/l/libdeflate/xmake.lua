package("libdeflate", function()
    ...
    add_urls(
        "https://github.com/ebiggers/libdeflate/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ebiggers/libdeflate.git")

    add_versions("v1.21",
                 "50827d312c0413fbd41b0628590cd54d9ad7ebf88360cba7c0e70027942dbd01")
    add_versions("v1.20",
    ...
    add_versions("v1.17",
                 "fa4615af671513fa2a53dc2e7a89ff502792e2bdfc046869ef35160fcc373763")
    add_versions("v1.19",
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset and package:is_arch("arm.*") then
                ...
                assert(minor and minor >= 30,
                       "package(libdeflate/arm): requires vs_toolset >= 14.3")
            end
        end)
    end
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DLIBDEFLATE_BUILD_STATIC_LIB=" ..
    ...
    on_test(function(package)
        assert(package:has_cfuncs("libdeflate_alloc_compressor",
