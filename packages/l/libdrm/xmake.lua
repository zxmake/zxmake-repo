package("libdrm", function()
    ...
    add_versions("2.4.118",
                 "a777bd85f2b5fc9c57f886c82058300578317cafdbc77d0a769d7e9a9567ab88")
    ...
    on_install("linux", function(package)
        local configs = {
            "-Dudev=true", "-Dvalgrind=disabled", "-Dman-pages=disabled",
