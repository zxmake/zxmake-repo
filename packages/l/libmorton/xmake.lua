package("libmorton", function()
    ...
    add_urls(
        "https://github.com/Forceflow/libmorton/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Forceflow/libmorton.git")

    add_versions("v0.2.12",
                 "48ec3e4ad1d9348052dcb64bff012ff95db226da3fec5522ae6e674fabbd686f")
