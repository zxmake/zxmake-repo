package("liblas", function()
    ...
    add_patches("1.8.1",
                path.join(os.scriptdir(), "patches", "1.8.1", "header.patch"),
                "fde1c186e78472f4eb8902f28b51b18a8b40166379c710b43f89323aac7c3afd")
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        io.replace("src/CMakeLists.txt", "${GDAL_LIBRARY}", "${PROJ_LIBRARIES}",
                   {plain = true})
        local configs = {
            "-DWITH_TESTS=OFF", "-DWITH_LASZIP=OFF", "-DWITH_GDAL=OFF",
            "-DBUILD_OSGEO4W=OFF", "-DBoost_USE_STATIC_LIBS=ON"
        }
