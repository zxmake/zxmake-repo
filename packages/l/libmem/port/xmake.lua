...
add_includedirs("external/llvm/include", "src/common", "internal", "src")

add_files("src/common/*.c", "src/common/*.cpp", "src/common/arch/*.c",
          "internal/demangler/*.cpp", "external/llvm/lib/Demangle/*.cpp")
