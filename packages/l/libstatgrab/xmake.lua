package("libstatgrab", function()
    ...
    add_urls(
        "https://github.com/libstatgrab/libstatgrab/releases/download/$(version).tar.gz",
        {
            version = function(version)
                return "LIBSTATGRAB_" .. version:gsub('%.', '_') ..
                           "/libstatgrab-" .. version
            end
        })

    add_versions("0.92.1",
                 "5688aa4a685547d7174a8a373ea9d8ee927e766e3cc302bdee34523c2c5d6c11")

    add_configs("thread_support", {
        description = "support for multi-threaded environments",
        default = true,
        type = "boolean"
    })
    ...
    on_install("macosx", "linux", function(package)
        local configs = {
            "--disable-statgrab", "--disable-saidar", "--disable-man",
            "--disable-tests"
        }
