...
if has_config("system-font-provider") then
    on_config(function(target)
        -- directwrite
        if target:is_plat("windows", "mingw") and
            target:has_cincludes("dwrite_c.h") then
        ...
        if target:is_plat("macosx") then
            if target:has_cfuncs("CTFontDescriptorCopyAttribute", {
...
add_headerfiles("libass/ass.h", "libass/ass_types.h",
                {prefix = "include/libass"})
