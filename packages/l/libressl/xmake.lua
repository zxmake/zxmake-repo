package("libressl", function()
    ...
    add_versions("3.4.2",
                 "cb82ca7d547336917352fbd23db2fc483c6c44d35157b32780214ec74197b3ce")
    add_versions("3.7.3",
                 "7948c856a90c825bd7268b6f85674a8dcd254bae42e221781b24e3f8dc335db3")
    add_versions("3.8.2",
    ...
    on_install("windows", function(package)
        ...
        table.insert(configs, "-DUSE_STATIC_MSVC_RUNTIMES=" ..
                         (package:config("vs_runtime"):startswith("MT") and "ON" or
                             "OFF"))
