package("libpopcnt", function()
    ...
    add_urls(
        "https://github.com/kimwalisch/libpopcnt/archive/refs/tags/$(version).tar.gz",
        "https://github.com/kimwalisch/libpopcnt.git")

    add_versions("v3.1",
                 "b4ea061f4c2e5385dff0dd032ad5a16c60dc0dd050391283afb463c0d62c19bd")
