package("libspectre", function()
    ...
    add_urls(
        "http://libspectre.freedesktop.org/releases/libspectre-$(version).tar.gz")
    add_versions("0.2.9",
                 "49ae9c52b5af81b405455c19fe24089d701761da2c45d22164a99576ceedfbed")
    ...
    on_install("macosx", "linux", function(package)
        ...
        if package:is_plat("macosx") then
            ...
            io.replace("configure", "have_libgs=no", "have_libgs=yes",
                       {plain = true})
        end
        local cppflags = {}
        local ldflags = {}
    ...
    on_test(function(package)
        assert(package:has_cfuncs("spectre_document_get_format",
                                  {includes = "libspectre/spectre.h"}))
    end)
end)
