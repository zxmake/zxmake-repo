package("liboqs", function()
    ...
    add_versions("0.11.0",
                 "f77b3eff7dcd77c84a7cd4663ef9636c5c870f30fd0a5b432ad72f7b9516b199")
    add_versions("0.10.1",
                 "00ca8aba65cd8c8eac00ddf978f4cac9dd23bb039f357448b60b7e3eed8f02da")
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset then
                ...
                assert(minor and minor >= 30,
                       "package(liboqs) require vs_toolset >= 14.3")
            end
        end)
    end

    on_install("!windows or windows|!arm64", function(package)
        io.replace(".CMake/compiler_opts.cmake", "add_compile_options(/MT)", "",
                   {plain = true})
        ...
        if package:is_plat("cross", "iphoneos") or
            (package:is_plat("mingw") and package:is_arch("i386")) then
        ...
        if package:is_plat("windows") and package:is_debug() then
            ...
            os.vcp(path.join(package:buildir(), dir, "*.pdb"),
                   package:installdir(dir))
        end
    end)
