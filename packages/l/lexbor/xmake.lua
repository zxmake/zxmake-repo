package("lexbor", function()
    ...
    add_urls(
        "https://github.com/lexbor/lexbor/archive/refs/tags/$(version).tar.gz",
        "https://github.com/lexbor/lexbor.git")

    add_versions("v2.2.0",
                 "0583bad09620adea71980cff7c44b61a90019aa151d66d2fe298c679b554c57d")
    add_versions("v2.3.0",
                 "522ad446cd01d89cb870c6561944674e897f8ada523f234d5be1f8d2d7d236b7")

    add_configs("thread", {
        description = "Build with Threads",
        default = false,
        type = "boolean"
    })
    ...
    on_install(function(package)
        local configs = {
            "-DLEXBOR_BUILD_EXAMPLES=OFF", "-DLEXBOR_BUILD_TESTS=OFF",
            "-DLEXBOR_BUILD_TESTS_CPP=OFF", "-DLEXBOR_INSTALL_HEADERS=ON"
        }
        ...
        table.insert(configs, "-DLEXBOR_WITHOUT_THREADS=" ..
                         (package:config("thread") and "OFF" or "ON"))
        import("package.tools.cmake").install(package, configs)
    end)

    on_test(function(package)
        assert(package:has_cfuncs("lxb_html_document_create", {
            includes = "lexbor/html/parser.h",
