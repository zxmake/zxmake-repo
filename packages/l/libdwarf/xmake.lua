package("libdwarf", function()
    ...
    add_versions("0.10.1",
                 "b511a2dc78b98786064889deaa2c1bc48a0c70115c187900dd838474ded1cc19")
    add_versions("0.10.0",
                 "17b7143c4b3e5949d1578c43e8f1e2abd9f1a47e725e6600fe7ac4833a93bb77")
    add_versions("0.9.2",
                 "c1cd51467f9cb8459cd27d4071857abc56191cc5d4182d8bdd7744030f88f830")
    add_versions("0.9.1",
    ...
    add_versions("0.8.0",
                 "771814a66b5aadacd8381b22d8a03b9e197bd35c202d27e19fb990e9b6d27b17")
    ...
    on_install("windows", "linux", "macosx", "mingw", function(package)
        ...
        table.insert(configs, "-DBUILD_NON_SHARED=" ..
        ...
        if package:is_plat("windows") then
            ...
            io.replace("src/lib/libdwarf/libdwarf_private.h",
                       "typedef long long off_t;", "#include <sys/types.h>",
                       {plain = true})
            io.replace("src/lib/libdwarf/libdwarf_private.h",
                       "typedef long off_t;", "#include <sys/types.h>",
                       {plain = true})
        end

        io.replace("CMakeLists.txt", "add_subdirectory(src/bin/dwarfdump)", "",
                   {plain = true})
    ...
    on_test(function(package)
        assert(package:has_cfuncs("dwarf_debug_addr_by_index",
                                  {includes = "libdwarf/libdwarf.h"}))
    end)
end)
