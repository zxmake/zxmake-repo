package("libgd", function()
    ...
    add_versions("2.3.2",
                 "dcc22244d775f469bee21dce1ea42552adbb72ba0cc423f9fa6a64601b3a1893")
    add_versions("github:2023.12.04", "58d25665be1c146e7284f253fa679e8256afa6cb")

    add_patches("2.3.2",
                path.join(os.scriptdir(), "patches", "2.3.2", "build.patch"),
                "87ae73df7ce126f8b31e1988aae3ecf0638eeb1c0a085689bd82045704c8171c")
    ...
    for conf, _ in pairs(configdeps) do
        add_configs(conf, {
            description = "Enable " .. conf .. " support.",
            default = (conf == "png"),
            type = "boolean"
        })
    end
    ...
    on_install("windows", "linux", "macosx", "mingw", function(package)
        local configs = {
            "-DBUILD_TEST=OFF", "-DBUILD_PROGRAMS=OFF", "-DBUILD_DOCS=OFF",
            "-DBUILD_EXAMPLES=OFF"
        }
