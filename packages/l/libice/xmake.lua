package("libice", function()
    ...
    add_versions("1.0.10",
                 "1116bc64c772fd127a0d0c0ffa2833479905e3d3d8197740b3abd5f292f22d2d")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("IceOpenConnection",
                                  {includes = "X11/ICE/ICElib.h"}))
    end)
end)
