package("libjpeg", function()
    ...
    add_versions("v9b",
                 "566241ad815df935390b341a5d3d15a73a4000e5aab40c58505324c2855cbbb8")
    add_versions("v9c",
                 "682aee469c3ca857c4c38c37a6edadbfca4b04d42e56613b11590ec6aa4a278d")
    add_versions("v9d",
                 "2303a6acfb6cc533e0e86e8a9d29f7e6079e118b9de3f96e07a71a11c082fa6a")
    add_versions("v9e",
    ...
    add_configs("headeronly", {
        description = "Install headerfiles only.",
        default = false,
        type = "boolean"
    })
    ...
    on_test(function(package)
        if package:config("headeronly") then
            ...
            assert(package:has_cfuncs("jpeg_create_compress(0)",
                                      {includes = {"stdio.h", "jpeglib.h"}}))
        end
    end)
end)
