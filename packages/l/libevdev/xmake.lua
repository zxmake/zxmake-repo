package("libevdev", function()
    ...
    add_urls(
        "https://gitlab.freedesktop.org/libevdev/libevdev/-/archive/libevdev-$(version)/libevdev-libevdev-$(version).tar.gz")
    add_versions("1.13.1",
                 "438a9060dca43a305f75a590624412d1f858a908d4807433c67c58770f676a47")

    add_includedirs("include/libevdev-1.0")

    add_deps("meson", "ninja", "pkg-config")
    on_install("linux", function(package)
        import("package.tools.meson").build(package, {
