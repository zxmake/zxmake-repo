package("linux-headers", function()
    ...
    add_versions("5.0.8",
                 "11908044e8cce1e093141f8da594708d45d05d0381676ae9aa3d8aeaf7c85435")
    add_versions("5.9.16",
                 "b0d7abae88e5f91893627c645e680a95c818defd1b4fcaf3e2afb4b2b6b4ab86")
    add_versions("5.10.46",
                 "569122a39c6b325befb9ac1c07da0c53e6363b3baacd82081d131b06c1dc1415")
    add_versions("5.16.9",
                 "1660e7228ec299c187c19739d115ded97f6b1be05a24986c4c443e7c5e8b744f")
    add_versions("5.15",
    ...
    add_configs("driver_modules", {
        description = "Enable driver modules files.",
        default = false,
        type = "boolean"
    })
    ...
    on_load(function(package)
        if package:config("driver_modules") then
            ...
            package:add("deps", "openssl", "elfutils",
    ...
    on_fetch(function(package, opt)
        if opt.system and not package:is_cross() then
            ...
            local linux_headersdir = find_path("include/linux",
                                               "/usr/src/linux-headers-*")
            if linux_headersdir then
                -- parse version, linux-headers-5.11.0-41-generic, linux-headers-5.11.0-41
                local version = path.filename(linux_headersdir):match(
                                    "linux%-headers%-(%d+%.%d+%.%d+).*")
                return {
                    includedirs = path.join(linux_headersdir, "include"),
                    version = version
                }
            end
        end
    ...
    on_install("linux", "cross", function(package)
        ...
        if package:config("driver_modules") then
            ...
            if package:is_plat("cross") then
                ...
                make.make(package, {
                    "ARCH=" .. arch, "CROSS_COMPILE=" .. cross, "allyesconfig"
                }, {curdir = installdir})
                make.make(package, {
            ...
            os.vrunv("make", {
                "headers_install", "INSTALL_HDR_PATH=" .. package:installdir()
            })
        end
    end)
