package("libpaper", function()
    ...
    add_urls(
        "http://deb.debian.org/debian/pool/main/libp/libpaper/libpaper_$(version).tar.gz")
    add_versions("1.1.28",
                 "c8bb946ec93d3c2c72bbb1d7257e90172a22a44a07a07fb6b802a5bb2c95fddc")
    ...
    on_install("macosx", "linux", function(package)
        ...
        if libtool then
            os.vrunv("autoreconf", {
                "--install", "-I" .. libtool:installdir("share", "aclocal")
            })
        else
