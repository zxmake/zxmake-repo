package("loguru", function()

    set_homepage("https://github.com/emilk/loguru")
    set_description("A lightweight C++ logging library")

    add_urls(
        "https://github.com/emilk/loguru/archive/refs/tags/$(version).tar.gz",
        "https://github.com/emilk/loguru.git")
    add_versions("v2.1.0",
                 "1a3be62ebec5609af60b1e094109a93b7412198b896bb88f31dcfe4d95b79ce7")
    ...
    add_configs("fmt", {
        description = "Use fmt to format the log.",
        default = false,
        type = "boolean"
    })
