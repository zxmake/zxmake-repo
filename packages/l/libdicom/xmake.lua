package("libdicom", function()
    set_homepage("https://libdicom.readthedocs.io")
    set_description("C library for reading DICOM files")
    set_license("MIT")

    add_urls(
        "https://github.com/ImagingDataCommons/libdicom/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ImagingDataCommons/libdicom.git")

    add_versions("v1.1.0",
                 "a0ab640e050f373bc5a3e1ec99bee7d5b488652340855223a73002181b094ae8")
