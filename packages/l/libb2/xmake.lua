package("libb2", function()
    set_homepage("https://blake2.net")
    set_description("C library providing BLAKE2b, BLAKE2s, BLAKE2bp, BLAKE2sp")
    set_license("CC0-1.0")

    add_urls(
        "https://github.com/BLAKE2/libb2/archive/643decfbf8ae600c3387686754d74c84144950d1.tar.gz",
        "https://github.com/BLAKE2/libb2.git")

    add_versions("v0.98.1",
                 "9eb776149c41a34619e801adeae8056ca68faadc7cea3a68a54b2a4d93ef1937")
