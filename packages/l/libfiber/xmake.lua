package("libfiber", function()
    ...
    add_urls(
        "https://github.com/iqiyi/libfiber/archive/refs/tags/$(version).tar.gz",
        {
    ...
    add_versions("v0.9.0+0",
                 "9359a7ebc8d9c48cfaa4c7d1445b3a3e1c392a238574f1d4f7c1191ec8242af2")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("acl_fiber_create",
                                  {includes = "fiber/lib_fiber.h"}))
    end)
end)
