package("libigl", function()
    ...
    add_urls(
        "https://github.com/libigl/libigl/archive/refs/tags/$(version).tar.gz",
        "https://github.com/libigl/libigl.git")
    add_versions("v2.2.0",
                 "b336e548d718536956e2d6958a0624bc76d50be99039454072ecdc5cf1b2ede5")
    add_versions("v2.3.0",
                 "9d6de3bdb9c1cfc61a0a0616fd96d14ef8465995600328c196fa672ee4579b70")
    add_versions("v2.4.0",
                 "f3f53ee6f1e9a6c529378c6b0439cd2cfc0e30b2178b483fe6bea169ce6deb22")
    add_versions("v2.5.0",
                 "1d9d8c3a3a6a269cf22612bbe24d7fd1c5f84838231d299d712969ad294f945f")

    add_resources("2.x", "libigl_imgui",
                  "https://github.com/libigl/libigl-imgui.git",
                  "7e1053e750b0f4c129b046f4e455243cb7f804f3")
    ...
    add_configs("cgal", {
        description = "Use CGAL library.",
        default = false,
        type = "boolean"
    })
    add_configs("imgui", {
        description = "Use imgui with libigl.",
        default = false,
        type = "boolean"
    })
    add_configs("embree", {
        description = "Use embree library.",
        default = false,
        type = "boolean"
    })
    ...
    on_install("macosx", "linux", "windows", "mingw", function(package)
        if package:config("imgui") then
            ...
            os.cp(path.join(igl_imgui_dir, "imgui_fonts_droid_sans.h"),
        ...
        local configs = {
            "-DLIBIGL_BUILD_TESTS=OFF", "-DLIBIGL_BUILD_TUTORIALS=OFF",
        ...
        if package:is_plat("windows") then
            table.insert(configs, "-DIGL_STATIC_RUNTIME=" ..
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = {"igl/cotmatrix.h", "Eigen/Dense", "Eigen/Sparse"}
        }))
        ...
        if package:config("imgui") then
            assert(package:check_cxxsnippets({
                ...
                configs = {languages = "c++14"},
                includes = {
                    "igl/opengl/glfw/Viewer.h", "Eigen/Dense", "Eigen/Sparse"
                }
            }))
        end
        ...
        if package:config("embree") then
            assert(package:check_cxxsnippets({
                ...
                configs = {languages = "c++14"},
                includes = {
                    "igl/embree/EmbreeIntersector.h", "igl/Hit.h",
