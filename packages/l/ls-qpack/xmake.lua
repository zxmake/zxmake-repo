package("ls-qpack", function()
    set_homepage("https://github.com/litespeedtech/ls-qpack")
    set_description("QPACK compression library for use with HTTP/3")
    set_license("MIT")

    add_urls(
        "https://github.com/litespeedtech/ls-qpack/archive/refs/tags/$(version).tar.gz",
        "https://github.com/litespeedtech/ls-qpack.git")

    add_versions("v2.5.5",
                 "8770435b81d13616cf952bd361ec0e6e0fd79acff76dd9f6e75c18fd88b4c4f4")
    add_versions("v2.5.4",
                 "56b96190a1943d75ef8d384b13cd4592a72e3e2d84284f78d7f8adabbc717f3e")
    add_versions("v2.5.3",
    ...
    on_install(function(package)
        ...
        local configs = {
            "-DLSQPACK_TESTS=OFF", "-DLSQPACK_BIN=OFF", "-DLSQPACK_XXH=OFF",
