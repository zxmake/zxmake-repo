package("libfyaml", function()
    ...
    add_urls(
        "https://github.com/pantoniou/libfyaml/archive/refs/tags/$(version).tar.gz",
    ...
    on_install("linux", "macosx", "android", "iphoneos", "cross",
               function(package)
        if package:is_plat("android") then
            ...
            assert(ndk_sdkver and tonumber(ndk_sdkver) > 21,
                   "package(libfyaml): need ndk api level > 21 for android")
        end
