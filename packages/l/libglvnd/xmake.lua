package("libglvnd", function()

    set_homepage("https://gitlab.freedesktop.org/glvnd/libglvnd")
    set_description("libglvnd: the GL Vendor-Neutral Dispatch library")

    add_urls(
        "https://gitlab.freedesktop.org/glvnd/libglvnd/-/archive/$(version)/libglvnd-$(version).tar.gz",
        "https://gitlab.freedesktop.org/glvnd/libglvnd.git")
    add_versions("v1.3.4",
                 "c42061da999f75234f9bca501c21144d9a5768c5911d674eceb8650ce3fb94bb")
