package("llhttp", function()
    set_homepage("https://github.com/nodejs/llhttp")
    set_description("Port of http_parser to llparse")
    set_license("MIT")

    add_urls(
        "https://github.com/nodejs/llhttp/archive/refs/tags/release/$(version).tar.gz")

    add_versions("v9.2.1",
                 "3c163891446e529604b590f9ad097b2e98b5ef7e4d3ddcf1cf98b62ca668f23e")
    add_versions("v8.1.0",
                 "9da0d23453e8e242cf3b2bc5d6fb70b1517b8a70520065fcbad6be787e86638e")
    add_versions("v3.0.0",
                 "02931556e69f8d075edb5896127099e70a093c104a994a57b4d72c85b48d25b0")
    ...
    on_install(function(package)
        ...
        if not package:config("shared") then
            io.replace("include/llhttp.h", "__declspec(dllexport)", "",
                       {plain = true})
        end
        ...
        if package:config("shared") then
            io.replace(package:installdir("include/llhttp.h"),
