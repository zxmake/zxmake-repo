package("libfork", function()
    ...
    add_urls(
        "https://github.com/ConorWilliams/libfork/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ConorWilliams/libfork.git")

    add_versions("v3.8.0",
                 "53f23f0d27bb0753c0b03132f3c17bf8099617f037a2389a04e85fdd6f2736e8")
