package("libmetalink", function()
    ...
    on_install("windows", "linux", "macosx", "android", "mingw", "cross",
               function(package)
    ...
    on_test(function(package)
        assert(package:has_cfuncs("metalink_get_version",
                                  {includes = "metalink/metalink.h"}))
    end)
end)
