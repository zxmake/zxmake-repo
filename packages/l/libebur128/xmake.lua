package("libebur128", function()
    set_homepage("https://github.com/jiixyj/libebur128")
    set_description("A library implementing the EBU R128 loudness standard.")
    set_license("MIT")

    add_urls(
        "https://github.com/jiixyj/libebur128/archive/refs/tags/$(version).tar.gz",
        "https://github.com/jiixyj/libebur128.git")

    add_versions("v1.2.6",
                 "baa7fc293a3d4651e244d8022ad03ab797ca3c2ad8442c43199afe8059faa613")
