package("libsdl_ttf", function()
    ...
    add_versions("2.20.1",
                 "18d81ab399c8e39adababe8918691830ba6e0d6448e5baa141ee0ddf87ede2dc")
    add_versions("2.20.2",
                 "aa6256bfcffd8381a75b3a2a2384ac12109b5b148e72722a19b0ede54c4051dc")
    add_versions("2.22.0",
                 "5766070145111cb047807fa3f91c2c6b81bc1008d63817e100417959b42a2484")

    add_patches(">=2.20.0 <=2.20.1", path.join(os.scriptdir(), "patches",
                                               "2.20.1", "cmakelists.patch"),
                "fe04ada62d9ed70029c0efb3c04bfec22fc7596bd6b73a567beb964e61ebd82c")
...
target_link_libraries(SDL2_ttf PRIVATE $<BUILD_INTERFACE:${SDL2_LIBRARY}>)
            ...
            io.replace("CMakeLists.txt",
                       "target_link_libraries(SDL2_ttf PRIVATE ${sdl2_target_name})",
                       [[
target_include_directories(SDL2_ttf PRIVATE ${SDL2_INCLUDE_DIR})
        ...
        if freetype then
            ...
            if fetchinfo then
                ...
                if #includedirs > 0 then
                    table.insert(configs, "-DFREETYPE_INCLUDE_DIRS=" ..
