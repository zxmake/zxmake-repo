package("libgeotiff", function()
    ...
    add_urls(
        "https://download.osgeo.org/geotiff/libgeotiff/libgeotiff-$(version).tar.gz")
    add_versions("1.7.1",
                 "05ab1347aaa471fc97347d8d4269ff0c00f30fa666d956baba37948ec87e55d6")

    add_configs("utils", {
        description = "Choose if GeoTIFF utilities should be built",
        default = false,
        type = "boolean"
    })
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        table.insert(configs, "-DWITH_UTILITIES=" ..
                         (package:config("utils") and "ON" or "OFF"))
