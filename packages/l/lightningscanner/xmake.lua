package("lightningscanner", function()
    ...
    add_urls(
        "https://github.com/localcc/LightningScanner/archive/refs/tags/$(version).tar.gz",
        "https://github.com/localcc/LightningScanner.git")

    add_versions("v1.0.2",
                 "09d2f0d8b84e64542bce6096922efb8c7a6683038f2f11321931928a815055ac")
    add_versions("v1.0.0",
                 "747ec772a9068c9818c174ab46f9900e105d3550820c0afa7ba6f38341779c01")

    add_deps("cmake")

    on_install("windows|x64", "windows|x86", "linux", "macosx|x86_64", "bsd",
               function(package)
        local configs = {
