package("libcbor", function()
    ...
    on_install(function(package)
        local configs = {
            "-DWITH_EXAMPLES=OFF", "-DCMAKE_SKIP_INSTALL_ALL_DEPENDENCY=OFF"
        }
        ...
        table.insert(configs, "-DSANITIZE=" ..
    ...
    on_test(function(package)
        assert(
            package:has_cfuncs("cbor_new_definite_map", {includes = "cbor.h"}))
    end)
end)
