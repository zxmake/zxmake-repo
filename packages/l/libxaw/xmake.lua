package("libxaw", function()
    ...
    on_test(function(package)
        assert(package:has_cfuncs("XawInitializeWidgetSet",
                                  {includes = "X11/Xaw/XawInit.h"}))
    end)
end)
