package("libgcrypt", function()
    ...
    add_urls(
        "https://www.gnupg.org/ftp/gcrypt/libgcrypt/libgcrypt-$(version).tar.gz")
    add_versions("1.10.0",
                 "624dc2f72aaadf6ef4e183589aba794cc060bfbf14d2f4f0995b4d636189c584")
    ...
    on_install("linux", "macosx", function(package)
        ...
        table.insert(configs, "--with-libgpg-error-prefix=" ..
                         package:dep("libgpg-error"):installdir())
