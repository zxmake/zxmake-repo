package("libnpy", function()
    ...
    add_urls(
        "https://github.com/llohse/libnpy/archive/refs/tags/$(version).tar.gz",
        "https://github.com/llohse/libnpy.git")

    add_versions("v1.0.1",
                 "43452a4db1e8c1df606c64376ea1e32789124051d7640e7e4e8518ab4f0fba44")
