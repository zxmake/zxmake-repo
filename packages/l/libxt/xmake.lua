package("libxt", function()
    ...
    add_versions("1.2.1",
                 "6da1bfa9dd0ed87430a5ce95b129485086394df308998ebe34d98e378e3dfb33")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("XtConvertAndStore",
                                  {includes = "X11/Intrinsic.h"}))
    end)
end)
