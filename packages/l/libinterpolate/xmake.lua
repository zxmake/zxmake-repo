package("libinterpolate", function()
    ...
    add_urls(
        "https://github.com/CD3/libInterpolate/archive/2887aaf000e62cec1cceb9b238d402852c24fa26.tar.gz",
        "https://github.com/CD3/libInterpolate.git")

    add_versions("2024.04.29",
                 "1f39904d09da933dd11a58c6ea061c5f2459bbd44dd6ffa2429734629b15b489")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "libInterpolate/Interpolate.hpp"
        }))
    end)
end)
