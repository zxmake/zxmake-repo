package("libraw", function()
    ...
    add_versions("0.19.5",
                 "9a2a40418e4fb0ab908f6d384ff6f9075f4431f8e3d79a0e44e5a6ea9e75abdc")
    ...
    on_install("macosx", "linux", "windows", "mingw@windows", "iphoneos",
               function(package)
    ...
    on_test(function(package)
        assert(package:has_cfuncs("libraw_version",
                                  {includes = "libraw/libraw.h"}))
    end)
end)
