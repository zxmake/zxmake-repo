...
set_urls(
    "https://www.x.org/archive/individual/lib/libXcomposite-$(version).tar.gz")

add_versions("0.4.6",
             "3599dfcd96cd48d45e6aeb08578aa27636fa903f480f880c863622c2b352d076")
...
on_test(function(package)
    assert(package:has_cfuncs("XCompositeRedirectWindow",
                              {includes = "X11/extensions/Xcomposite.h"}))
end)
