package("libwebm", function()
    ...
    add_configs("webmts", {
        description = "Enables WebM PES/TS support.",
        default = false,
        type = "boolean"
    })
    add_configs("webm_info", {
        description = "Enables building webm_info.",
        default = false,
        type = "boolean"
    })
    add_configs("parser", {
        description = "Enables new parser API.",
        default = false,
        type = "boolean"
    })
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DENABLE_WEBMTS=" ..
                         (package:config("webmts") and "ON" or "OFF"))
        table.insert(configs, "-DENABLE_WEBMINFO=" ..
                         (package:config("webm_info") and "ON" or "OFF"))
        table.insert(configs, "-DENABLE_WEBM_PARSER=" ..
                         (package:config("parser") and "ON" or "OFF"))
