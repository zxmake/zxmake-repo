package("lolly", function()
    ...
    add_configs("nowide_standalone",
                {description = "nowide", default = true, type = "boolean"})

    on_load(function(package)
        if package:is_plat("mingw", "windows") and
            package:config("nowide_standalone") then
