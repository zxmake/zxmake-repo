package("libxkbcommon", function()
    ...
    add_versions("1.0.3",
                 "5d10a57ab65daad7d975926166770eca1d2c899131ab96c23845df1c42da5c31")
    ...
    add_configs("x11", {
        description = "Enable backend to X11 (default is false).",
        default = false,
        type = "boolean"
    })
    add_configs("wayland", {
        description = "Enable backend to X11 (default is true).",
        default = true,
        type = "boolean"
    })
    ...
    on_install("linux", function(package)
        ...
        local configs = {
            "-Denable-docs=false", "-Dc_link_args=-lm",
    ...
    on_test(function(package)
        assert(package:has_cfuncs("xkb_context_new",
                                  {includes = "xkbcommon/xkbcommon.h"}))
    end)
end)
