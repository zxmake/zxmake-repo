package("libpthread-stubs", function()
    set_homepage("https://www.x.org/")
    set_description("X.Org: pthread-stubs.pc")

    add_urls(
        "https://xcb.freedesktop.org/dist/libpthread-stubs-$(version).tar.gz",
    ...
    add_versions("0.5",
                 "593196cc746173d1e25cb54a93a87fd749952df68699aab7e02c085530e87747")
    ...
    on_test(function(package)
        local envs = {
            PKG_CONFIG_PATH = path.join(package:installdir(), "lib", "pkgconfig")
        }
