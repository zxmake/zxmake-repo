package("lsquic", function()
    set_homepage("https://github.com/litespeedtech/lsquic")
    set_description("LiteSpeed QUIC and HTTP/3 Library")
    set_license("MIT")

    add_urls(
        "https://github.com/litespeedtech/lsquic/archive/refs/tags/$(version).tar.gz",
        "https://github.com/litespeedtech/lsquic.git")

    add_versions("v4.0.12",
                 "9dfbb5617059f6085c3d796dae3850c9e8a65f2e35582af12babeed633a22be7")
    add_versions("v4.0.11",
                 "b1c46951c1fc524a96923f4e380cb9fc6cc20bb8a8a41779351bcad6dcbe6e16")
    add_versions("v4.0.9",
                 "bebb6e687138368d89ff3f67768692ac55b06925d63b011d000ce134b6ec98f1")
    add_versions("v4.0.8",
    ...
    on_install("windows|!arm64", "linux", "macosx", function(package)
        ...
        io.replace("CMakeLists.txt", "lib${LIB_NAME}${LIB_SUFFIX}",
                   "lib${LIB_NAME}" ..
                       (boringssl:config("shared") and ".so" or ".a"),
                   {plain = true})
        ...
        table.insert(configs, "-DLSQUIC_SHARED_LIB=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DLSQUIC_FIU=" ..
                         (package:config("fiu") and "ON" or "OFF"))
        if package:is_plat("windows") then
