package("libsdl_image", function()
    ...
    add_urls(
        "https://www.libsdl.org/projects/SDL_image/release/SDL2_image-$(version).zip",
        "https://github.com/libsdl-org/SDL_image/releases/download/release-$(version)/SDL2_image-$(version).zip")
    add_versions("2.6.0",
                 "2252cdfd5be73cefaf727edc39c2ef3b7682e797acbd3126df117e925d46aaf6")
    add_versions("2.6.1",
                 "cbfea63a46715c63a1db9e41617e550749a95ffd33ef9bd5ba6e58b2bdca6ed3")
    add_versions("2.6.2",
    ...
    add_versions("2.8.0",
                 "fed33c3fe9f8d38ab4460bdd100c4495be40f8afdac1d44bfcd2b0259b74a123")
    add_versions("2.8.1",
                 "0c5afef0ac4bc951a46c6790e576c9b3e7ed2c5ab1d2bbfa5e7e9300718f67d2")
    add_versions("2.8.2",
                 "2196ad6665b68fc453a659e172d67fbf18d548277aa07344dfd2deed9d9b84bd")

    if is_plat("macosx", "iphoneos") then
        add_frameworks("CoreFoundation", "CoreGraphics", "ImageIO",
                       "CoreServices")
