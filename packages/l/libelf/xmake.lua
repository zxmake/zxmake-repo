package("libelf", function()

    set_homepage(
        "https://web.archive.org/web/20181111033959/www.mr511.de/software/english.html")
    ...
    on_install("linux", "android", function(package)
        local configs = {"--disable-dependency-tracking", "--disable-compat"}
        ...
        io.replace("./configure", "main(){return(0);}",
                   "int main(){return(0);}", {plain = true})
