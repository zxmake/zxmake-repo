package("libsdl_mixer", function()
    ...
    add_versions("2.6.0",
                 "aca0ffc96a4bf2a56a16536a269de28e341ce38a46a25180bc1ef75e19b08a3a")
    add_versions("2.6.1",
                 "788c748c1d3a87126511e60995b03526ed4e31e2ba053dffd9dcc8abde97b950")
    add_versions("2.6.2",
                 "61549615a67e731805ca1df553e005be966a625c1d20fb085bf99edeef6e0469")
    add_versions("2.8.0",
                 "02df784cc68723419dd266530ee6964f810a6f02a27b03ecc85689c2e5e442ce")
...
target_link_libraries(SDL2_mixer PRIVATE $<BUILD_INTERFACE:${SDL2_LIBRARY}>)
            ...
            io.replace("CMakeLists.txt",
                       "target_link_libraries(SDL2_mixer PRIVATE ${sdl2_target_name})",
                       [[
target_include_directories(SDL2_mixer PRIVATE ${SDL2_INCLUDE_DIR})
target_link_libraries(SDL2_mixer PRIVATE ${SDL2_LIBRARY})
        ...
        local configs = {
            "-DSDL2MIXER_CMD=OFF", "-DSDL2MIXER_FLAC=OFF",
            "-DSDL2MIXER_GME=OFF", "-DSDL2MIXER_MIDI=OFF",
            "-DSDL2MIXER_MOD=OFF", "-DSDL2MIXER_MP3=ON", -- was on by not being here
            "-DSDL2MIXER_OPUS=OFF", "-DSDL2MIXER_SAMPLES=OFF",
