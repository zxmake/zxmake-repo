package("lapack", function()
    ...
    add_urls(
        "https://github.com/Reference-LAPACK/lapack/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Reference-LAPACK/lapack.git")

    add_versions("v3.12.0",
    ...
    on_test(function(package)
        ...
        assert(package:has_cfuncs("LAPACKE_dsyev",
                                  {includes = "lapacke_utils.h"}))
    end)
end)
