package("libmpdclient", function()
    ...
    add_urls(
        "https://musicpd.org/download/libmpdclient/2/libmpdclient-$(version).tar.xz")
    add_versions("2.19",
    ...
    on_test(function(package)
        assert(package:has_cfuncs("mpd_connection_new",
                                  {includes = "mpd/connection.h"}))
    end)
end)
