package("libwebp", function()
    ...
    add_versions("v1.1.0",
                 "424faab60a14cb92c2a062733b6977b4cc1e875a6398887c5911b3a1a6c56c51")
    add_versions("v1.2.0",
                 "d37571723f531e5002667632c94fa18857ed7eb5b0561e3b49e913c3e0b1403e")
    add_versions("v1.2.1",
                 "7926985218c9e546069c2013dd93774aac3f012fd275247f82b0c119ec9a3801")
    add_versions("v1.2.2",
                 "51e9297aadb7d9eb99129fe0050f53a11fcce38a0848fb2b0389e385ad93695e")
    add_versions("v1.2.3",
                 "5e8452bcfe64badadbed5480ea9e86f156fe649f15e765e6059645f0aff73546")
    add_versions("v1.2.4",
                 "dfe7bff3390cd4958da11e760b65318f0a48c32913e4d5bc5e8d55abaaa2d32e")
    add_versions("v1.3.0",
                 "dc9860d3fe06013266c237959e1416b71c63b36f343aae1d65ea9c94832630e1")

    add_patches(">=1.1.0 <1.3.0", path.join(os.scriptdir(), "patches",
                                            "0001-fix-dll-export.patch"),
                "81d92d800dd7b57704a0e4db3b7155184fe8bb6bc0a925a699a8a0868629f60c")

    add_configs("anim_utils", {
    ...
    add_configs("sharpyuv", {
        description = "Build the sharpyuv library, remove since v1.2.3",
        default = false,
        type = "boolean"
    })
    add_configs("extras", {
    ...
    on_load(function(package)
        ...
        for _, l in ipairs(links) do
            if package:version():ge("1.3") then
                package:add("links",
                            (package:is_plat("windows") and "lib" or "") .. l)
            else
                package:add("links", l)
            end
        end
    ...
    on_install("linux", "macosx", "windows", "mingw", "bsd", "wasm",
               function(package)
        local configs = {}
        ...
        for name, enabled in pairs(package:configs()) do
            ...
            elseif not package:extraconf("configs", name, "builtin") then
                table.insert(configs, "-DWEBP_BUILD_" .. name:upper() .. "=" ..
    ...
    on_test(function(package)
        assert(package:has_cfuncs("WebPGetEncoderVersion",
                                  {includes = "webp/encode.h"}))
        if package:config("libwebpmux") and package:version():ge("1.2.1") then
            assert(package:has_cfuncs("WebPGetMuxVersion",
                                      {includes = "webp/mux.h"}))
        end
    end)
end)
