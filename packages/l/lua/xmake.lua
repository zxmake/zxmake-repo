package("lua", function()
    ...
    elseif is_plat("linux") then
        add_extsources("pacman::lua", "pacman::lua51", "pacman::lua52",
                       "pacman::lua53", "apt::liblua5.1-0-dev",
                       "apt::liblua5.2-dev", "apt::liblua5.3-dev",
                       "apt::liblua5.4-dev")
...
#define system(s) ((s)==NULL ? 0 : -1)
        ...
        ]], sourcedir, package:config("shared") and "shared" or "static",
                                         package:is_cross() and "false" or
                                             "true"))
