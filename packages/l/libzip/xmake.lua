package("libzip", function()
    ...
    add_versions("v1.10.1",
                 "9669ae5dfe3ac5b3897536dc8466a874c8cf2c0e3b1fdd08d75b273884299363")
    add_versions("v1.8.0",
                 "30ee55868c0a698d3c600492f2bea4eb62c53849bcf696d21af5eb65f3f3839e")
    add_versions("v1.9.2",
    ...
    on_install(function(package)
        ...
        local configs = {
            "-DBUILD_DOC=OFF", "-DBUILD_EXAMPLES=OFF", "-DBUILD_REGRESS=OFF",
            "-DBUILD_OSSFUZZ=OFF", "-DBUILD_TOOLS=ON"
        }
        ...
        for config, dep in pairs(configdeps) do
            table.insert(configs, "-DENABLE_" .. config:upper() .. "=" ..
    ...
    on_test(function(package)
        assert(package:has_cfuncs("zip_source_buffer_create",
                                  {includes = "zip.h"}))
    end)
end)
