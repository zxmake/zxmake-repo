package("libfreenect2", function()
    ...
    add_patches("v0.2.0", path.join(os.scriptdir(), "patches", "0.2.0",
                                    "frame_listener_impl.cpp.patch"),
                "47687b34fd0ca275d3e1c2ce87064ffaacd13f2f8d3a310224d3b9fef2cd54a3")
    ...
    elseif is_plat("macosx") then
        add_frameworks("CoreMedia", "CoreFoundation", "CoreVideo", "Foundation",
                       "IOKit", "ImageIO", "VideoToolbox")
    end
    ...
    on_install("windows", "linux", "macosx", function(package)
        io.replace("CMakeLists.txt", "FIND_PACKAGE(LibUSB REQUIRED)", "",
                   {plain = true})
        ...
        table.insert(configs, "-DENABLE_OPENGL=" ..
        ...
        if libjpegturbo then
            table.insert(configs, "-DTurboJPEG_INCLUDE_DIRS=" ..
                             table.concat(
                                 libjpegturbo.includedirs or
                                     libjpegturbo.sysincludedirs, ";"))
            table.insert(configs, "-DTurboJPEG_LIBRARIES=" ..
                             table.concat(libjpegturbo.libfiles, ";"))
        end
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "libfreenect2/libfreenect2.hpp"
        }))
    end)
end)
