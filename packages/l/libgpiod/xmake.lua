package("libgpiod", function()
    ...
    add_versions("v2.0.1",
                 "cf0d4db1d94cc99281de142063d0e28f42760c4d918d6b8854e1b27811517c34")
    add_versions("v2.0",
                 "a0f835c4ca4a2a3ca021090b574235ba58bb9fd612d8a6051fb1350054e04fdd")
    add_versions("v1.6.4",
                 "9f920260c46b155f65cba8796dcf159e4ba56950b85742af357d75a1af709e68")

    add_configs("enable_bindings_cxx", {
        description = "Enable C++ bindings",
        default = true,
        type = "boolean"
    })
    add_configs("enable_tools", {
