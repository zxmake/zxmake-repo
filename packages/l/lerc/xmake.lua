package("lerc", function()
    ...
    add_versions("v4.0.0",
                 "91431c2b16d0e3de6cbaea188603359f87caed08259a645fd5a3805784ee30a0")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("lerc_computeCompressedSize",
                                  {includes = "Lerc_c_api.h"}))
    end)
end)
