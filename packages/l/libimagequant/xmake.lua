package("libimagequant", function()
    ...
    add_versions("2.15.1",
                 "3a9548f99be8c3b20a5d9407d0ca95bae8b0fb424a2735a87cb6cf3fdd028225")

    add_configs("sse",
                {description = "Use SSE.", default = true, type = "boolean"})
    ...
    on_test(function(package)
        assert(package:has_cfuncs("liq_attr_create",
                                  {includes = "libimagequant.h"}))
    end)
end)
