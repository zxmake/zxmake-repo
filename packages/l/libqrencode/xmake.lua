package("libqrencode", function()
    set_homepage("https://github.com/fukuchi/libqrencode")
    set_description("A fast and compact QR Code encoding library")
    set_license("LGPL-2.1")

    add_urls(
        "https://github.com/fukuchi/libqrencode/archive/refs/tags/v$(version).zip")
    add_versions("4.1.1",
                 "5ebf5f71fefda8e58e713e821f956759b38b9178ce455df7444e17f5c99e1b19")
