package("webui", function()
    ...
    set_urls(
        "https://github.com/webui-dev/webui/archive/refs/tags/$(version).tar.gz",
        "https://github.com/webui-dev/webui.git")

    add_versions("2.4.2",
                 "c51967bbab472655d04e28ce1668ee4adda1f320e05f98c14f071b2cdf61228b")
    add_versions("2.3.0",
                 "14be57405b12cf434daade2310178534240866e3169c7213a6fa0e4a6c6f9f27")
    ...
    on_install("windows", "linux", "macosx", "mingw", "msys", "android",
        ...
        if package:is_plat("android") and package:is_arch("armeabi-v7a") then
            ...
            if tonumber(ndk_sdkver) < 24 then
                ...
                io.replace("src/civetweb/civetweb.c", "ftello", "ftell",
                           {plain = true})
                io.replace("src/civetweb/civetweb.c", "fseeko", "fseek",
                           {plain = true})
            end
        end
