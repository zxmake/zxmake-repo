...
on_config(function(target)
    ...
    local outputdir = target:extraconf("rules", rule_name, "outputdir") or
...
before_buildcmd_file(function(target, batchcmds, sourcefile, opt)
    ...
    assert(wayland_scanner,
           "wayland-scanner not found! please install wayland package")
    ...
    if server then
        ...
        batchcmds:show_progress(opt.progress,
                                "${color.build.object}generating.wayland.protocol.server %s",
                                basename)
    ...
    batchcmds:show_progress(opt.progress,
                            "${color.build.object}generating.wayland.protocol.%s %s",
                            visibility, basename)
