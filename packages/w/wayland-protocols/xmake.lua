package("wayland-protocols", function()
    ...
    add_versions("1.27",
                 "9046f10a425d4e2a00965a03acfb6b3fb575a56503ac72c2b86821c69653375c")
    add_versions("1.28",
                 "c7659fb6bf14905e68ef605f898de60d1c066bf66dbea92798573dddec1535b6")
    add_versions("1.29",
                 "e25e9ab75ac736704ddefe92e8f9ac8730beab6f564db62f7ad695bba4ff9ed8")
    add_versions("1.30",
                 "3c1498fb65fd2b80b0376d7e87cf215e6ae957b2ccdba5da45a448718831bc60")
    add_versions("1.31",
