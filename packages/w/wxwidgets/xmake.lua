package("wxwidgets", function()
    ...
    if is_plat("windows") then
        if is_arch("x64") then
            add_urls(
                "https://github.com/wxWidgets/wxWidgets/releases/download/v$(version)/wxMSW-$(version)_vc14x_x64_Dev.7z")
            add_versions("3.2.0",
                         "02b7227916b98324f73ae9bed0f1cf27ae3157b4e3a3ded40ee8c0d570f0fd10")
            ...
            add_versions("3.2.2",
                         "b5d36e3ac9e01dc1a024344a0a28f9b99bdba75bafa119e1a626d8cc6fdef63d")
            ...
            add_versions("3.2.3",
                         "b8a6be72378d9947e303d7075a58c9bbc161d5debd25a187b654373b4d204873")
            ...
            add_versions("3.2.4",
                         "b8be152f08031aed2bfeffd17d8409209c38667859094b319818e08f7a4ad065")
            ...
            add_urls(
                "https://github.com/wxWidgets/wxWidgets/releases/download/v$(version)/wxMSW-$(version)_vc14x_Dev.7z")
            add_versions("3.2.0",
                         "0cd2387edcf1f26924d59efcc3ea4c8a00783ee01bf396756dabdd7967e4b37b")
            add_resources("3.2.0", "releaseDLL",
            ...
            add_versions("3.2.2",
                         "7150112bece62f4eccd68d3b0eba11b5a1da0f773e864bdecb9840ce76160847")
            add_resources("3.2.2", "releaseDLL",
            ...
            add_versions("3.2.3",
                         "8961f24abb16362a542140912f3c6cb75b8f95111816311ecf5b00ea1e0c55f3")
            add_resources("3.2.3", "releaseDLL",
            ...
            add_versions("3.2.4",
                         "efa6bf76d42373e7930af18a176e5e52fbdd43f5da41b9bf6cd3b347d820f8b7")
            add_resources("3.2.4", "releaseDLL",
        ...
        add_versions("3.2.0",
                     "356e9b55f1ae3d58ae1fed61478e9b754d46b820913e3bfbc971c50377c1903a")
        add_versions("3.2.2",
                     "8edf18672b7bc0996ee6b7caa2bee017a9be604aad1ee471e243df7471f5db5d")
        add_versions("3.2.3",
                     "c170ab67c7e167387162276aea84e055ee58424486404bba692c401730d1a67a")
        add_versions("3.2.4",
                     "0640e1ab716db5af2ecb7389dbef6138d7679261fbff730d23845ba838ca133e")
        add_versions("3.2.5",
                     "0ad86a3ad3e2e519b6a705248fc9226e3a09bbf069c6c692a02acf7c2d1c6b51")
    ...
    if is_plat("macosx") then
        add_defines("__WXOSX_COCOA__", "__WXMAC__", "__WXOSX__",
                    "__WXMAC_XCODE__")
        add_frameworks("AudioToolbox", "WebKit", "CoreFoundation", "Security",
                       "Carbon", "Cocoa", "IOKit", "QuartzCore")
        add_syslinks("iconv")
    ...
    elseif is_plat("windows") then
        add_defines("WXUSINGDLL", "__WXMSW__", "wxSUFFIX=u",
                    "wxMSVC_VERSION=14x")
        add_links("wxbase32u", "wxbase32u_net", "wxbase32u_xml", "wxexpat",
                  "wxjpeg", "wxmsw32u_adv", "wxmsw32u_aui", "wxmsw32u_core",
                  "wxmsw32u_gl", "wxmsw32u_html", "wxmsw32u_media",
                  "wxmsw32u_propgrid", "wxmsw32u_qa", "wxmsw32u_ribbon",
                  "wxmsw32u_richtext", "wxmsw32u_stc", "wxmsw32u_webview",
                  "wxmsw32u_xrc", "wxpng", "wxregexu", "wxscintilla", "wxtiff",
                  "wxzlib")
    end
    ...
    on_load(function(package)
        if package:is_plat("macosx", "linux") then
            ...
            if package:is_plat("macosx") then
                package:add("includedirs", path.join("lib", "wx", "include",
                                                     "osx_cocoa-unicode" ..
                                                         static .. "-" .. suffix))
    ...
    on_install("windows", function(package)
        ...
        os.cp(path.join(package:resourcedir("releaseDLL"), "lib", dlldir,
                        "*.dll"), package:installdir("bin"))
        os.cp(path.join("lib", dlldir, "mswu", "wx"),
              package:installdir("lib", dlldir, "mswu"))
        os.cp(path.join(package:resourcedir("headers"), "include"),
              package:installdir())
        os.cp(
            path.join(package:resourcedir("headers"), "include", "msvc", "wx",
                      "setup.h"), package:installdir("include/wx"))
        io.replace(path.join(package:installdir("include"), "wx", "setup.h"),
                   "../../../lib/", "../../lib/", {plain = true})
    end)
    ...
    on_install("macosx", "linux", function(package)
        ...
        local major, minor, patch = cmake_fetch.version:match(
                                        "^(%d+)%.(%d+)%.(%d+)$")
        ...
        io.replace("build/cmake/modules/FindGTK3.cmake",
                   ...
                   {plain = true})
        local configs = {
            "-DwxBUILD_TESTS=OFF", "-DwxBUILD_SAMPLES=OFF",
            "-DwxBUILD_DEMOS=OFF", "-DwxBUILD_PRECOMP=OFF",
            "-DwxBUILD_BENCHMARKS=OFF", "-DwxUSE_REGEX=sys", "-DwxUSE_ZLIB=sys",
            "-DwxUSE_EXPAT=sys", "-DwxUSE_LIBJPEG=sys", "-DwxUSE_LIBPNG=sys",
            "-DwxUSE_NANOSVG=sys", "-DwxUSE_LIBTIFF=builtin"
        }
        ...
        os.cp(path.join(package:installdir("include", subdir, "wx", setupdir,
                                           "setup.h")),
              path.join(package:installdir("include", subdir, "wx")))
        local lib_suffix = version:major() .. "." .. version:minor()
        if package:is_plat("linux") then
            package:add("links", "wx_gtk3u_xrc-" .. lib_suffix,
                        "wx_gtk3u_html-" .. lib_suffix,
                        "wx_gtk3u_qa-" .. lib_suffix,
                        "wx_gtk3u_core-" .. lib_suffix,
                        "wx_baseu_xml-" .. lib_suffix,
                        "wx_baseu_net-" .. lib_suffix, "wx_baseu-" .. lib_suffix)
        end
    end)
