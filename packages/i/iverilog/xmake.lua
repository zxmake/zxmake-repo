package("iverilog", function()
    ...
    if is_plat("windows") then
        add_urls(
            "https://github.com/xmake-mirror/iverilog-windows/releases/download/$(version)/iverilog-$(version).zip")
        add_versions("2022.6.11",
                     "6ce9411bf9468c43df70ae777e6727d47ae4f56413e772455fa93356597b6b7b")
    else
