package("immer", function()
    ...
    add_urls(
        "https://github.com/arximboldi/immer/archive/refs/tags/$(version).tar.gz",
        "https://github.com/arximboldi/immer.git")
    add_versions("v0.8.0",
                 "4ed9e86a525f293e0ba053107b937d88b032674ec6e5db958816f2e412677fde")
    add_versions("v0.8.1",
    ...
    on_install("windows", "linux", "macosx", function(package)
        local configs = {
            "-Dimmer_BUILD_TESTS=OFF", "-Dimmer_BUILD_EXAMPLES=OFF",
            "-Dimmer_BUILD_DOCS=OFF", "-Dimmer_BUILD_EXTRAS=OFF"
        }
