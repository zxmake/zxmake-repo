package("ispc", function()
    ...
    if is_host("windows") then
        add_urls(
            "https://github.com/ispc/ispc/releases/download/v$(version)/ispc-v$(version)-windows.zip")
        add_versions("1.17.0",
                     "e9a7cc98f69357482985bcbf69fa006632cee7b3606069b4d5e16dc62092d660")
    elseif is_host("macosx") then
        add_urls(
            "https://github.com/ispc/ispc/releases/download/v$(version)/ispc-v$(version)-macOS.tar.gz")
        add_versions("1.17.0",
                     "e7fdcdbd5c272955249148c452ccd7295d7cf77b35ca1dec377e72b49c847bff")
    elseif is_host("linux") then
        add_urls(
            "https://github.com/ispc/ispc/releases/download/v$(version)/ispc-v$(version)-linux.tar.gz")
        add_versions("1.17.0",
