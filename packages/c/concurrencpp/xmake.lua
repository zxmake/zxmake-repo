package("concurrencpp", function()
    ...
    add_urls(
        "https://github.com/David-Haim/concurrencpp/archive/refs/tags/$(version).tar.gz",
        {
    ...
    add_versions("0.1.5",
                 "330150ebe11b3d30ffcb3efdecc184a34cf50a6bd43b68e294a496225d286651")
    add_versions("0.1.6",
                 "e7d5c23a73ff1d7199d361d3402ad2a710dfccf7630b622346df94a7532b4221")
    add_versions("0.1.7",
                 "049f3e83ad1828e0b8b518652de1a3160d5849fdff03d521d0a5af0167338e89")
    ...
    on_load(function(package)
        package:add("includedirs",
                    "include/concurrencpp-" .. package:version_str())
    end)
