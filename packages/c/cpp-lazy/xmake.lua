package("cpp-lazy", function()
    ...
    set_urls(
        "https://github.com/MarcDirven/cpp-lazy/archive/refs/tags/v$(version).tar.gz",
        "https://github.com/MarcDirven/cpp-lazy.git")

    add_versions("v7.0.2",
                 "7a5c2a42ce5c98343676d09761959b9821ec125dbff7b9f2028792c117de0b09")
