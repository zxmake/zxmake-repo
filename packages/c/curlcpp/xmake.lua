package("curlcpp", function()
    set_homepage("https://josephp91.github.io/curlcpp")
    set_description("An object oriented C++ wrapper for CURL (libcurl)")
    set_license("MIT")

    add_urls(
        "https://github.com/JosephP91/curlcpp/archive/refs/tags/$(version).tar.gz",
        "https://github.com/JosephP91/curlcpp.git")

    add_versions("3.1",
                 "ba7aeed9fde9e5081936fbe08f7a584e452f9ac1199e5fabffbb3cfc95e85f4b")
