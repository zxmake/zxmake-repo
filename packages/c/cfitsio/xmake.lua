package("cfitsio", function()
    ...
    add_urls(
        "https://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfit-$(version).zip")
    add_versions("4.0.0",
                 "b70423f831dc28919c56ff37baebb50b1eaca665ca8ca34094cb58b60c482386")
