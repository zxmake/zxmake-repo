package("caudio", function()

    set_homepage("https://github.com/R4stl1n/cAudio")
    set_description("3D Audio Engine Based on Openal")

    add_urls(
        "https://github.com/R4stl1n/cAudio/archive/refs/tags/$(version).zip",
        "https://github.com/R4stl1n/cAudio.git")
    add_versions("2.3.1",
                 "10f36cd7e1583405ade9001c3782fdf04be09f0f74e56cba23fac3a2b3ed5ae5")

    add_patches("2.3.1", path.join(os.scriptdir(), "patches", "2.3.1",
                                   "win32_fix.patch"),
                "92d09b63479e203e59cece12fb5d539ab73f6654228ad44b221361db50639acf")
    ...
    on_install("windows", "linux", function(package)
        local dep_dir =
            (package:is_arch("x64", "x86_64") and "Dependencies64" or
                "Dependencies")
        local configs = {
        ...
        if package:is_plat("windows") then
            io.replace("cAudio/Headers/cOpenALUtil.h",
                       "#if !defined(CAUDIO_PLATFORM_LINUX)", "#if 0",
                       {plain = true})
