package("catch2", function()
    ...
    add_urls(
        "https://github.com/catchorg/Catch2/archive/refs/tags/$(version).zip",
        "https://github.com/catchorg/Catch2.git")
    add_versions("v3.7.1",
                 "7d771897398704ecb61eae534912e50c4d3ec6129c4d01c174a55c29657970d7")
    add_versions("v3.7.0",
                 "75b04c94471a70680f10f5d0d985bd1a96b8941d040d6a7bfd43f6c6b1de9daf")
    add_versions("v3.6.0",
                 "aa0ebf551ffbf098ec1e253b5fee234c30b4ee54a31b1be63cb1a7735d3cf391")
    add_versions("v3.5.4",
                 "190a236fe0772ac4f5eebfdebfc18f92eeecfd270c55a1e5095ae4f10be2343f")
    add_versions("v3.5.3",
                 "2de1868288b26a19c2aebfc3fe53a748ec3ec5fc32cc742dfccaf6c685a0dc07")
    add_versions("v3.5.2",
                 "85fcc78d0c3387b15ad82f22a94017b29e4fe7c1cf0a05c3dd465b2746eef73f")
    add_versions("v3.5.1",
                 "b422fcd526a95e6057839f93a18099261bdc8c595f932ed4b1a978b358b3f1ed")
    add_versions("v3.5.0",
    ...
    add_versions("v3.3.2",
                 "802a1d7f98f8e38a7913b596c5e3356ea76c544acb7c695bfd394544556359f3")
    add_versions("v3.2.1",
    ...
    add_versions("v2.13.10",
                 "121e7488912c2ce887bfe4699ebfb983d0f2e0d68bcd60434cdfd6bb0cf78b43")
    add_versions("v2.13.9",
                 "860e3917f07d7ee75654f86900d50a03acf0047f6fe5ba31d437e1e9cda5b456")
    add_versions("v2.13.8",
                 "de0fd1f4c51a1021ffcb33a4d42028545bf1a0665a4ab59ddb839a0cc93f03a5")
    add_versions("v2.13.7",
                 "3f3ccd90ad3a8fbb1beeb15e6db440ccdcbebe378dfd125d07a1f9a587a927e9")
    add_versions("v2.13.6",
                 "39d50f5d1819cdf2908066664d57c2cde4a4000c364ad3376ea099735c896ff4")
    add_versions("v2.13.5",
                 "728679b056dc1248cc79b3a1999ff7453f76422c68417563fc47a0ac2aaeeaef")
    add_versions("v2.9.2",
                 "dc486300de22b0d36ddba1705abb07b9e5780639d824ba172ddf7062b2a1bf8f")

    if is_plat("windows") then
        add_patches("v3.5.4", path.join(os.scriptdir(), "patches", "3.5.4",
                                        "windows_arm64.patch"),
                    "36fa29bd38fc97d3d3563bc4e7fab0810e899f8a2d8f8418555e2a4c051ad947")
    end

    add_configs("cxx17", {
        description = "Compiles Catch as a C++17 library (requires a C++17 compiler).",
        default = true,
        type = "boolean"
    })
    ...
    on_test(function(package)
        if package:version():ge("3.0") then
            assert(package:check_cxxsnippets({
                ...
                includes = "catch2/catch_test_macros.hpp"
            }))
        else
            assert(package:check_cxxsnippets({
                test = [[
