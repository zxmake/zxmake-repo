package("ctpg", function()
    ...
    add_urls(
        "https://github.com/peter-winter/ctpg/archive/refs/tags/$(version).tar.gz",
        "https://github.com/peter-winter/ctpg.git")

    add_versions("v1.3.7",
                 "6cc7c34de4983e21070599fd5693b65ef08cd5c8f42612e43b47eda723623429")
