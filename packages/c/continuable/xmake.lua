package("continuable", function()
    ...
    add_urls(
        "https://github.com/Naios/continuable/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Naios/continuable.git", {submodules = false})

    add_versions("4.2.2",
                 "49bf82a349b26c01194631e4fe5d1dbad080b3b4a347eebc5cf95326ea130fba")
