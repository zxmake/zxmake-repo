package("cpp-jwt", function()
    ...
    add_urls(
        "https://github.com/arun11299/cpp-jwt/archive/refs/tags/$(version).tar.gz",
        "https://github.com/arun11299/cpp-jwt.git")

    add_versions("v1.4",
                 "1cb8039ee15bf9bf735c26082d7ff50c23d2886d65015dd6b0668c65e17dd20f")

    add_deps("nlohmann_json", "openssl3")

    on_install("!wasm@macosx and !iphoneos@macosx and !android",
               function(package)
