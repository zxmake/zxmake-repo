package("cglm", function()
    ...
    add_versions("v0.9.4",
                 "101376d9f5db7139a54db35ccc439e40b679bc2efb756d3469d39ee38e69c41b")
    add_versions("v0.9.3",
                 "4eda95e34f116c36203777f4fe770d64a3158b1450ea40364abb111cf4ba4773")
    add_versions("v0.9.2",
                 "5c0639fe125c00ffaa73be5eeecd6be999839401e76cf4ee05ac2883447a5b4d")
    add_versions("v0.9.0",
                 "9b688bc52915cdd4ad8b7d4080ef59cc92674d526856d8f16bb3a114db1dd794")
        ...
        on_check("windows", function(package)
            ...
            if msvc then
                ...
                assert(vs_sdkver and semver.match(vs_sdkver):gt("10.0.19041"),
                       "package(cglm): need vs_sdkver > 10.0.19041.0")
            end
        end)
    end
