package("coin-or-asl", function()
    ...
    add_urls(
        "https://github.com/coin-or-tools/ThirdParty-ASL/archive/refs/tags/releases/$(version).tar.gz",
        "https://github.com/coin-or-tools/ThirdParty-ASL.git")

    add_versions("2.0.1",
                 "92575a7d5264311a53bfec65bec006475c4b5ef3e79d8d84db798d73e8d3567f")
