package("cppzmq", function()
    ...
    add_urls(
        "https://github.com/zeromq/cppzmq/archive/refs/tags/$(version).tar.gz",
        "https://github.com/zeromq/cppzmq.git")
    add_versions("v4.8.1",
                 "7a23639a45f3a0049e11a188e29aaedd10b2f4845f0000cf3e22d6774ebde0af")
    add_versions("v4.9.0",
                 "3fdf5b100206953f674c94d40599bdb3ea255244dcc42fab0d75855ee3645581")
    add_versions("v4.10.0",
