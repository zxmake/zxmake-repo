package("c-ares", function()
    ...
    add_urls(
        "https://github.com/c-ares/c-ares/releases/download/$(version).tar.gz",
        {
            version = function(version)
                if version:ge("1.30.0") then
                    return "v" .. version .. "/c-ares-" .. version
                else
                    return "cares-" .. version:gsub("%.", "_") .. "/c-ares-" ..
                               version
                end
            end
        })
    ...
    add_versions("1.34.1",
                 "7e846f1742ab5998aced36d170408557de5292b92ec404fb0f7422f946d60103")
    add_versions("1.33.1",
                 "06869824094745872fa26efd4c48e622b9bd82a89ef0ce693dc682a23604f415")
    add_versions("1.33.0",
                 "3e41df2f172041eb4ecb754a464c11ccc5046b2a1c8b1d6a40dac45d3a3b2346")
    add_versions("1.32.3",
                 "5f02cc809aac3f6cc5edc1fac6c4423fd5616d7406ce47b904c24adf0ff2cd0f")
    add_versions("1.32.2",
                 "072ff6b30b9682d965b87eb9b77851dc1cd8e6d8090f6821a56bd8fa89595061")
    add_versions("1.31.0",
                 "0167a33dba96ca8de29f3f598b1e6cabe531799269fd63d0153aa0e6f5efeabd")
    add_versions("1.30.0",
    ...
    add_versions("1.17.0",
                 "1cecd5dbe21306c7263f8649aa6e9a37aecb985995a3489f487d98df2b40757d")
    add_versions("1.17.1",
    ...
    add_versions("1.18.0",
                 "71c19708ed52a60ec6f14a4a48527187619d136e6199683e77832c394b0b0af8")
    add_versions("1.18.1",
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DCARES_BUILD_TOOLS=" ..
