...
add_files("infback.c", "inffast.c", "inftrees.c", "trees.c", "uncompr.c",
          "zutil.c")
add_headerfiles("zlib.h", "zconf.h", "chromeconf.h", "deflate.h", "inffast.h",
                "inffixed.h", "inflate.h", "inftrees.h", "zutil.h")
...
on_load(function(target)
    ...
    if is_plat("android") then
        ...
        target:add("includedirs",
                   path.join(ndk, "sources", "android", "cpufeatures"))
        target:add("files", path.join(ndk, "sources", "android", "cpufeatures",
                                      "cpu-features.c"))
    end
end)
...
elseif is_arch("i386", "x86", "x64", "x86_64") then
    ...
    add_files("adler32_simd.c", "contrib/optimizations/inffast_chunk.c",
...
set_kind("static")
add_deps("zlib")
add_files("contrib/minizip/ioapi.c", "contrib/minizip/unzip.c",
          "contrib/minizip/zip.c")
add_headerfiles("contrib/minizip/ioapi.h", "contrib/minizip/unzip.h",
