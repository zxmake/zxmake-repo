package("cpu-features", function()
    ...
    add_versions("v0.7.0",
                 "df80d9439abf741c7d2fdcdfd2d26528b136e6c52976be8bd0cd5e45a27262c0")
    ...
    on_install("windows|x64", "windows|x86", "linux", "macosx", "android",
               function(package)
    ...
    on_test(function(package)
        ...
        assert(package:has_ctypes("CacheLevelInfo", {
            includes = "cpu_features/cpu_features_cache_info.h"
        }))
    end)
end)
