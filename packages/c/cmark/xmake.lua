package("cmark", function()
    ...
    on_test(function(package)
        assert(package:has_cfuncs("cmark_markdown_to_html",
                                  {includes = "cmark.h"}))
    end)
end)
