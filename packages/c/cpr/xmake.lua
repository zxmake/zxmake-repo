package("cpr", function()
    ...
    set_urls(
        "https://github.com/libcpr/cpr/archive/refs/tags/$(version).tar.gz",
        "https://github.com/libcpr/cpr.git")
    add_versions("1.6.2",
                 "c45f9c55797380c6ba44060f0c73713fbd7989eeb1147aedb8723aa14f3afaa3")
    add_versions("1.7.2",
    ...
    add_versions("1.9.4",
                 "2fbb27716c010d8a28e52d5bc8f108e0d073ca3b3f5a48a2696b0231ea5196d5")
    add_versions("1.10.2",
                 "044e98079032f7abf69c4c82f90ee2b4e4a7d2f28245498a5201ad6e8d0b1d08")
    add_versions("1.10.3",
                 "d7f2574bd9dae8adb0ce6cf1afab119b509c297fffcb4204a1bb3e4e731074f2")
    add_versions("1.10.5",
    ...
    on_load(function(package)
        if package:config("ssl") then
            package:add("deps", "libcurl",
                        {configs = {libssh2 = true, zlib = true}})
    ...
    on_install("linux", "macosx", "windows", "mingw@windows", function(package)
        local configs = {
            "-DCPR_BUILD_TESTS=OFF", "-DCPR_FORCE_USE_SYSTEM_CURL=ON",
        ...
        table.insert(configs, "-DCPR_ENABLE_SSL=" ..
        ...
        if package:is_plat("windows") then
            ...
            io.replace("CMakeLists.txt", "find_package%(CURL COMPONENTS .-%)",
                       "find_package(CURL)")
        end
