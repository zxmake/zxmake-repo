package("corrade", function()
    ...
    add_urls(
        "https://github.com/mosra/corrade/archive/refs/tags/$(version).zip",
    ...
    on_install("windows", "linux", "macosx", function(package)
        ...
        table.insert(configs, "-DCORRADE_BUILD_STATIC=" ..
    ...
    on_test(function(package)
        ...
        assert(package:check_cxxsnippets({
            ...
            includes = "Corrade/Utility/Resource.h"
        }))
    end)
end)
