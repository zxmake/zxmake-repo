package("ctrack", function()
    ...
    add_urls(
        "https://github.com/Compaile/ctrack/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Compaile/ctrack.git")

    add_versions("v1.0.2",
                 "cbe19d0a852e43da4fe675abc751464cd871b5a50af2ef7f315c0d0d68690092")
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DDISABLE_PAR=" ..
                         (package:config("parallel") and "OFF" or "ON"))
