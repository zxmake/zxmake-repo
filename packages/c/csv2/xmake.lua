package("csv2", function()
    ...
    add_urls(
        "https://github.com/p-ranav/csv2/archive/refs/tags/$(version).tar.gz",
        "https://github.com/p-ranav/csv2.git")
    add_versions("v0.1",
                 "e185d0378a95edb2ad0f2473970d8fe8579c87326640340d42bdf6327fd96791")
