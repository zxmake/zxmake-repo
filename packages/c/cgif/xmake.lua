package("cgif", function()
    set_homepage("https://github.com/dloebl/cgif")
    set_description("GIF encoder written in C")
    set_license("MIT")

    add_urls(
        "https://github.com/dloebl/cgif/archive/refs/tags/$(version).tar.gz",
        "https://github.com/dloebl/cgif.git")

    add_versions("v0.4.1",
                 "8666f9c5f8123d1c22137a6dd714502a330377fb74e2007621926fe4258529d5")
    add_versions("v0.4.0",
    ...
    on_install("windows", "linux", "macosx", "bsd", "mingw", "msys", "iphoneos",
        ...
        if package:is_plat("windows") and package:config("shared") then
            io.replace("inc/cgif.h", "CGIF* cgif_newgif",
                       "LIBRARY_API CGIF* cgif_newgif", {plain = true})
            io.replace("inc/cgif.h", "int   cgif_addframe",
                       "LIBRARY_API int cgif_addframe", {plain = true})
            io.replace("inc/cgif.h", "int   cgif_close",
                       "LIBRARY_API int cgif_close", {plain = true})
