package("commonlibsse-ng", function()
    ...
    add_urls(
        "https://github.com/CharmedBaryon/CommonLibSSE-NG/archive/$(version).zip",
        "https://github.com/CharmedBaryon/CommonLibSSE-NG.git")
    add_versions("v3.7.0",
                 "c2fc2b5ac1c67ad4779bd0570c95fe494e0724f957a61880fa42cf74d1edce14")
    add_versions("v3.6.0",
                 "6f84c36f5747cff73d6a95bc7b9de84b11601648b218fd3e69edc884cc94a5a8")
    add_versions("v3.5.6",
                 "a3e1d4ec7496adca8310613fe75a2e08a9dbf562a9febec584b4e79aacc92bd3")
    add_versions("v3.5.5",
                 "5b00de66b9b8bc300244f14f1a281f26961931ba28ed0f4c9cce3a30a77c784a")

    add_configs("skyrim_se", {
        description = "Enable runtime support for Skyrim SE",
        default = true,
        type = "boolean"
    })
    add_configs("skyrim_ae", {
        description = "Enable runtime support for Skyrim AE",
        default = true,
        type = "boolean"
    })
    add_configs("skyrim_vr", {
        description = "Enable runtime support for Skyrim VR",
        default = true,
        type = "boolean"
    })
    add_configs("skse_xbyak", {
        description = "Enable trampoline support for Xbyak",
        default = false,
        type = "boolean"
    })
