package("unicorn", function()
    ...
    local archs = {
        "aarch64", "sparc", "sparc", "riscv64", "arm", "m68k", "x86_64",
        "s390x", "mips64", "sparc64", "ppc", "ppc64", "mipsel", "riscv32",
        "mips", "mips64el"
    }
    add_configs("arch", {
        description = "Select unicorn architecture for softmmu.",
        default = "aarch64",
        values = archs
    })
    ...
    on_install("windows", "macosx", "linux", function(package)
        local configs = {
            "-DUNICORN_BUILD_TESTS=OFF", "-DUNICORN_STATIC_MSVCRT=OFF"
        }
