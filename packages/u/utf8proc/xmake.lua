package("utf8proc", function()
    ...
    add_urls(
        "https://github.com/JuliaStrings/utf8proc/archive/refs/tags/$(version).tar.gz",
    ...
    add_deps("cmake")
    on_load("windows", "macosx", "linux", "android", "mingw", "bsd",
            function(package)
    ...
    on_install("windows", "macosx", "linux", "android", "mingw", "bsd",
               function(package)
    ...
    on_test(function(package)
        assert(package:has_cfuncs("utf8proc_encode_char",
                                  {includes = "utf8proc.h"}))
    end)
end)
