package("uuid_v4", function()
    ...
    add_urls(
        "https://github.com/crashoz/uuid_v4/archive/refs/tags/$(version).tar.gz",
        "https://github.com/crashoz/uuid_v4.git")

    add_versions("v1.0.0",
                 "0d858bc8e7466be693332f4f16768b29f605ff386443f37a07b1f872db29ff2d")
