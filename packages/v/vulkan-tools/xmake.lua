package("vulkan-tools", function()
    ...
    add_versions("1.2.198+0",
                 "06e174bca7834df73dc6ce3c2a72ab3bc34b63e16fdb9a486bf1315f02768032")
    add_versions("1.2.189+1",
                 "ef5db0934ff7192657bbfc675f6e3e1ee009f2ad34aab915d2bd9993a59add81")
    add_versions("1.2.162+0",
                 "8324a6dfd1bc20d4fad45c4ea56357d8354fc03e3e4529d0a4919f124d9e6106")
    add_versions("1.2.154+0",
                 "c7d66ec1f5fe5c0a13e487fe5c6eefd3a954522c0b05f06bd2ae41792aeea272")
    ...
    on_install("windows|x64", "linux", function(package)
        ...
        if package:is_plat("linux") then
            ...
            local linkdirs = {}
            for _, lib in ipairs({
                "wayland", "libxrandr", "libxcb", "libxkbcommon"
            }) do
        ...
        io.replace(path.join("icd", "CMakeLists.txt"),
                   "copy ${src_json} ${dst_json}",
                   "${CMAKE_COMMAND} -E copy ${src_json} ${dst_json}",
                   {plain = true})
        local configs = {}
        ...
        table.insert(configs, "-DVULKAN_LOADER_INSTALL_DIR=" ..
                         vulkan_loader:installdir())
