package("viennacl", function()
    ...
    add_urls("https://sourceforge.net/projects/viennacl/files/$(version).zip", {
        version = function(version)
            return format("%s.%s.x/ViennaCL-%s", version:major(),
                          version:minor(), version)
        end
    })
    add_versions("1.7.1",
                 "1e9ffaa9d1dd22202cbd10ec8a8450184bceb41bbd90ebe2effd50be2015a7f6")
