package("vexcl", function()
    ...
    add_urls(
        "https://github.com/ddemidov/vexcl/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ddemidov/vexcl.git")
    add_versions("1.4.2",
                 "3a2be30e303c4f44a269ca85de48f1a628127012f18abee0aa82c0c2cbb0e0c8")
    ...
    on_install("windows", "linux", "macosx", function(package)
        local configs = {
            "-DVEXCL_BUILD_TESTS=OFF", "-DVEXCL_BUILD_EXAMPLES=OFF",
