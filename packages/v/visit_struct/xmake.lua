package("visit_struct", function()
    ...
    add_urls(
        "https://github.com/cbeck88/visit_struct/archive/refs/tags/$(version).tar.gz",
        "https://github.com/garbageslam/visit_struct.git")
    add_versions('v1.1.0',
                 '73a84f2d8a8844bc03a919163b27ee3b3f85d8c64f6151ce098ca50dbed6be51')
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = {"visit_struct/visit_struct.hpp", "iostream"}
        }))
    end)
end)
