package("kvazaar", function()
    set_homepage("https://github.com/ultravideo/kvazaar")
    set_description("An open-source HEVC encoder")
    set_license("BSD-3-Clause")

    add_urls(
        "https://github.com/ultravideo/kvazaar/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ultravideo/kvazaar.git")

    add_versions("v2.3.1",
                 "c5a1699d0bd50bc6bdba485b3438a5681a43d7b2c4fd6311a144740bfa59c9cc")

    add_configs("cryptopp", {
        description = "Use crypto library",
        default = false,
        type = "boolean"
    })
    ...
    on_install("windows", "linux", "macosx", "mingw", function(package)
        ...
        table.insert(configs, "-DUSE_CRYPTO=" ..
                         (package:config("cryptopp") and "ON" or "OFF"))
