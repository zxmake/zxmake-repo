package("kompute", function()
    ...
    add_versions("v0.8.0",
                 "9752c6325735434e53fe6fca96946fc1a3212ff951039d1202f1c0606843b24e")
    ...
    on_install("windows", function(package)
        ...
        table.insert(configs, "-DKOMPUTE_OPT_BUILD_AS_SHARED_LIB=" ..
    ...
    on_test(function(package)
        assert(package:has_cxxtypes("kp::Manager",
                                    {includes = "kompute/Kompute.hpp"}))
    end)
    package_end()
end)
