package("kokkos-kernels", function()
    ...
    add_urls(
        "https://github.com/kokkos/kokkos-kernels/archive/refs/tags/$(version).tar.gz",
        "https://github.com/kokkos/kokkos-kernels.git")

    add_versions("4.4.00",
                 "6559871c091eb5bcff53bae5a0f04f2298971d1aa1b2c135bd5a2dae3f9376a2")
    add_versions("4.3.01",
                 "749553a6ea715ba1e56fa0b13b42866bb9880dba7a94e343eadf40d08c68fab8")
    add_versions("4.3.00",
                 "03c3226ee97dbca4fa56fe69bc4eefa0673e23c37f2741943d9362424a63950e")
    add_versions("4.2.01",
                 "058052b3a40f5d4e447b7ded5c480f1b0d4aa78373b0bc7e43804d0447c34ca8")
    add_versions("4.0.01",
                 "3f493fcb0244b26858ceb911be64092fbf7785616ad62c81abde0ea1ce86688a")
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset then
                ...
                assert(minor and minor >= 30,
                       "package(kokkos-kernels) require vs_toolset >= 14.3")
            end
        end)
    end
    ...
    on_install("windows|x64", "macosx|x86_64", "linux", function(package)
        ...
        import("package.tools.cmake").install(package, configs, {
            buildir = path.join(os.tmpdir(), "kk-build")
        })
    end)
