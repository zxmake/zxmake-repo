package("soundtouch", function()
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DINTEGER_SAMPLES=" ..
                         (package:config("integers_samples") and "ON" or "OFF"))
        table.insert(configs, "-DSOUNDTOUCH_DLL=" ..
                         (package:config("dll") and "ON" or "OFF"))
        table.insert(configs, "-DOPENMP=" ..
                         (package:config("openmp") and "ON" or "OFF"))
        if package:is_arch("arm.*") then
            table.insert(configs, "-DNEON=" ..
