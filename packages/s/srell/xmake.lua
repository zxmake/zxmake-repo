package("srell", function()
    ...
    add_urls("https://akenotsuki.com/misc/srell/srell$(version).zip", {
        version = function(version)
            return version:gsub("%.", "_")
        end
    })
    add_versions("4.019",
                 "b4281825c529c7f63b61917782b33066a93cd40b55efbcac13c1ef615cd29835")
    add_versions("3.018",
                 "0cb7587b3613085204ed847259cb46a54f7328aef90a0ce85a1eaa895a755ccf")
