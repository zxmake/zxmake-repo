package("svector", function()
    ...
    add_urls(
        "https://github.com/martinus/svector/archive/refs/tags/$(version).tar.gz",
        "https://github.com/martinus/svector.git")

    add_versions("v1.0.3",
                 "40d597f5d8ade27059bef49012f23f2147c1a7dfbcd45492bb1057620c434b4f")
