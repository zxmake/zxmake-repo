package("swig", function()
    ...
    if is_host("windows") then
        add_urls(
            "https://sourceforge.net/projects/swig/files/swigwin/swigwin-$(version)/swigwin-$(version).zip")
        add_versions("4.0.2",
                     "daadb32f19fe818cb9b0015243233fc81584844c11a48436385e87c050346559")
        add_versions("4.1.1",
                     "2ec3107e24606db535d77ef3dbf246dc6eccbf1d5c868dce365d7f7fb19a1a51")
    else
        add_urls(
            "https://sourceforge.net/projects/swig/files/swig/swig-$(version)/swig-$(version).tar.gz")
        add_versions("4.0.2",
        ...
        if package:version():ge("4.1") then
            ...
            if pcre2 and not pcre2:is_system() then
                table.insert(configs,
                             "--with-pcre2-prefix=" .. pcre2:installdir())
            end
        else
