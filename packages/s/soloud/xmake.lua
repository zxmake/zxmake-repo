package("soloud", function()
    ...
    add_urls(
        "https://github.com/jarikomppa/soloud/archive/refs/tags/RELEASE_$(version).zip",
        {
            version = function(version)
                return version:gsub("%.", "")
            end
        })
    add_versions("2020.02.07",
                 "ad3a6ee2020150e33e72911ce46bbfe26f9c84ec08ff8d7f22680ce4970f7fd3")

    add_deps("miniaudio")
    add_patches("2020.02.07",
                path.join(os.scriptdir(), "patches", "miniaudio_v11.patch"),
                "d98b6727a159c3dccd45de872b321a1c180bc353af08d4bdce4e298f4de14f21")
