package("streamvbyte", function()
    ...
    add_urls(
        "https://github.com/lemire/streamvbyte/archive/refs/tags/$(version).tar.gz",
        "https://github.com/lemire/streamvbyte.git")

    add_versions("v1.0.0",
                 "6b1920e9865146ba444cc317aa61cd39cdf760236e354ef7956011a9fe577882")
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DSTREAMVBYTE_SANITIZE=" ..
                         (package:config("asan") and "ON" or "OFF"))
        import("package.tools.cmake").install(package, configs)
    end)

    on_test(function(package)
        assert(package:has_cfuncs("streamvbyte_encode",
                                  {includes = "streamvbyte.h"}))
    end)
end)
