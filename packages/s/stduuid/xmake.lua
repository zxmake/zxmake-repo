package("stduuid", function()
    ...
    add_urls(
        "https://github.com/mariusbancila/stduuid/archive/refs/tags/$(version).tar.gz",
        "https://github.com/mariusbancila/stduuid.git")

    add_versions("v1.2.3",
                 "b1176597e789531c38481acbbed2a6894ad419aab0979c10410d59eb0ebf40d3")
