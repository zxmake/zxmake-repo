package("sqlite3", function()
    ...
    on_install(function(package)
        ...
        if package:is_plat(os.host()) and
            (package:is_arch(os.arch()) or package:is_plat("windows")) then
            xmake_lua = xmake_lua .. [[
