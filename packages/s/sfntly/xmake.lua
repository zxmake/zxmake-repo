package("sfntly", function()
    ...
    add_urls("https://github.com/googlefonts/sfntly/archive/$(version).zip", {
        version = function(version)
            return commits[tostring(version)]
        end
    })
    add_versions("20190917",
                 "8b27d570624dcbe1769c64274c75cfce4afc9d12893b0b8acba090e5c870e51f")
