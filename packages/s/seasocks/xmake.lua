package("seasocks", function()
    ...
    add_urls(
        "https://github.com/mattgodbolt/seasocks/archive/refs/tags/$(version).tar.gz",
        "https://github.com/mattgodbolt/seasocks.git")

    add_versions("v1.4.6",
                 "fc69636ce1205d338d4c02784333b04cd774fa368843fcf9f4fe6f8530a2cd67")

    add_configs("deflate", {
        description = "Include support for deflate (requires zlib).",
        default = false,
        type = "boolean"
    })
    ...
    on_install("windows", "linux", "bsd", function(package)
        ...
        table.insert(configs, "-DSEASOCKS_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DDEFLATE_SUPPORT=" ..
                         (package:config("deflate") and "ON" or "OFF"))
