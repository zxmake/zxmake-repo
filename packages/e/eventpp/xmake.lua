package("eventpp", function()
    ...
    add_urls(
        "https://github.com/wqking/eventpp/archive/refs/tags/$(version).tar.gz",
        "https://github.com/wqking/eventpp.git")

    add_versions("v0.1.3",
                 "d87aba67223fd9aced2ba55eb82bd534007e43e1b919106a53fcd3070fa125ea")
