package("ezc3d", function()
    ...
    add_urls(
        "https://github.com/pyomeca/ezc3d/archive/refs/tags/Release_$(version).tar.gz")
    add_versions("1.4.5",
                 "01602b2ccfc0edd88089e89d249e10086022f7ed7ef40caa3eb3b048ccfa40aa")
    add_versions("1.4.7",
                 "b11921ecd9ff5716f19b4a4eeede36f8cfa5ff08e6fd2c9c12e55f83e9d782bd")
