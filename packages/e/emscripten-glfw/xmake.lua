package("emscripten-glfw", function()
    set_homepage(
    ...
    add_urls(
        "https://github.com/pongasoft/emscripten-glfw/archive/refs/tags/$(version).tar.gz",
        {
    ...
    add_versions("2024.09.07",
                 "ad4eea0c52ce61921da18e9fc8b6402a4a2e4515a8c783e2f1ae62671ab23fe3")

    add_configs("joystick", {
        description = "Enable joystick support",
        default = true,
        type = "boolean"
    })
    add_configs("multi_window", {
        description = "Enable multi window support",
        default = true,
        type = "boolean"
    })
    ...
    on_install("wasm", function(package)
        ...
        table.insert(configs, "-DEMSCRIPTEN_GLFW3_DISABLE_JOYSTICK=" ..
                         (package:config("joystick") and "OFF" or "ON"))
        table.insert(configs,
                     "-DEMSCRIPTEN_GLFW3_DISABLE_MULTI_WINDOW_SUPPORT =" ..
                         (package:config("multi_window") and "OFF" or "ON"))
        import("package.tools.cmake").install(package, configs)

        package:add("ldflags", "--js-library",
    ...
    on_test(function(package)
        ...
        assert(package:has_cfuncs("emscripten_glfw_open_url",
                                  {includes = "GLFW/emscripten_glfw3.h"}))
    end)
end)
