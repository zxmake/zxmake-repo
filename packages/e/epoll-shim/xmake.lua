package("epoll-shim", function()
    ...
    add_urls(
        "https://github.com/jiixyj/epoll-shim/archive/refs/tags/$(version).tar.gz",
        "https://github.com/jiixyj/epoll-shim.git")

    add_versions("v0.0.20240608",
    ...
    on_test(function(package)
        ...
        assert(
            package:has_cfuncs("timerfd_create", {includes = "sys/timerfd.h"}))
    end)
end)
