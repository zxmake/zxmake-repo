package("boringssl", function()
    set_homepage("https://boringssl.googlesource.com/boringssl")
    set_description(
        "BoringSSL is a fork of OpenSSL that is designed to meet Google's needs.")

    add_urls(
        "https://github.com/google/boringssl/archive/refs/tags/$(version).tar.gz",
        {
    ...
    add_patches("2022.06.13",
                path.join(os.scriptdir(), "patches", "2022.06.13", "cmake.patch"),
                "c44e5c2b4b4f010a6fab1c0bce22a50feb5d85f37a870cf9a71f8d58bdfbd169")
    add_patches("2021.12.29",
                path.join(os.scriptdir(), "patches", "2021.12.29", "cmake.patch"),
    ...
    on_load("windows", function(package)
        if package:is_plat("windows") and package:version():ge("2022.06.13") and
        ...
        if package:version():ge("2022.06.13") then
            ...
            if package:config("shared") then
                ...
                elseif package:is_plat("macosx") then
                    ...
                    os.cp("build/crypto/libcrypto.dylib",
