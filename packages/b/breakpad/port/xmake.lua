...
if is_plat("android") then
    ...
    remove_headerfiles("src/processor/*test*.h",
    ...
    if is_plat("windows") then
        add_defines("UNICODE", "WIN32_LEAN_AND_MEAN", "_CRT_SECURE_NO_WARNINGS",
        ...
        remove_files("src/common/windows/*test*.cc", "src/common/language.cc",
                     "src/common/path_helper.cc",
                     "src/common/stabs_to_module.cc",
                     "src/common/stabs_reader.cc", "src/common/dwarf*.cc",
        ...
        remove_headerfiles("src/common/windows/*test*.h",
                           "src/common/language.h", "src/common/path_helper.h",
                           "src/common/stabs_to_module.h",
                           "src/common/stabs_reader.h", "src/common/dwarf*.h",
        ...
        if is_plat("macosx") then
            ...
            add_files("src/common/mac/MachIPC.mm", "src/common/mac/*.cc",
...
on_config(function(target)
    ...
    elseif not target:is_plat("macosx") then
        if target:has_cfuncs("getcontext", {includes = "ucontext.h"}) then
            ...
            target:add("files", path.join(os.projectdir(),
