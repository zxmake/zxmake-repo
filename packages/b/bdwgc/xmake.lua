...
add_versions("v8.2.6",
             "3bfc2b1dd385bfb46d2dab029211a66249a309795b6893f4e00554904999e40a")
add_versions("v8.2.4",
             "18e63ab1428bd52e691da107a6a56651c161210b11fbe22e2aa3c31f7fa00ca5")
    ...
    on_check("android", function(package)
        if package:is_arch("armeabi-v7a") then
            ...
            assert(ndk_sdkver and tonumber(ndk_sdkver) > 21,
                   "package(bdwgc/armeabi-v7a): need ndk api level > 21")
        end
    end)
end
...
on_install("!wasm", function(package)
    ...
    import("package.tools.cmake").install(package, configs,
                                          {packagedeps = "libatomic_ops"})

    if package:is_plat("windows", "mingw", "cygwin") then
        package:add("defines",
                    (package:config("shared") and "GC_DLL" or "GC_NOT_DLL"))
    end
end)
