package("backportcpp", function()
    ...
    add_urls(
        "https://github.com/bitwizeshift/BackportCpp/archive/refs/tags/$(version).tar.gz",
        "https://github.com/bitwizeshift/BackportCpp.git")

    add_versions("v1.2.0",
                 "8efded40a1d0e6674824336499d8706043a62bd8ae8aef62210c8c215f710b84")
