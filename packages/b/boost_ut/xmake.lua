package("boost_ut", function()
    ...
    add_urls(
        "https://github.com/boost-ext/ut/archive/refs/tags/$(version).tar.gz")
    add_urls("https://github.com/boost-ext/ut.git")
    add_versions("v2.1.0",
                 "1c9c35c039ad3a9795a278447db6da0a4ec1a1d223bf7d64687ad28f673b7ae8")
    add_versions("v1.1.9",
                 "1a666513157905aa0e53a13fac602b5673dcafb04a869100a85cd3f000c2ed0d")
    add_versions("v2.0.1",
                 "1e43be17045a881c95cedc843d72fe9c1e53239b02ed179c1e39e041ebcd7dad")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            configs = {languages = "c++20", defines = "BOOST_UT_DISABLE_MODULE"},
            includes = "boost/ut.hpp"
        }))
    end)
end)
