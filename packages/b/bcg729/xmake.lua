package("bcg729", function()
    ...
    add_urls(
        "https://github.com/BelledonneCommunications/bcg729/archive/refs/tags/$(version).tar.gz",
    ...
    on_test(function(package)
        assert(package:has_cfuncs("bcg729Decoder",
                                  {includes = "bcg729/decoder.h"}))
        assert(package:has_cfuncs("bcg729Encoder",
                                  {includes = "bcg729/encoder.h"}))
    end)
end)
