package("brynet", function()
    ...
    add_urls(
        "https://github.com/IronsDu/brynet/archive/337c9f375800b46da77116687a61c00ce534b60f.tar.gz",
        "https://github.com/IronsDu/brynet")

    add_versions("2024.06.03",
                 "d35271b8f635959c6507c3bba24ff1ee121c6f27db177564012e54654e813ab8")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "brynet/net/TcpService.hpp"
        }))
    end)
end)
