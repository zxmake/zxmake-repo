package("better-enums", function()
    ...
    add_urls(
        "https://github.com/aantron/better-enums/archive/refs/tags/$(version).tar.gz",
        "https://github.com/aantron/better-enums.git")
    add_versions("0.11.3",
                 "1b1597f0aa5452b971a94ab13d8de3b59cce17d9c43c8081aa62f42b3376df96")

    on_install(function(package)
        os.cp("enum.h", package:installdir(path.join("include", "better-enums")))
        os.cp("extra/better-enums/*.h",
              package:installdir(path.join("include", "better-enums")))
    end)
