package("bqlog", function()
    ...
    add_urls(
        "https://github.com/Tencent/BqLog/archive/refs/tags/Release_$(version).tar.gz",
        "https://github.com/Tencent/BqLog.git")

    add_versions("1.4.4",
                 "c32a8eae1f935a0dfc2d67e93b0d6cad6a0c551d65e72b10713da304ab33ee11")
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset then
                ...
                assert(minor and minor >= 30,
                       "package(bqlog) require vs_toolset >= 14.3")
            end
        end)
    end

    on_install("windows|x64", "linux", "macosx", "bsd", "android", "iphoneos",
               function(package)
        ...
        table.insert(configs, "-DBUILD_TYPE=" ..
                         (package:config("shared") and "dynamic_lib" or
                             "static_lib"))
