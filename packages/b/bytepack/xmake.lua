package("bytepack", function()
    ...
    add_urls(
        "https://github.com/farukeryilmaz/bytepack/archive/refs/tags/$(version).tar.gz",
        "https://github.com/farukeryilmaz/bytepack.git")

    add_versions("v0.1.0",
                 "7761cf51736d4e1a65ca69323182930967846eaed04adddfd316f59a5c2eb244")
    ...
    on_check(function(package)
        assert(package:check_cxxsnippets({
            ...
            void test() {
               ...
               "package(bytepack) Require at least C++20.")
    end)
