package("blitz", function()
    ...
    add_urls(
        "https://github.com/blitzpp/blitz/archive/refs/tags/$(version).zip",
        "https://github.com/blitzpp/blitz.git")
    add_versions("1.0.2",
                 "a477b9692a47363fce5929bba6d6d230773ddfbb020ce6841f7a961a55b9e71f")
    ...
    on_install("windows", "macosx", "linux", function(package)
        io.replace("src/CMakeLists.txt", "SHARED",
