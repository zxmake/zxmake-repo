package("blosc", function()
    ...
    add_urls(
        "https://github.com/Blosc/c-blosc/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Blosc/c-blosc.git")
    add_versions("v1.21.6",
                 "9fcd60301aae28f97f1301b735f966cc19e7c49b6b4321b839b4579a0c156f38")
    add_versions("v1.21.5",
                 "32e61961bbf81ffea6ff30e9d70fca36c86178afd3e3cfa13376adec8c687509")
    add_versions("v1.21.4",
                 "e72bd03827b8564bbb3dc3ea0d0e689b4863871ce3861d946f2efd7a186ecf3e")
    add_versions("v1.21.1",
                 "f387149eab24efa01c308e4cba0f59f64ccae57292ec9c794002232f7903b55b")
    add_versions("v1.20.1",
                 "42c4d3fcce52af9f8e2078f8f57681bfc711706a3330cb72b9b39e05ae18a413")
    add_versions("v1.5.0",
                 "208ba4db0e5116421ed2fbbdf2adfa3e1d133d29a6324a0f47cf2d71f3810c92")
    ...
    on_install("macosx", "linux", "windows", "mingw", function(package)
        local configs = {
            ...
            "-DBUILD_BENCHMARKS=OFF", "-DPREFER_EXTERNAL_COMPLIBS=ON"
        }
        ...
        for name, enabled in pairs(package:configs()) do
            if not package:extraconf("configs", name, "builtin") then
                table.insert(configs, "-DDEACTIVATE_" .. name:upper() .. "=" ..
                                 (enabled and "OFF" or "ON"))
                table.insert(configs,
                             "-DPREFER_EXTERNAL_" .. name:upper() .. "=ON")
            end
        end
        ...
        if package:is_plat("windows", "mingw") then
            ...
            if package:config("shared") then
                ...
                os.trymv(path.join(package:installdir("lib"), "blosc.dll"),
            ...
            elseif version:le("1.10") then
                ...
                os.mv(path.join(package:installdir("lib"), "libblosc.lib"),
                      path.join(package:installdir("lib"), "blosc.lib"))
            end
        end
    end)
    ...
    on_test(function(package)
        ...
        }, {configs = {languages = "c++11"}, includes = {"blosc.h"}}))
    end)
end)
