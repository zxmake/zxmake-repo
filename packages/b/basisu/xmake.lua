package("basisu", function()
    ...
    on_install(function(package)
        io.replace("encoder/basisu_comp.cpp", "../zstd/zstd.h", "zstd.h",
                   {plain = true})
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "basisu/transcoder/basisu_transcoder.h"
        }))
    end)
end)
