package("buddy", function()
    set_homepage("https://github.com/xmake-mirror/Buddy")
    set_description("Binary Decision Diagrams")

    add_urls(
        "https://github.com/xmake-mirror/Buddy/archive/refs/tags/$(version).tar.gz",
        "https://github.com/xmake-mirror/Buddy.git")
    add_versions("2.4",
                 "01f7fb04f389c6ba89ef759ea903a217acdaba5c5f7c5d137eb1e2327cb60675")
