package("bgfx", function()
    ...
    add_resources("7816", "bx", "https://github.com/bkaradzic/bx.git",
                  "51f25ba638b9cb35eb2ac078f842a4bed0746d56")
    add_resources("8203", "bx", "https://github.com/bkaradzic/bx.git",
                  "b9501348c596b68e5e655a8308df5c55f61ecd80")
    add_resources("8674", "bx", "https://github.com/bkaradzic/bx.git",
                  "67dfdf34f642a4a807b75eb600f82f4f04027963")
    add_resources("8752", "bx", "https://github.com/bkaradzic/bx.git",
                  "0ec634e8fdf8c810f9911c686a8158088ae25379")
    add_resources("7816", "bimg", "https://github.com/bkaradzic/bimg.git",
                  "8355d36befc90c1db82fca8e54f38bfb7eeb3530")
    add_resources("8203", "bimg", "https://github.com/bkaradzic/bimg.git",
                  "663f724186e26caf46494e389ed82409106205fb")
    add_resources("8674", "bimg", "https://github.com/bkaradzic/bimg.git",
                  "964a5b85483cdf59a30dc006e9bd8bbdde6cb2be")
    add_resources("8752", "bimg", "https://github.com/bkaradzic/bimg.git",
                  "61a7e9ebe7e33c821cf80b0542dcf23088446f5b")
    ...
    elseif is_plat("iphoneos") then
        add_frameworks("OpenGLES", "CoreGraphics", "Metal", "QuartzCore",
                       "UIKit")
    ...
    on_load("windows", "macosx", "linux", "iphoneos", function(package)
        ...
        package:add("defines",
                    "BX_CONFIG_DEBUG=" .. (package:debug() and "1" or "0"))
    end)
    ...
    on_install("windows|native", "macosx", "linux", "iphoneos",
        ...
        os.trycp(path.join(bimgdir, "include", "*"),
        ...
        if package:is_plat("windows") then
            ...
            os.trycp("../../win*_vs*/bin/*.lib|*example*",
            ...
            if package:is_plat("macosx") then
                target =
                    (package:is_arch("x86_64") and "osx-x64" or "osx-arm64")
                table.insert(args, "--gcc=" .. target)
                configs = {
                    "-C", ".build/projects/gmake-" .. target,
                    "config=" .. mode:lower()
                }
            ...
            elseif package:is_plat("linux") then
                ...
                target =
                    "linux" .. (package:is_arch("x86_64") and "64" or "32") ..
                        "_gcc"
                configs = {
                    "-C", ".build/projects/gmake-linux",
                    "config=" .. mode:lower() ..
                        (package:is_arch("x86_64") and "64" or "32")
                }
            end
            ...
            if package:is_plat("macosx", "iphoneos") then
                os.trycp(".build/" .. target .. "/bin/*.a|*example*",
                         package:installdir("lib"))
                os.trycp(".build/" .. target .. "/bin/*.dylib",
                         package:installdir("lib"))
                os.trycp(".build/" .. target .. "/bin/*|*.*",
                         package:installdir("bin"))
            elseif package:is_plat("linux") then
                os.trycp(".build/" .. target .. "/bin/*.a|*example*",
                         package:installdir("lib"))
                os.trycp(".build/" .. target .. "/bin/*.so",
                         package:installdir("lib"))
                os.trycp(".build/" .. target .. "/bin/*|*.*",
                         package:installdir("bin"))
            end
