package("blend2d", function()
    ...
    add_configs("jit", {
        description = "Enable JIT compiler support",
        default = true,
        type = "boolean"
    })
    ...
    on_check("windows", function(package)
        ...
        if msvc and package:is_arch("arm.*") then
            ...
            assert(vs and tonumber(vs) >= 2022,
                   "package(blend2d/arm): need vs >= 2022")
        end
    end)
    ...
    on_install("!iphoneos", function(package)
        ...
        table.insert(configs, "-DBLEND2D_STATIC=" ..
                         (package:config("shared") and "FALSE" or "TRUE"))
