package("plusaes", function()
    ...
    add_urls(
        "https://github.com/kkAyataka/plusaes/archive/refs/tags/$(version).tar.gz",
        "https://github.com/kkAyataka/plusaes.git")

    add_versions("v1.0.0",
                 "0e33e8d0e2ea5e6f9eb7a06093f576350ce8ef58339ce9de791514a8f433087d")
