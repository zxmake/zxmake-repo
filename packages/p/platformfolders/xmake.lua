package("platformfolders", function()
    ...
    add_urls(
        "https://github.com/sago007/PlatformFolders/archive/refs/tags/$(version).tar.gz",
        "https://github.com/sago007/PlatformFolders.git")

    add_versions("4.2.0",
                 "31bb0f64a27315aec8994f226332aaafe9888d00bb69a2ff2dff9912e2f4ccf4")

    add_patches("4.2.0", "patches/4.2.0/cmake-install.patch",
                "a38850ff7e9b91034f226685af7633ff692de3aea4798cb3dddecc6b055a7601")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "sago/platform_folders.h"
        }))
    end)
end)
