package("pe-parse", function()
    set_homepage("https://github.com/trailofbits/pe-parse")
    set_description("Principled, lightweight C/C++ PE parser")
    set_license("MIT")

    add_urls(
        "https://github.com/trailofbits/pe-parse/archive/f2f0ee91f3b6dee41f75b2f775e82015f2b72007.tar.gz",
        "https://github.com/trailofbits/pe-parse.git")

    add_versions("2024.06.04",
                 "f20594916452f868a55928ef99945dbbd416387e320101b1bf63f9dcff4af628")
    ...
    on_install(function(package)
        io.replace("cmake/compilation_flags.cmake", "-Werror", "",
                   {plain = true})
        ...
        table.insert(configs, "-DBUILD_COMMAND_LINE_TOOLS=" ..
