package("pupnp", function()
    ...
    add_urls(
        "https://github.com/pupnp/pupnp/archive/refs/tags/release-$(version).tar.gz")
    add_versions("1.14.12",
                 "6a7f26818d5aa3949bc2e68739387a261c564430ba612f793c61d31619dde1e4")
    ...
    on_install("linux", "macosx", function(package)
        ...
        table.insert(configs, "-DUPNP_BUILD_STATIC=" ..
                         (package:config("shared") and "OFF" or "ON"))
        table.insert(configs, "-DUPNP_BUILD_SHARED=" ..
