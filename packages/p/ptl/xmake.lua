package("ptl", function()
    ...
    add_urls(
        "https://github.com/jrmadsen/PTL/archive/refs/tags/$(version).tar.gz",
        "https://github.com/jrmadsen/PTL.git")
    add_versions("v2.0.0",
                 "58e561a3a1de75679faf4d8760d2ff045ced232d4367157b5b4e4f26c8474721")
    ...
    on_install("windows", "macosx", "linux", function(package)
        io.replace("cmake/Templates/PTLConfig.cmake.in", "if(WIN32)",
                   "if(FALSE)", {plain = true})
        local configs = {}
        ...
        table.insert(configs, "-DPTL_USE_TBB=" ..
                         (package:config("tbb") and "ON" or "OFF"))
