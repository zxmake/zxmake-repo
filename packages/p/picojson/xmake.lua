package("picojson", function()
    ...
    add_urls(
        "https://github.com/kazuho/picojson/archive/refs/tags/$(version).tar.gz",
        "https://github.com/kazuho/picojson.git")
    add_versions("v1.3.0",
                 "056805ca2691798f5545935a14bb477f2e1d827c9fb862e6e449dbea22801c7d")
