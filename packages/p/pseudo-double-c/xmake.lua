package("pseudo-double-c", function()
    ...
    on_install("windows|x64", "linux|x86_64", "macosx", "bsd", "android|arm64*",
               "wasm", function(package)
        local configs = {}
        io.replace("pseudo_double.h", "#include <stdint.h>",
        ...
        package:add("defines", "PSEUDO_DOUBLE_EXP_BITS=" ..
                        package:config("pseudo_double_exp_bits"))
        package:add("defines", "PD_ERROR_CHECK=" ..
                        (package:config("pd_error_check") and "1" or "0"))
