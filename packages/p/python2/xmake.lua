package("python2", function()
    ...
    if is_host("windows") then
        if is_arch("x86", "i386") or os.arch() == "x86" then
            add_urls(
                "https://cdn.jsdelivr.net/gh/xmake-mirror/python-releases@$(version)/python-$(version).win32.tar.gz",
            ...
            add_versions("2.7.15",
                         "4a7be2b440b74776662daaeb6bb6c5574bb6d0f4ddc0ad03ce63571ab2353303")
            add_versions("2.7.18",
                         "9efaf273aa2e7d23fa22efa2936619ec91cf9ee189f707e375f9063fadeabcd6")
        else
            add_urls(
                "https://cdn.jsdelivr.net/gh/xmake-mirror/python-releases@$(version)/python-$(version).win64.tar.gz",
            ...
            add_versions("2.7.15",
                         "c81c4604b4176ff26be8d37cf48a2582e71a5e8f475b531c2e5d032a39511acb")
            add_versions("2.7.18",
                         "0e1adec089c4358b4ff1cd392c8bd7c975e0bf7c279aee91e7aaa04c00fb2c10")
        end
    else
        set_urls(
    ...
    on_install("@macosx", "@linux", function(package)
        ...
        if package:is_plat("macosx") then
            ...
            if not xcode_dir or not xcode_sdkver then
                ...
                local xcode = import("detect.sdks.find_xcode")(nil, {
                    force = true,
                    plat = package:plat(),
                    arch = package:arch()
                })
            ...
            if xcode_dir and xcode_sdkver then
                ...
                table.insert(cflags, "-I" .. path.join(xcode_sdkdir,
        ...
        if #linkdirs > 0 and #includedirs > 0 then
            io.replace("setup.py", "    def detect_modules(self):",
                       format([[    def detect_modules(self):
        linkdirs = ['%s']
        includedirs = ['%s']
...
]], table.concat(linkdirs, "', '"), table.concat(includedirs, "', '")),
                       {plain = true})
        end
