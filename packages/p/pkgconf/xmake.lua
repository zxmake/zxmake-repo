package("pkgconf", function()
    ...
    on_install("@windows", function(package)
        ...
        os.cp(path.join(bindir, "pkgconf.exe"),
              path.join(bindir, "pkg-config.exe"))
    end)
