package("perlinnoise", function()
    ...
    add_urls(
        "https://github.com/Reputeless/PerlinNoise/archive/refs/tags/$(version).tar.gz",
        "https://github.com/Reputeless/PerlinNoise.git")

    add_versions("v3.0.0",
                 "1fea1e7ebeb3c66b79d60c2c398aa83ccfadcef343bd396c0f0a684380e827fc")
