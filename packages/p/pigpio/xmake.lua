package("pigpio", function()
    set_homepage("https://github.com/joan2937/pigpio")
    set_description(
        "pigpio is a C library for the Raspberry which allows control of the General Purpose Input Outputs (GPIO).")

    add_urls(
        "https://github.com/joan2937/pigpio/archive/refs/tags/$(version).tar.gz",
        "https://github.com/joan2937/pigpio.git")

    add_versions("v79",
                 "c5337c0b7ae888caf0262a6f476af0e2ab67065f7650148a0b21900b8d1eaed7")
