package("patch", function()
    ...
    if is_host("windows") then
        add_urls(
            "https://gitlab.com/xmake-mirror/patch/uploads/2ff76c0c6a35a4a6af98bb7052544c38/patch-$(version)-bin.zip")
        add_urls(
            "https://github.com/xmake-mirror/patch/releases/download/v2.5.9/patch-$(version)-bin.zip")
        add_versions("2.5.9-7",
        ...
        add_versions("2.7.6",
                     "3d1d001210d76c9f754c12824aa69f25de7cb27bb6765df63455b77601a0dcc9")
    end
