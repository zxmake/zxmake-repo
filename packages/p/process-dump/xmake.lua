package("process-dump", function()
    ...
    add_urls(
        "https://github.com/glmcdona/Process-Dump/archive/refs/tags/$(version).tar.gz",
        "https://github.com/glmcdona/Process-Dump.git")

    add_versions("v2.1.1",
                 "cd4e2327ce8fae5228d4790c73e4f3add9bff86e8f27ac9bcfc18f3373f61461")
