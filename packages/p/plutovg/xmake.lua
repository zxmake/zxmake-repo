package("plutovg", function()
    set_homepage("https://github.com/sammycage/plutovg")
    set_description("Tiny 2D vector graphics library in C")
    set_license("MIT")

    add_urls(
        "https://github.com/sammycage/plutovg/archive/refs/tags/$(version).tar.gz",
        "https://github.com/sammycage/plutovg.git")

    add_versions("v0.0.7",
                 "31e264b6f451a0d18335d1596817c2b7f58e2fc6efeb63aac0ff9a7fbfc07c00")
    add_versions("v0.0.6",
                 "3be0e0d94ade3e739f60ac075c88c2e40d84a0ac05fc3ff8c7c97d0749e9a82b")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("plutovg_surface_create",
                                  {includes = "plutovg/plutovg.h"}))
    end)
end)
