package("redex", function()
    ...
    add_includedirs("include/redex/libredex", "include/redex/libresource",
                    "include/redex/liblocator", "include/redex/shared",
                    "include/redex/sparta", "include/redex/tools",
                    "include/redex/tools/common", "include/redex/tools/tools",
                    "include/redex/util", "include/redex/service")
    ...
    on_install("linux", "macosx", function(package)
        ...
        if not package:config("shared") then
            ...
            if jsoncpp and jsoncpp.libfiles then
                table.insert(configs, "-DJSONCPP_LIBRARY_STATIC=" ..
                                 table.unwrap(jsoncpp.libfiles):gsub("\\", "/"))
            end
        end
    ...
    on_test(function(package)
        assert(package:has_cxxtypes("DexLoader", {
            includes = "DexLoader.h",
