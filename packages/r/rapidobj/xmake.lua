package("rapidobj", function()
    ...
    add_urls(
        "https://github.com/guybrush77/rapidobj/archive/refs/tags/$(version).tar.gz",
        "https://github.com/guybrush77/rapidobj.git")

    add_versions("v1.1",
                 "87640b4d70905081552d31a36e6b68a947e167ba379a7032a056986c16f716d3")
    ...
    if on_check then
        on_check("android", function(package)
            ...
            assert(ndk_sdkver and tonumber(ndk_sdkver) > 21,
                   "package(rapidobj): need ndk api level  > 21 for android")
        end)
    end
    ...
    on_install("!wasm and !bsd", function(package)
        ...
        table.insert(configs, "-DRAPIDOBJ_BuildTools=" ..
