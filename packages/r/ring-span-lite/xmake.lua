package("ring-span-lite", function()
    ...
    add_urls(
        "https://github.com/martinmoene/ring-span-lite/archive/refs/tags/$(version).tar.gz",
        "https://github.com/martinmoene/ring-span-lite.git")

    add_versions("v0.7.0",
                 "7650bb1bcf76cb0f7ac75240c5346203cbe7eb7027c0843c60253f6db08a93c1")
