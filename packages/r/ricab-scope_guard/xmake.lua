package("ricab-scope_guard", function()
    ...
    add_urls(
        "https://github.com/ricab/scope_guard/archive/refs/tags/$(version).tar.gz",
        "https://github.com/ricab/scope_guard.git")

    add_versions("v1.1.0",
                 "ddaf22ccd07e59af4698e2b9f912171adb664dc88f34b317f39dde3b88de4507")
