...
target("DebugUtils")
set_kind("static")
add_includedirs("DebugUtils/Include", "Detour/Include",
                "DetourTileCache/Include", "Recast/Include")
...
target("DetourCrowd")
set_kind("static")
add_includedirs("DetourCrowd/Include", "Detour/Include", "Recast/Include")
add_headerfiles("DetourCrowd/Include/*.h")
add_files("DetourCrowd/Source/*.cpp")

target("DetourTileCache")
set_kind("static")
add_includedirs("DetourTileCache/Include", "Detour/Include", "Recast/Include")
