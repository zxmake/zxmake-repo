package("json-c", function()
    ...
    add_urls(
        "https://github.com/json-c/json-c/archive/refs/tags/json-c-$(version).tar.gz",
        {
            version = function(version)
                local list = {["0.17"] = "20230812"}
                return version .. "-" .. list[tostring(version)]
            end
        })

    add_versions("0.17",
                 "024d302a3aadcbf9f78735320a6d5aedf8b77876c8ac8bbb95081ca55054c7eb")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("json_object_new_object",
