package("json-schema-validator", function()
    set_homepage("https://github.com/pboettch/json-schema-validator")
    set_description("JSON schema validator for JSON for Modern C++")

    add_urls(
        "https://github.com/pboettch/json-schema-validator/archive/refs/tags/$(version).tar.gz",
        "https://github.com/pboettch/json-schema-validator.git")
    add_versions("2.1.0",
                 "83f61d8112f485e0d3f1e72d51610ba3924b179926a8376aef3c038770faf202")
    add_versions("2.3.0",
                 "2c00b50023c7d557cdaa71c0777f5bcff996c4efd7a539e58beaa4219fa2a5e1")
    ...
    on_install("linux", "bsd", "windows", "macosx", "iphoneos", "mingw",
