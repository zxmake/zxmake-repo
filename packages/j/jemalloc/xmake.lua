...
fragmentation avoidance and scalable concurrency support]])
    ...
    add_patches("5.2.1", path.join(os.scriptdir(), "patches", "5.2.1",
                                   "fix_nothrow_type.patch"),
                "d79f5c8767695059ff541f291db3fbc57c9b67299dc129848dd365c2f51b214a")
    ...
    on_install("linux", "macosx", "mingw@macosx", function(package)
        local configs = {"--disable-debug", "--with-jemalloc-prefix="}
