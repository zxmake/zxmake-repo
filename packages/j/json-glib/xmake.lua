package("json-glib", function()
    ...
    add_urls(
        "https://github.com/GNOME/json-glib/archive/refs/tags/$(version).tar.gz")
    add_versions("1.10.0",
                 "447890f9de2a04c312871768208f6c8aeec4069392af7605bc77e61165dcb374")
    add_versions("1.9.2",
    ...
    on_install("linux", function(package)
        local configs = {
            "-Ddocumentation=disabled", "-Dtests=false", "-Dgtk_doc=disabled",
            "-Dman=false"
        }
