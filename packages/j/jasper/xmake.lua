package("jasper", function()
    ...
    add_urls(
        "https://github.com/jasper-software/jasper/archive/refs/tags/version-$(version).tar.gz")
    add_versions("2.0.28",
                 "6b4e5f682be0ab1a5acb0eeb6bf41d6ce17a658bb8e2dbda95de40100939cc88")
    add_versions("2.0.32",
                 "a3583a06698a6d6106f2fc413aa42d65d86bedf9a988d60e5cfa38bf72bc64b9")
    add_versions("2.0.33",
                 "38b8f74565ee9e7fec44657e69adb5c9b2a966ca5947ced5717cde18a7d2eca6")
    ...
    on_install("windows", "macosx", "linux", function(package)
        io.replace("build/cmake/modules/JasOpenGL.cmake", "find_package(GLUT",
                   "find_package(FreeGLUT", {plain = true})
        ...
        if vs_sdkver then
            ...
            assert(tonumber(build_ver) >= 18362,
                   "Jasper requires Windows SDK to be at least 10.0.18362.0")
        ...
        table.insert(configs, "-DJAS_ENABLE_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DJAS_ENABLE_OPENGL=" ..
    ...
    on_test(function(package)
        assert(package:has_cfuncs("jas_image_decode",
                                  {includes = "jasper/jasper.h"}))
    end)
end)
