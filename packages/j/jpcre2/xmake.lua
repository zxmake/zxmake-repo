package("jpcre2", function()
    ...
    add_urls(
        "https://github.com/jpcre2/jpcre2/archive/867af2d36413cf5f69c2e224f4f96f56f876d889.tar.gz",
        "https://github.com/jpcre2/jpcre2.git")

    add_versions("2021.06.15",
                 "8df87579bda9b56ff23eceafcd2a5604938e3e299e0206b88a8f4ee1ba29c0e3")
