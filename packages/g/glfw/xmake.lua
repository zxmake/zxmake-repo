package("glfw", function()
    ...
    add_versions("3.3.4",
                 "cc8ac1d024a0de5fd6f68c4133af77e1918261396319c24fd697775a6bc93b63")
    add_versions("3.3.5",
                 "32fdb8705784adfe3082f97e0d41e7c515963e977b5a14c467a887cf0da827b5")
    add_versions("3.3.6",
                 "ed07b90e334dcd39903e6288d90fa1ae0cf2d2119fec516cf743a0a404527c02")
    add_versions("3.3.7",
                 "fd21a5f65bcc0fc3c76e0f8865776e852de09ef6fbc3620e09ce96d2b2807e04")
    add_versions("3.3.8",
    ...
    add_configs("glfw_include", {
        ...
        default = "none",
        type = "string",
        values = {"none", "vulkan", "glu", "glext", "es2", "es3", "system"}
    })
    add_configs("x11", {
        description = "Build support for X11",
        default = is_plat("linux"),
        type = "boolean"
    })
    add_configs("wayland", {
        description = "Build support for Wayland",
        default = false,
        type = "boolean"
    })
    ...
    on_load(function(package)
        ...
        if package:config("x11") then
            package:add("deps", "libx11", "libxrandr", "libxrender",
                        "libxinerama", "libxfixes", "libxcursor", "libxi",
                        "libxext")
        end
    ...
    on_install("!wasm and !iphoneos", function(package)
        ...
        table.insert(configs, "-DGLFW_BUILD_X11=" ..
                         (package:config("x11") and "ON" or "OFF"))
        table.insert(configs, "-DGLFW_BUILD_WAYLAND=" ..
                         (package:config("wayland") and "ON" or "OFF"))
        if package:is_plat("linux") then
            import("package.tools.cmake").install(package, configs, {
                packagedeps = {
                    "libxrender", "libxfixes", "libxext", "libx11", "wayland"
                }
            })
        else
            import("package.tools.cmake").install(package, configs)
