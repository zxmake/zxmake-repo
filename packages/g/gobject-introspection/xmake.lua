package("gobject-introspection", function()
    ...
    add_urls(
        "https://download.gnome.org/sources/gobject-introspection/$(version).tar.xz",
        {
            version = function(version)
                return format("%d.%d/gobject-introspection-%s", version:major(),
                              version:minor(), version)
            end
        })
    add_versions("1.70.0",
                 "902b4906e3102d17aa2fcb6dad1c19971c70f2a82a159ddc4a94df73a3cafc4a")
    ...
    on_test(function(package)
        assert(package:has_cfuncs("g_irepository_get_default",
                                  {includes = "girepository.h"}))
    end)
end)
