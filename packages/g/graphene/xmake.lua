package("graphene", function()
    ...
    add_configs("gobject", {
        description = "Enable GObject types",
        default = true,
        type = "boolean"
    })
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        table.insert(configs, "-Dgobject_types=" ..
                         (package:config("gobject") and "true" or "false"))
    ...
    on_test(function(package)
        assert(package:has_cfuncs("graphene_matrix_alloc",
                                  {includes = "graphene.h"}))
    end)
end)
