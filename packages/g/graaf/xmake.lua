package("graaf", function()
    ...
    add_urls(
        "https://github.com/bobluppes/graaf/releases/download/$(version)/header-only.tar.gz",
        "https://github.com/bobluppes/graaf.git")

    add_versions("v1.1.1",
                 "86a95e14aa18f81ea31ec0764ef8b12d1fe42396da3be0046e0dbbb562fb3c89")
        ...
        on_check(function(package)
            assert(package:check_cxxsnippets({
                ...
                void test() {
                   ...
                   "package(graaf) Require at least C++20.")
        end)
    end
