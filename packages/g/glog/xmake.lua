package("glog", function()
    ...
    on_install(function(package)
        ...
        if package:version() and package:version():ge("0.7.0") then
            io.replace(
                path.join(package:installdir("include"), "glog/logging.h"),
    ...
    on_test(function(package)
        ...
        assert(package:has_cxxfuncs("google::InitGoogleLogging(\"glog\")", {
            includes = "glog/logging.h",
