package("gnu-gsl", function()
    ...
    if is_plat("windows") then
        add_patches("2.7.x",
                    path.join(os.scriptdir(), "patches", "configure.patch"),
                    "50fe9e6a4e68750fa2e21febf05471423cc7a0a38e59cf41d5009cd79352b2e6")
        add_patches("2.7.x", path.join(os.scriptdir(), "patches",
                                       "add_fp_control.patch"),
                    "6c6782327126ea979c5aceab3ee022b5ddc7d9d01c244774294572e73427ec4b")
    end
    ...
    on_install("windows", function(package)
        os.cp(path.join(os.scriptdir(), "cmake", "cmakelists.txt"),
              path.join(package:cachedir(), "source"))
        local configs = {}
