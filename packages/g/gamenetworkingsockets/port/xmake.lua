...
if has_config("webrtc") then
    ...
    local files = {
        ...
        "src/external/webrtc/api/proxy.cc", "src/external/webrtc/api/proxy.h",
        ...
        "src/external/webrtc/pc/channel.cc", "src/external/webrtc/pc/channel.h",
    ...
    if is_plat("windows") then
        add_files("src/external/webrtc/rtc_base/win32.cc",
                  "src/external/webrtc/rtc_base/synchronization/rw_lock_win.cc")
        add_headerfiles("src/external/webrtc/rtc_base/win32.h",
                        "src/external/webrtc/rtc_base/synchronization/rw_lock_win.h")
        on_config(function(target)
            io.writefile(
                "src/external/webrtc/base/third_party/libevent/event.h",
                "#pragma once\n#include <event.h>\n")
        end)
...
add_defines("STEAMNETWORKINGSOCKETS_CRYPTO_25519_OPENSSL",
            ...
            "GOOGLE_PROTOBUF_NO_RTTI", "VALVE_CRYPTO_25519_OPENSSL",
            "CRYPTO_DISABLE_ENCRYPT_WITH_PASSWORD", "ENABLE_OPENSSLCONNECTION")

add_includedirs("include", "src", "src/common", "src/tier0", "src/tier1",
                "src/vstdlib", "src/steamnetworkingsockets",
                "src/steamnetworkingsockets/clientlib", "src/public")
...
add_files("src/common/crypto_openssl.cpp",
          "src/common/crypto_25519_openssl.cpp", "src/common/opensslwrapper.cpp")
...
add_files("src/common/crypto.cpp", "src/common/crypto_textencode.cpp",
          "src/common/keypair.cpp", "src/common/steamid.cpp",
          "src/vstdlib/strtools.cpp", "src/tier0/dbg.cpp",
          "src/tier0/platformtime.cpp", "src/tier1/ipv6text.c",
          "src/tier1/netadr.cpp", "src/tier1/utlbuffer.cpp",
