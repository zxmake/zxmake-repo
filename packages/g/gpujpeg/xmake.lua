package("gpujpeg", function()
    ...
    add_urls(
        "https://github.com/CESNET/GPUJPEG/archive/refs/tags/$(version).tar.gz",
        "https://github.com/CESNET/GPUJPEG.git")
    add_versions("continuous",
                 "02be161bb8eca4479f186c700d96275784da200341b7dc67d60714e484af9cee")
