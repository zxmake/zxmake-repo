package("glm", function()
    set_homepage("https://glm.g-truc.net/")
    set_description("OpenGL Mathematics (GLM)")
    set_license("MIT")

    add_urls(
        "https://github.com/g-truc/glm/archive/refs/tags/$(version).tar.gz", {
    ...
    on_install(function(package)
        if not package:config("modules") then
            if package:config("header_only") then
                ...
                io.replace("CMakeLists.txt", "NOT GLM_DISABLE_AUTO_DETECTION",
                           "FALSE")
