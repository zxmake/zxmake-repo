package("geographiclib", function()
    ...
    add_urls(
        "https://sourceforge.net/projects/geographiclib/files/distrib-C++/GeographicLib-$(version).zip")
    add_versions("2.1.1",
                 "7887143ae2a6cae08f14f2018508d5a1636273f7f935b1a17d74b56b0252c341")
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "GeographicLib/Geodesic.hpp"
        }))
    end)
end)
