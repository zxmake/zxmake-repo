package("gfx-timsort", function()
    ...
    add_urls(
        "https://github.com/timsort/cpp-TimSort/archive/refs/tags/$(version).tar.gz",
        "https://github.com/timsort/cpp-TimSort.git")

    add_versions("v3.0.0",
                 "d61b92850996305e5248d1621c8ac437c31b474f74907e223019739e2e556b1f")
        ...
        on_check(function(package)
            if package:is_plat("android") then
                ...
                assert(ndk and tonumber(ndk) > 22,
                       "package(gfx-timsort) requires ndk version > 22")
            end
            ...
            assert(package:check_cxxsnippets({
                ...
                void test() {
                   ...
                   "package(gfx-timsort) Require at least C++20.")
        end)
    end
