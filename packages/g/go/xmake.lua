package("go", function()
    ...
    if is_host("windows") then
        ...
        elseif os.arch() == "arm64" then
            ...
            add_versions("1.22.6",
                         "7cf55f357ba8116cd3bff992980e20a704ba451b3dab341cf1787b133d900512")
            add_versions("1.22.7",
                         "9007bdda31f22176a8f686aa52c406e144e8e88f5133a8baddadd5129ede1165")
            add_versions("1.22.8",
                         "cede70578fa92664e9960b391174c520c8f9ad593adfa0d3bcab5e45f9180169")
            add_versions("1.23.0",
            ...
            add_versions("1.17.6",
                         "3809c4e40482ff047200c8b1e22a43a2c9c79b53ef540668d2b00f7228f093aa")
            add_versions("1.22.2",
            ...
            add_versions("1.22.7",
                         "5077c4a2c8a398817caa3178785abac5a93109173a488ae289d697544aac9cde")
            add_versions("1.22.8",
                         "94dfb97846276a214f72670be2f5604b7f0557057c9d5f522780fe266ffab9e9")
            add_versions("1.23.0",
            ...
            add_versions("1.23.2",
                         "eaa3bc377badbdcae144633f8b29bf2680475b72dcd4c135343d3bdc0ba7671e")
        end
    elseif is_host("linux") then
        if os.arch() == "x86_64" then
            ...
            add_versions("1.22.6",
                         "999805bed7d9039ec3da1a53bfbcafc13e367da52aa823cb60b68ba22d44c616")
            add_versions("1.22.7",
                         "fc5d49b7a5035f1f1b265c17aa86e9819e6dc9af8260ad61430ee7fbe27881bb")
            add_versions("1.22.8",
                         "5f467d29fc67c7ae6468cb6ad5b047a274bae8180cac5e0b7ddbfeba3e47e18f")
            add_versions("1.23.0",
                         "905a297f19ead44780548933e0ff1a1b86e8327bb459e92f9c0012569f76f5e3")
            add_versions("1.23.1",
                         "49bbb517cfa9eee677e1e7897f7cf9cfdbcf49e05f61984a2789136de359f9bd")
            add_versions("1.23.2",
        ...
        elseif os.arch() == "i386" then
            ...
            add_versions("1.17.6",
                         "06c50fb0d44bb03dd4ea8795f9448379c5825d2765307b51f66905084c3ba541")
            add_versions("1.22.2",
            ...
            add_versions("1.22.6",
                         "9e680027b058beab10ce5938607660964b6d2c564bf50bdb01aa090dc5beda98")
            add_versions("1.22.7",
                         "810e4d9f3f2f03b2f11471a9c7a32302968fc09d51f666cecacedb1055f2f873")
            add_versions("1.22.8",
                         "0c8e9f824bf443f51e06ac017b9ae402ea066d761b309d880dbb2ca5793db8a2")
            add_versions("1.23.0",
                         "0e8a7340c2632e6fb5088d60f95b52be1f8303143e04cd34e9b2314fafc24edd")
            add_versions("1.23.1",
                         "cdee2f4e2efa001f7ee75c90f2efc310b63346cfbba7b549987e9139527c6b17")
            add_versions("1.23.2",
        ...
        elseif os.arch() == "arm64" then
            ...
            add_versions("1.22.7",
                         "ed695684438facbd7e0f286c30b7bc2411cfc605516d8127dc25c62fe5b03885")
            add_versions("1.22.8",
                         "5c616b32dab04bb8c4c8700478381daea0174dc70083e4026321163879278a4a")
            add_versions("1.23.0",
                         "62788056693009bcf7020eedc778cdd1781941c6145eab7688bd087bce0f8659")
            add_versions("1.23.1",
                         "faec7f7f8ae53fda0f3d408f52182d942cc89ef5b7d3d9f23ff117437d4b2d2f")
            add_versions("1.23.2",
    ...
    elseif is_host("macosx") then
        if os.arch() == "x86_64" then
            ...
            add_versions("1.17.6",
                         "874bc6f95e07697380069a394a21e05576a18d60f4ba178646e1ebed8f8b1f89")
            add_versions("1.22.2",
            ...
            add_versions("1.22.6",
                         "9c3c0124b01b5365f73a1489649f78f971ecf84844ad9ca58fde133096ddb61b")
            add_versions("1.22.7",
                         "2c1b36bf4a21dabe3f23384c8228804c9af4c233de6250ec2e69249c25d15070")
            add_versions("1.22.8",
                         "ef0f7c1da5c8ac1eed0361381591a55effc90f9ca63b12cfd319f3f8ee113c12")
            add_versions("1.23.0",
                         "ffd070acf59f054e8691b838f274d540572db0bd09654af851e4e76ab88403dc")
            add_versions("1.23.1",
                         "488d9e4ca3e3ed513ee4edd91bef3a2360c65fa6d6be59cf79640bf840130a58")
            add_versions("1.23.2",
                         "445c0ef19d8692283f4c3a92052cc0568f5a048f4e546105f58e991d4aea54f5")
        elseif os.arch() == "arm64" then
            ...
            add_versions("1.22.6",
                         "ebac39fd44fc22feed1bb519af431c84c55776e39b30f4fd62930da9c0cfd1e3")
            add_versions("1.22.7",
                         "51a452563076950049da4857fb659437981ae70c7ec9bb0b0b2f1afc4dd66a9d")
            add_versions("1.22.8",
                         "725bd8491bc302af9e7188b259db2f14dae6be4fb4f31965be4f76c9af84ff45")
            add_versions("1.23.0",
                         "b770812aef17d7b2ea406588e2b97689e9557aac7e646fe76218b216e2c51406")
            add_versions("1.23.1",
                         "e223795ca340e285a760a6446ce57a74500b30e57469a4109961d36184d3c05a")
            add_versions("1.23.2",
                         "d87031194fe3e01abdcaf3c7302148ade97a7add6eac3fec26765bcb3207b80f")
        end
    end
