package("guetzli", function()

    set_homepage("https://github.com/google/guetzli")
    set_description("Perceptual JPEG encoder")

    add_urls(
        "https://github.com/google/guetzli/archive/refs/tags/$(version).tar.gz",
        "https://github.com/google/guetzli.git")

    add_versions("v1.0.1",
                 "e52eb417a5c0fb5a3b08a858c8d10fa797627ada5373e203c196162d6a313697")
