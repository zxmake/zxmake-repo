package("gmm", function()
    ...
    add_urls(
        "http://download-mirror.savannah.gnu.org/releases/getfem/stable/gmm-$(version).tar.gz")
    add_versions("5.4",
                 "7163d5080efbe6893d1950e4b331cd3e9160bb3dcf583d206920fba6af7b1e56")
