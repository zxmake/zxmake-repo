package("zpp_throwing", function()
    ...
    add_urls(
        "https://github.com/eyalz800/zpp_throwing/archive/refs/tags/$(version).tar.gz",
        "https://github.com/eyalz800/zpp_throwing.git")

    add_versions("v1.0.1",
                 "c15651ad36f9ddcb51e6244b0a78dbdebf7be8748b3e7ffe1c7339f0e41fd411")
