package("zlog", function()
    ...
    add_urls(
        "https://github.com/HardySimpson/zlog/archive/refs/tags/$(version).tar.gz",
        "https://github.com/HardySimpson/zlog.git")

    add_versions("1.2.18",
                 "3977dc8ea0069139816ec4025b320d9a7fc2035398775ea91429e83cb0d1ce4e")
    add_versions("1.2.17",
