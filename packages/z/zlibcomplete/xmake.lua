package("zlibcomplete", function()
    ...
    add_urls(
        "https://github.com/rudi-cilibrasi/zlibcomplete/archive/refs/tags/$(version).tar.gz",
        "https://github.com/rudi-cilibrasi/zlibcomplete.git")
    add_versions("1.0.5",
                 "2b263983823395eaabb091cb9b629eb8466fe24b929bba7ff6d833cadad11977")
