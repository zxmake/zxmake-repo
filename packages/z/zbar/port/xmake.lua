...
add_files("zbar/config.c", "zbar/error.c", "zbar/symbol.c", "zbar/image.c",
          "zbar/convert.c", "zbar/refcnt.c", "zbar/window.c", "zbar/video.c",
          "zbar/img_scanner.c", "zbar/scanner.c", "zbar/decoder.c",
          "zbar/misc.c", "zbar/sqcode.c")

local symbologies = {
    {name = "ean", files = {"zbar/decoder/ean.c"}},
...
if enabled_symbologies then
    for _, symbology in ipairs(symbologies) do
        if enabled_symbologies:find(symbology.name) or
            enabled_symbologies:find("all") then
