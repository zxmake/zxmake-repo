package("zfp", function()
    ...
    add_patches("0.5.5",
                path.join(os.scriptdir(), "patches", "0.5.5", "msvc.patch"),
                "5934c3fcd2abc64857c89c8dc16a2af855ab278e935e8a259bbcea89ddfe9a52")
    ...
    on_install("windows", "macosx", "linux", function(package)
        local configs = {
            "-DZFP_WITH_OPENMP=OFF", "-DBUILD_TESTING=OFF",
