package("fcl", function()
    ...
    add_urls(
        "https://github.com/flexible-collision-library/fcl/archive/refs/tags/$(version).tar.gz",
        "https://github.com/flexible-collision-library/fcl.git")
    add_versions("v0.6.1",
                 "c8a68de8d35a4a5cd563411e7577c0dc2c626aba1eef288cb1ca88561f8d8019")
    add_versions("0.7.0",
                 "90409e940b24045987506a6b239424a4222e2daf648c86dd146cbcb692ebdcbc")
    ...
    add_configs("octomap", {
        description = "Enable OctoMap library support.",
        default = false,
        type = "boolean"
    })
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        table.insert(configs, "-DFCL_STATIC_LIBRARY=" ..
                         (package:config("shared") and "OFF" or "ON"))
        table.insert(configs, "-DFCL_WITH_OCTOMAP=" ..
                         (package:config("octomap") and "ON" or "OFF"))
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "fcl/math/sampler/sampler_r.h"
        }))
    end)
end)
