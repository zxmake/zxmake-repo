package("fcpw", function()
    ...
    add_configs("enoki", {
        description = "Build enoki backend",
        default = false,
        type = "boolean"
    })
    add_configs("gpu", {
    ...
    on_install(function(package)
        ...
        if package:config("python") then
            ...
            table.insert(configs, "-DFCPW_USE_ENOKI=" ..
                             (package:config("enoki") and "ON" or "OFF"))
            table.insert(configs, "-DFCPW_ENABLE_GPU_SUPPORT=" ..
                             (package:config("gpu") and "ON" or "OFF"))
            table.insert(configs, "-DFCPW_BUILD_BINDINGS=" ..
