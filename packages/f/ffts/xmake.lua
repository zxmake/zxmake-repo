package("ffts", function()
    ...
    add_configs("neon", {
        description = "Enables the use of NEON instructions.",
        default = false,
        type = "boolean"
    })
    add_configs("vfp", {
        description = "Enables the use of VFP instructions.",
        default = false,
        type = "boolean"
    })
    ...
    on_install(function(package)
        -- remove test
        io.replace("CMakeLists.txt", "endif(ENABLE_STATIC OR ENABLE_SHARED)",
                   "endif(0)", {plain = true})
        io.replace("CMakeLists.txt", "if(ENABLE_STATIC OR ENABLE_SHARED)",
                   "if(0)", {plain = true})
        ...
        table.insert(configs, "-DENABLE_STATIC=" ..
        ...
        table.insert(configs, "-DENABLE_VFP=" ..
                         (package:config("vfp") and "ON" or "OFF"))
