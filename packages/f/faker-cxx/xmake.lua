package("faker-cxx", function()
    ...
    add_urls(
        "https://github.com/cieslarmichal/faker-cxx/archive/refs/tags/$(version).tar.gz",
        "https://github.com/cieslarmichal/faker-cxx.git")

    add_versions("v3.0.0",
                 "63d6846376593e05da690136cabe8e7bf42ddcdd4edad3ae9b48696f86d80468")
    add_versions("v2.0.0",
                 "8a7f5441f4453af868444675878a2d9a74918c1595caa65d537d3ea327e46a49")
        ...
        on_check(function(package)
            assert(package:check_cxxsnippets({
                ...
                void test() {
                   ...
                   "package(faker-cxx) Require at least C++20.")
        end)
    end

    on_install(function(package)
        local configs = {
            "-DBUILD_TESTING=OFF", "-DUSE_SYSTEM_DEPENDENCIES=ON",
            "-DUSE_STD_FORMAT=OFF"
        }
