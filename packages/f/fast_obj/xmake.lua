package("fast_obj", function()
    set_homepage("https://github.com/thisistherk/fast_obj")
    set_description("Fast C OBJ parser")
    set_license("MIT")

    add_urls(
        "https://github.com/thisistherk/fast_obj/archive/refs/tags/$(version).tar.gz",
        "https://github.com/thisistherk/fast_obj.git")

    add_versions("v1.3",
                 "f0f175edbe60db2099b3d8266ff0085b21862a17d9a1dc00fd195258c5b622b1")
