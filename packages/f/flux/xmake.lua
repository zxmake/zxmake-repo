package("flux", function()
    ...
    add_urls(
        "https://github.com/tcbrindle/flux/archive/refs/tags/$(version).tar.gz",
        "https://github.com/tcbrindle/flux.git")

    add_versions("v0.4.0",
                 "95e7d9d71c9ee9e89bb24b46ccba77ddfb0a1580630c2faab0b415dacc7c8d56")
    ...
    if on_check then
        on_check("android", function(package)
            ...
            assert(ndkver and tonumber(ndkver) > 22,
                   "package(flux) require ndk version > 22")
            assert(ndk_sdkver and tonumber(ndk_sdkver) >= 24,
                   "package(flux) require ndk api >= 24")
        end)
        ...
        on_check("windows", function(package)
            ...
            if vs_toolset then
                ...
                assert(minor and minor >= 30,
                       "package(flux) require vs_toolset >= 14.3")
            end
        end)
    end
