package("fmt", function()
    ...
    add_versions("11.0.2",
                 "40fc58bebcf38c759e11a7bd8fdc163507d2423ef5058bba7f26280c5b9c5465")
    add_versions("11.0.1",
    ...
    add_versions("10.2.0",
                 "8a942861a94f8461a280f823041cde8f620a6d8b0e0aacc98c15bb5a9dd92399")
    add_versions("10.1.1",
                 "b84e58a310c9b50196cda48d5678d5fa0849bca19e5fdba6b684f0ee93ed9d1b")
    add_versions("10.1.0",
                 "d725fa83a8b57a3cedf238828fa6b167f963041e8f9f7327649bddc68ae316f4")
    add_versions("10.0.0",
                 "4943cb165f3f587f26da834d3056ee8733c397e024145ca7d2a8a96bb71ac281")
    add_versions("9.1.0",
                 "cceb4cb9366e18a5742128cb3524ce5f50e88b476f1e54737a47ffdf4df4c996")
    add_versions("9.0.0",
    ...
    add_versions("8.0.0",
                 "36016a75dd6e0a9c1c7df5edb98c93a3e77dabcf122de364116efb9f23c6954a")
    add_versions("7.1.3",
                 "5d98c504d0205f912e22449ecdea776b78ce0bb096927334f80781e720084c9f")
    add_versions("6.2.0",
                 "a4468d528682143dcef2f16068104e03ef50467b0170b6125c9caf777d27bf10")
    add_versions("6.0.0",
                 "b4a16b38fa171f15dbfb958b02da9bbef2c482debadf64ac81ec61b5ac422440")
    add_versions("5.3.0",
                 "4c0741e10183f75d7d6f730b8708a99b329b2f942dad5a9da3385ab92bb4a15c")

    add_patches("10.1.0", "patches/10.1.0/utf8.patch",
    ...
    on_install(function(package)
        ...
        io.gsub("CMakeLists.txt",
                "MASTER_PROJECT AND CMAKE_GENERATOR MATCHES \"Visual Studio\"",
                "0")
        local configs = {
        ...
        table.insert(configs, "-DFMT_UNICODE=" ..
                         (package:config("unicode") and "ON" or "OFF"))
