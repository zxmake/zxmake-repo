package("faiss", function()
    ...
    add_urls(
        "https://github.com/facebookresearch/faiss/archive/refs/tags/$(version).tar.gz",
        "https://github.com/facebookresearch/faiss.git")
    add_versions("v1.7.0",
                 "f86d346ac9f409ee30abe37e52f6cce366b7f60d3924d65719f40aa07ceb4bec")
    ...
    on_install("windows|x64", "linux", function(package)
        io.replace("CMakeLists.txt", "add_subdirectory(demos)", "",
                   {plain = true})
        io.replace("CMakeLists.txt", "add_subdirectory(tutorial/cpp)", "",
                   {plain = true})
        ...
        table.insert(configs, "-DFAISS_ENABLE_GPU=" ..
                         (package:dep("cuda"):exists() and "ON" or "OFF"))
