package("fdk-aac", function()
    ...
    add_urls(
        "https://github.com/mstorsjo/fdk-aac/archive/refs/tags/v$(version).tar.gz",
        "https://github.com/mstorsjo/fdk-aac.git")
    add_versions("2.0.3",
                 "e25671cd96b10bad896aa42ab91a695a9e573395262baed4e4a2ff178d6a3a78")
    add_versions("2.0.0",
                 "6e6c7921713788e31df655911e1d42620b057180b00bf16874f5d630e1d5b9a2")
    add_versions("2.0.1",
    ...
    on_install(function(package)
        ...
        if package:is_plat("android") then
            io.replace("libSBRdec/src/lpp_tran.cpp", "#ifdef __ANDROID__",
                       "#if 0")
        end
    ...
    on_test(function(package)
        assert(package:has_cfuncs("aacEncOpen",
                                  {includes = "fdk-aac/aacenc_lib.h"}))
    end)
end)
