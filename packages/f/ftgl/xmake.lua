package("ftgl", function()
    ...
    add_urls(
        "https://github.com/frankheckenbach/ftgl/archive/refs/tags/$(version).tar.gz")
    add_versions("v2.4.0",
                 "aa97da1c3442a8fd3941037655df18016d70b5266381c81d81e8b5335f196ea8")

    add_patches("v2.4.0",
                path.join(os.scriptdir(), "patches", "2.4.0", "cmake.patch"),
                "9006ccfba2632c5ffee50c76f163a98d9867a3e11c6390c14ed07ab401a85f29")
