package("fribidi", function()
    ...
    add_versions("1.0.15",
                 "0bbc7ff633bfa208ae32d7e369cf5a7d20d5d2557a0b067c9aa98bcbf9967587")
    add_versions("1.0.14",
    ...
    on_install("windows|x86", "windows|x64", "mingw", "msys", "wasm", "cross",
               function(package)
    ...
    on_test(function(package)
        assert(package:has_cfuncs("fribidi_debug_status",
                                  {includes = "fribidi/fribidi-common.h"}))
    end)
end)
