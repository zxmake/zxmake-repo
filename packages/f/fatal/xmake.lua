package("fatal", function()
    ...
    add_urls(
        "https://github.com/facebook/fatal/releases/download/v$(version).00/fatal-v$(version).00.zip",
        "https://github.com/facebook/fatal.git")

    add_versions("2024.06.24",
                 "9b134c46eec2a1fc38cfbfef13de11f7b252ded6d789d2460956d43b89719a8b")
