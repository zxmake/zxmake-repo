package("ndk", function()
    ...
    if is_host("windows") then
        ...
        set_urls(
            "https://dl.google.com/android/repository/android-ndk-$(version).zip",
            {
        ...
        add_versions("21.0",
                     "f71307c5c572e2c163d602b3704b8bc024bec0c43ba2800de36bd10f3a21492b")
        add_versions("22.0",
    ...
    elseif is_host("macosx") then
        ...
        add_versions("26.0",
                     "4b0ea6148a9a2337e62a0c0c7ac59ff1edc38d69b81d9c58251897d23f7fa321")
    end
    ...
    on_fetch(function(package, opt)
        if opt.system then
            ...
            local ndk = find_ndk()
            if ndk and ndk.ndkver and
                semver.satisfies(ndk.ndkver .. ".0", opt.require_version) then
                return true
            end
        end
    end)
    ...
    on_test(function(package)
        ...
        os.vrunv(path.join(package:installdir(), "toolchains/llvm/prebuilt",
                           host .. "-x86_64", "bin/clang"), {"--version"})
    end)
end)
