package("newtondynamics", function()
    ...
    on_load(function(package)
        wprint(
            "newtondynamics package has been renamed to newtondynamics3 due to release of v4, please update your dependency to newtondynamics3 or newtondynamics4")
    ...
    on_install("windows", "linux", "macosx", "mingw", function(package)
        ...
        if not package:config("shared") and package:is_plat("linux", "android") and
            package:config("pic") ~= false then
