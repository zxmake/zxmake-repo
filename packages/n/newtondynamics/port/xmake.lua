...
add_includedirs("sdk", "sdk/dgCore", "sdk/dgMeshUtil", "sdk/dgPhysics",
                "sdk/dgNewton")
...
before_install(function(package)
    local targetHeader = path.join(package:installdir(), "include", "newton",
                                   "Newton.h")
    os.vcp("sdk/dgNewton/Newton.h",
           path.join(package:installdir(), "include", "newton", "Newton.h"))
end)
