package("nim", function()
    ...
    if is_host("windows") then
        if os.arch() == "x86" then
            ...
            add_versions("2.0.2",
                         "d076d35fdab29baf83c66f1135a1fd607eb61d4c14037706f7be3ba58fb83d87")
            precompiled = true
        elseif os.arch() == "x64" then
            add_urls("https://nim-lang.org/download/nim-$(version)_x64.zip")
            add_versions("2.0.2",
                         "948dbf8e3fdd1b5242e3d662fd25c50e9b2586e097be8a85c22d7db2bde70bad")
            precompiled = true
        end
    end
    if not precompiled then
        add_urls(
            "https://github.com/nim-lang/Nim/archive/refs/tags/v$(version).tar.gz")
        add_versions("2.0.2",
                     "2ca2f559d05e29f130cb4f319ebb93a98e7c0e2187716b17b2cb4e747f5ff798")
    end
