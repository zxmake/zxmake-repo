package("ninja", function()
    ...
    if is_host("windows") then
        ...
        add_versions("1.11.1",
                     "524b344a1a9a55005eaf868d991e090ab8ce07fa109f1820d40e74642e289abc")
    elseif is_host("macosx") then
        ...
        add_versions("1.10.1",
                     "0bd650190d4405c15894055e349d9b59d5690b0389551d757c5ed2d3841972d1")
        add_versions("1.10.2",
    ...
    on_load("linux", "bsd", function(package)
        package:add("deps",
                    package:version():ge("1.10.0") and "python" or "python2",
                    {kind = "binary"})
    end)
