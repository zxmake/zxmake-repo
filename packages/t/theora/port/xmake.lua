...
target("theoraenc")
add_files("lib/apiwrapper.c", "lib/fragment.c", "lib/idct.c", "lib/internal.c",
          "lib/info.c", "lib/state.c", "lib/quant.c", "lib/analyze.c",
          "lib/encfrag.c", "lib/encapiwrapper.c", "lib/encinfo.c",
          "lib/encode.c", "lib/enquant.c", "lib/fdct.c", "lib/huffenc.c",
          "lib/mathops.c", "lib/mcenc.c", "lib/rate.c", "lib/tokenize.c")
...
target("theoradec")
add_files("lib/apiwrapper.c", "lib/bitpack.c", "lib/decapiwrapper.c",
          "lib/decinfo.c", "lib/decode.c", "lib/dequant.c", "lib/fragment.c",
          "lib/huffdec.c", "lib/idct.c", "lib/info.c", "lib/internal.c",
