package("tl_function_ref", function()
    ...
    set_urls(
        "https://github.com/TartanLlama/function_ref/archive/$(version).zip",
        "https://github.com/TartanLlama/function_ref.git")

    add_versions("v1.0.0",
                 "b3161fddbf40b41be984d5649ad6b5790ecebd0388f9db51b3160ecd006963f4")
