package("thrust", function()
    ...
    add_urls(
        "https://github.com/NVIDIA/thrust/archive/refs/tags/$(version).tar.gz",
        "https://github.com/NVIDIA/thrust.git")
    add_versions("1.17.0",
                 "b02aca5d2325e9128ed9d46785b8e72366f758b873b95001f905f22afcf31bbf")
