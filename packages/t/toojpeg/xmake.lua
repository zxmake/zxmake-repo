package("toojpeg", function()
    ...
    add_urls(
        "https://github.com/stbrumme/toojpeg/archive/refs/tags/toojpeg_v$(version).zip",
        "https://github.com/stbrumme/toojpeg.git")
    add_versions("1.5",
                 "ff2a8a9d89c1ec34328a0f9e09530e98b22df93644ca6c19e005842dd812976b")

    add_configs("shared", {
        description = "Build share library.",
        default = false,
        type = "boolean",
        readonly = true
    })
