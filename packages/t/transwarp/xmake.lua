package("transwarp", function()
    ...
    add_urls(
        "https://github.com/bloomen/transwarp/archive/refs/tags/$(version).zip")
    add_versions("2.2.3",
                 "41c45e1131233fed24ded3e5e49ec412e97b76bdeaf3bd7259a7c8c8f2f7189a")
