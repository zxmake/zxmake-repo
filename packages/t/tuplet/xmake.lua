package("tuplet", function()
    ...
    add_urls(
        "https://github.com/codeinred/tuplet/archive/refs/tags/$(version).tar.gz",
        "https://github.com/codeinred/tuplet.git")
    add_versions("v2.1.1",
                 "2df403ffeed38a9687a3f2a7d2a68419ba029f519244e9bcd30caa0e8ec2ead3")
