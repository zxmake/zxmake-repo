package("tidy-html5", function()
    ...
    on_install(function(package)
        ...
        local configs = {
            "-DBUILD_TAB2SPACE=OFF", "-DSUPPORT_CONSOLE_APP=OFF",
            "-DCMAKE_POLICY_DEFAULT_CMP0057=NEW"
        }
        table.insert(configs, "-DCMAKE_BUILD_TYPE=" ..
                         (package:is_debug() and "Debug" or "Release"))
        table.insert(configs, "-DENABLE_DEBUG_LOG=" ..
                         (package:is_debug() and "ON" or "OFF"))
        table.insert(configs, "-DENABLE_ALLOC_DEBUG=" ..
                         (package:is_debug() and "ON" or "OFF"))
        table.insert(configs, "-DENABLE_MEMORY_DEBUG=" ..
                         (package:is_debug() and "ON" or "OFF"))
        table.insert(configs, "-DBUILD_SHARED_LIB=" ..
