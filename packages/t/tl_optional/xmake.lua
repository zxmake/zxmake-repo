package("tl_optional", function()

    set_kind("library", {headeronly = true})
    set_homepage("https://github.com/TartanLlama/optional")
    set_description(
        "C++11/14/17 std::optional with functional-style extensions and support for references.")
    set_license("CC0")

    set_urls(
        "https://github.com/TartanLlama/optional/archive/refs/tags/$(version).zip",
