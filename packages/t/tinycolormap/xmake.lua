package("tinycolormap", function()
    ...
    add_urls(
        "https://github.com/yuki-koyama/tinycolormap/archive/refs/tags/$(version).tar.gz",
        "https://github.com/yuki-koyama/tinycolormap.git")

    add_versions("v0.7.0",
                 "5e03b6c35c658aa7273ca6fb38ef9df06f885a2429191059c8770d5ff8b65951")
