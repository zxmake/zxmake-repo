package("tinydir", function()
    ...
    add_urls(
        "https://github.com/cxong/tinydir/archive/refs/tags/$(version).tar.gz",
        "https://github.com/cxong/tinydir.git")

    add_versions("1.2.6",
                 "1ecbdf8d04b079f8a9404662708d2333d6b72b956effb0d5296d063db3a02b4e")
