package("tabulate", function()
    ...
    add_urls(
        "https://github.com/p-ranav/tabulate/archive/refs/tags/$(version).tar.gz",
        "https://github.com/p-ranav/tabulate.git")

    add_versions("v1.5",
                 "16b289f46306283544bb593f4601e80d6ea51248fde52e910cc569ef08eba3fb")
