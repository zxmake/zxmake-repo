package("yaml_cpp_struct", function()
    ...
    add_urls(
        "https://github.com/fantasy-peak/yaml_cpp_struct/archive/refs/tags/$(version).tar.gz",
        "https://github.com/fantasy-peak/yaml_cpp_struct.git")
    add_versions('v1.0.2',
                 '7635bb968690f97f9be420e42de2120b1101f0ab20173ddec8d24b5de16f25e5')
