package("async_simple", function()
    ...
    add_versions("1.1",
                 "32d1ea16dfc1741206b6e4a3fbe532eeb1c378619766c1abe11a9efc53109c10")
    add_versions("1.2",
                 "a59a2674ac2b0a3997b90873b2bf0fbe4d96fdedbe6a2628c16c92a65a3fa39a")
    add_versions("1.3",
                 "0ba0dc3397882611b538d04b8ee6668b1a04ce046128599205184c598b718743")

    add_configs("aio", {
        description = "default not open aio",
        default = false,
        type = "boolean"
    })
    add_configs("modules", {
        description = "default not use modules",
        default = false,
        type = "boolean"
    })
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DASYNC_SIMPLE_DISABLE_AIO=" ..
                         (package:config("aio") and "OFF" or "ON"))
        table.insert(configs, "-DASYNC_SIMPLE_BUILD_MODULES=" ..
                         (package:config("modules") and "ON" or "OFF"))
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = {
                "async_simple/coro/Lazy.h", "async_simple/coro/SyncAwait.h"
            }
        }))
    end)
end)
