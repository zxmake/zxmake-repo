package("attr", function()
    ...
    add_urls(
        "https://github.com/xmake-mirror/attr/releases/download/v$(version)/attr-$(version).tar.gz",
    ...
    on_test(function(package)
        assert(package:has_cfuncs("attr_copy_file",
                                  {includes = "attr/libattr.h"}))
    end)
end)
