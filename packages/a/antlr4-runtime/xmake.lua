package("antlr4-runtime", function()
    ...
    add_urls(
        "https://github.com/antlr/antlr4/archive/refs/tags/$(version).tar.gz",
        "https://github.com/antlr/antlr4.git")

    add_versions("4.13.2",
                 "9f18272a9b32b622835a3365f850dd1063d60f5045fb1e12ce475ae6e18a35bb")
    add_versions("4.13.1",
                 "da20d487524d7f0a8b13f73a8dc326de7fc2e5775f5a49693c0a4e59c6b1410c")
    ...
    on_install(function(package)
        ...
        table.insert(configs, "-DANTLR_BUILD_SHARED=" ..
                         (package:config("shared") and "ON" or "OFF"))
        table.insert(configs, "-DANTLR_BUILD_STATIC=" ..
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "antlr4-runtime/antlr4-runtime.h"
        }))
    end)
end)
