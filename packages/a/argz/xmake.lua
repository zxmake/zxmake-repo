package("argz", function()
    ...
    add_urls(
        "https://github.com/stephenberry/argz/archive/refs/tags/$(version).tar.gz",
        "https://github.com/stephenberry/argz.git")

    add_versions("v0.2.1",
                 "1a9d85ef7e4722f81ce426c2cf8ceaa0a10cc42e7762cdf2465ae6484ece9c7e")
    ...
    on_install(function(package)
        if package:has_tool("cxx", "cl") then
            package:add("cxxflags", "/Zc:preprocessor", "/GL", "/permissive-",
                        "/Zc:lambda")
        end
        io.replace("CMakeLists.txt", "include(cmake/dev-mode.cmake)", "",
                   {plain = true})
