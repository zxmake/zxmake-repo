package("angelscript", function()
    ...
    add_urls(
        "http://angelcode.com/angelscript/sdk/files/angelscript_$(version).zip")
    ...
    add_versions("2.35.1",
                 "5c1096b6d6cf50c7e77ae93c736d35b69b07b1e5047161c7816bca25b413a18b")
    add_versions("2.35.0",
                 "010dd45e23e734d46f5891d70e268607a12cb9ab12503dda42f842d9db7e8857")
    add_versions("2.34.0",
    ...
    if on_check then
        on_check("mingw", function(package)
            if is_host("macosx") and package:is_arch("i386") and
                package:version():eq("2.37.0") then
                assert(false,
                       "package(angelscript 2.37.0): Unsupported version on mingw|i386")
            end
        end)
    end

    on_load("windows|x86", "windows|x64", "linux", "android", "msys", "mingw",
            function(package)
        package:add("deps", "cmake")
    end)

    on_install("windows|x86", "windows|x64", "linux", "android", "msys",
        ...
        table.insert(configs, "-DAS_NO_EXCEPTIONS=" ..
