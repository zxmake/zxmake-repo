package("abseil", function()
    ...
    on_install(function(package)
        if package:version() and package:version():eq("20230802.1") and
            package:is_plat("mingw") then
            io.replace(path.join("absl", "synchronization", "internal",
                                 "pthread_waiter.h"), "#ifndef _WIN32",
