package("angle", function()
    ...
    add_urls(
        "https://github.com/google/angle/archive/refs/heads/chromium/$(version).zip")
    add_versions("6288",
                 "0d3bcf5bfd9eecd2b1635a6220a18f52a27ae5823928d4b6b083c54c163f963b")

    add_resources(">=6288", "chromium_zlib",
                  "https://github.com/xmake-mirror/chromium_zlib.git",
    ...
    if is_plat("windows") then
        ...
        if is_plat("macosx") then
            add_syslinks("objc")
            add_frameworks("CoreFoundation", "CoreGraphics", "IOKit", "Metal",
                           "IOSurface", "QuartzCore", "Cocoa")
        end
    ...
    on_install("windows", "macosx", "linux", function(package)
        ...
        os.cp(path.join(os.scriptdir(), "port", package:version_str(),
                        "xmake.lua"), "xmake.lua")
