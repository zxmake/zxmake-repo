...
angle_define_option("enable_gl_desktop",
                    {default = is_plat("windows", "macosx", "linux")})
...
local libangle_common_sources = {
    "src/common/Float16ToFloat32.cpp", "src/common/MemoryBuffer.cpp",
    "src/common/PackedEGLEnums_autogen.cpp", "src/common/PackedEnums.cpp",
    "src/common/PackedGLEnums_autogen.cpp", "src/common/PoolAlloc.cpp",
    "src/common/RingBufferAllocator.cpp", "src/common/WorkerThread.cpp",
    "src/common/aligned_memory.cpp", "src/common/android_util.cpp",
    "src/common/angleutils.cpp", "src/common/base/anglebase/sha1.cc",
    "src/common/debug.cpp", "src/common/entry_points_enum_autogen.cpp",
    "src/common/event_tracer.cpp", "src/common/mathutil.cpp",
    "src/common/matrix_utils.cpp", "src/common/platform_helpers.cpp",
    "src/common/string_utils.cpp", "src/common/system_utils.cpp",
    "src/common/tls.cpp", "src/common/uniform_type_info_autogen.cpp",
    "src/common/utilities.cpp"
}
if is_plat("android") then
    table.join2(libangle_common_sources,
                "src/common/backtrace_utils_android.cpp")
else
...
if is_plat("macosx", "iphoneos") then
    table.join2(libangle_common_sources, {
        ...
        "src/common/system_utils_apple.cpp", "src/common/system_utils_posix.cpp"
    })
...
local libangle_common_cl_sources = {"src/common/PackedCLEnums_autogen.cpp"}
local xxhash_sources = {"src/common/third_party/xxhash/xxhash.c"}
local libangle_image_util_sources = {
    "src/image_util/copyimage.cpp", "src/image_util/imageformats.cpp",
    "src/image_util/loadimage.cpp", "src/image_util/loadimage_astc.cpp",
    "src/image_util/loadimage_etc.cpp", "src/image_util/loadimage_paletted.cpp",
    "src/image_util/storeimage_paletted.cpp", -- no astc encoder
    "src/image_util/AstcDecompressorNoOp.cpp"
}
local libangle_gpu_info_util_sources = {"src/gpu_info_util/SystemInfo.cpp"}
local libangle_gpu_info_util_win_sources = {
    "src/gpu_info_util/SystemInfo_win.cpp"
}
local libangle_gpu_info_util_android_sources = {
    "src/gpu_info_util/SystemInfo_android.cpp"
}
local libangle_gpu_info_util_linux_sources = {
    "src/gpu_info_util/SystemInfo_linux.cpp"
}
local libangle_gpu_info_util_vulkan_sources = {
    "src/gpu_info_util/SystemInfo_vulkan.cpp"
}
local libangle_gpu_info_util_libpci_sources = {
    "src/gpu_info_util/SystemInfo_libpci.cpp"
}
local libangle_gpu_info_util_x11_sources = {
...
local libangle_sources = {
    "src/libANGLE/AttributeMap.cpp", "src/libANGLE/BlobCache.cpp",
    "src/libANGLE/Buffer.cpp", "src/libANGLE/Caps.cpp",
    "src/libANGLE/Compiler.cpp", "src/libANGLE/Config.cpp",
    "src/libANGLE/Context.cpp", "src/libANGLE/ContextMutex.cpp",
    "src/libANGLE/Context_gles_1_0.cpp", "src/libANGLE/Debug.cpp",
    "src/libANGLE/Device.cpp", "src/libANGLE/Display.cpp",
    "src/libANGLE/EGLSync.cpp", "src/libANGLE/Error.cpp",
    "src/libANGLE/Fence.cpp", "src/libANGLE/Framebuffer.cpp",
    "src/libANGLE/FramebufferAttachment.cpp", "src/libANGLE/GLES1Renderer.cpp",
    "src/libANGLE/GLES1State.cpp", "src/libANGLE/GlobalMutex.cpp",
    "src/libANGLE/HandleAllocator.cpp", "src/libANGLE/Image.cpp",
    "src/libANGLE/ImageIndex.cpp", "src/libANGLE/IndexRangeCache.cpp",
    "src/libANGLE/LoggingAnnotator.cpp", "src/libANGLE/MemoryObject.cpp",
    "src/libANGLE/MemoryProgramCache.cpp", "src/libANGLE/MemoryShaderCache.cpp",
    "src/libANGLE/Observer.cpp", "src/libANGLE/Overlay.cpp",
    "src/libANGLE/OverlayWidgets.cpp", "src/libANGLE/Overlay_autogen.cpp",
    "src/libANGLE/Overlay_font_autogen.cpp",
    "src/libANGLE/PixelLocalStorage.cpp", "src/libANGLE/Platform.cpp",
    "src/libANGLE/Program.cpp", "src/libANGLE/ProgramExecutable.cpp",
    "src/libANGLE/ProgramLinkedResources.cpp",
    "src/libANGLE/ProgramPipeline.cpp", "src/libANGLE/Query.cpp",
    "src/libANGLE/Renderbuffer.cpp", "src/libANGLE/ResourceManager.cpp",
    "src/libANGLE/Sampler.cpp", "src/libANGLE/Semaphore.cpp",
    "src/libANGLE/Shader.cpp", "src/libANGLE/ShareGroup.cpp",
    "src/libANGLE/State.cpp", "src/libANGLE/Stream.cpp",
    "src/libANGLE/Surface.cpp", "src/libANGLE/Texture.cpp",
    "src/libANGLE/Thread.cpp", "src/libANGLE/TransformFeedback.cpp",
    "src/libANGLE/Uniform.cpp", "src/libANGLE/VaryingPacking.cpp",
    "src/libANGLE/VertexArray.cpp", "src/libANGLE/VertexAttribute.cpp",
    "src/libANGLE/angletypes.cpp", "src/libANGLE/context_private_call_gles.cpp",
    "src/libANGLE/es3_copy_conversion_table_autogen.cpp",
    "src/libANGLE/format_map_autogen.cpp",
    "src/libANGLE/format_map_desktop.cpp", "src/libANGLE/formatutils.cpp",
    "src/libANGLE/gles_extensions_autogen.cpp",
    "src/libANGLE/queryconversions.cpp", "src/libANGLE/queryutils.cpp",
    ...
    "src/libANGLE/validationEGL.cpp", "src/libANGLE/validationES.cpp",
    "src/libANGLE/validationES1.cpp", "src/libANGLE/validationES2.cpp",
    "src/libANGLE/validationES3.cpp", "src/libANGLE/validationES31.cpp",
    "src/libANGLE/validationES32.cpp", "src/libANGLE/validationESEXT.cpp"
}
local libangle_gl_sources = {
    "src/libANGLE/Context_gl.cpp", "src/libANGLE/context_private_call_gl.cpp",
    "src/libANGLE/validationGL1.cpp", "src/libANGLE/validationGL2.cpp",
    "src/libANGLE/validationGL3.cpp", "src/libANGLE/validationGL4.cpp"
}
local libangle_cl_sources = {
    "src/libANGLE/CLBuffer.cpp", "src/libANGLE/CLCommandQueue.cpp",
    "src/libANGLE/CLContext.cpp", "src/libANGLE/CLDevice.cpp",
    "src/libANGLE/CLEvent.cpp", "src/libANGLE/CLImage.cpp",
    "src/libANGLE/CLKernel.cpp", "src/libANGLE/CLMemory.cpp",
    "src/libANGLE/CLObject.cpp", "src/libANGLE/CLPlatform.cpp",
    "src/libANGLE/CLProgram.cpp", "src/libANGLE/CLSampler.cpp",
    "src/libANGLE/cl_utils.cpp", "src/libANGLE/renderer/CLCommandQueueImpl.cpp",
    ...
    "src/libANGLE/renderer/CLSamplerImpl.cpp", "src/libANGLE/validationCL.cpp"
}
local libangle_mac_sources = {"src/libANGLE/renderer/driver_utils_mac.mm"}
...
local libglesv2_sources = {
    "src/libGLESv2/egl_ext_stubs.cpp", "src/libGLESv2/egl_stubs.cpp",
    ...
    "src/libGLESv2/global_state.cpp", "src/libGLESv2/libGLESv2_autogen.cpp",
...
local angle_gl_enum_utils = {
    "src/common/gl_enum_utils.cpp", "src/common/gl_enum_utils_autogen.cpp"
}

if is_kind("static") then
    add_defines({
        "ANGLE_EXPORT=", "ANGLE_STATIC=1", "ANGLE_UTIL_EXPORT=", "EGLAPI=",
        "GL_APICALL=", "GL_API="
    })
end
...
add_includedirs("src/common/base", "src/common/third_party/xxhash",
                "src/third_party/khronos", "third_party/zlib/google",
                {public = true})
...
if is_plat("windows") then
    ...
    if has_config("enable_d3d9") or has_config("enable_d3d11") or
        has_config("enable_gl") then
...
before_build(function(target)
    ...
    if option.get("verbose") then
        print(python.program .. " " .. "./src/commit_id.py gen " .. buildir ..
                  "/gen/angle/angle_commit.h")
    end
    os.vrunv(python.program, {
        "./src/commit_id.py", "gen", buildir .. "/gen/angle/angle_commit.h"
    })
    if option.get("verbose") then
        print(python.program .. " " .. "./src/commit_id.py gen " .. buildir ..
                  "/gen/angle/angle_commit_autogen.cpp")
    end
    os.vrunv(python.program, {
        "./src/program_serialize_data_version.py",
        buildir .. "/gen/angle/ANGLEShaderProgramVersion.h",
        buildir .. "/gen/response"
    })
    if option.get("verbose") then
...
add_defines("GL_GLES_PROTOTYPES=1", "EGL_EGL_PROTOTYPES=1",
...
if is_kind("shared") then
    if is_plat("windows") then
        ...
        add_defines("GL_APICALL=__attribute__((visibility(\"default\")))",
                    "GL_API=__attribute__((visibility(\"default\")))")
    end
end
after_install(function(target)
    if target:is_plat("windows") and target:kind() == "shared" then
        local vcvars = import("core.tool.toolchain").load("msvc"):config(
                           "vcvars")
        local winsdkdir = vcvars["WindowsSdkDir"]
        local d3dcompiler = path.join(winsdkdir, "Redist", "D3D", target:arch(),
                                      "d3dcompiler_47.dll")
