package("agg", function()
    ...
    add_urls(
        "https://github.com/aggeom/agg-2.6/archive/refs/tags/agg-$(version).zip",
        "https://github.com/aggeom/agg-2.6.git")
    add_versions("2.7.1",
                 "d7b86cdf55282e798aba43194a87705ad30ba950b5723144524e08fe8477db80")
    ...
    add_configs("freetype", {
        description = "Use Freetype library.",
        default = false,
        type = "boolean",
        readonly = true
    })
    ...
    on_install("windows", "macosx", "linux", "mingw", function(package)
        ...
        table.insert(configs, "-Dagg_USE_FREETYPE=" ..
    ...
    on_test(function(package)
        assert(package:check_cxxsnippets({
            ...
            includes = "agg/agg_rasterizer_scanline_aa.h"
        }))
    end)
end)
