package("atk", function()
    set_homepage("https://gitlab.gnome.org/GNOME/atk")
    set_description("ATK - The Accessibility Toolkit")
    set_license("LGPL-2.0")

    add_urls(
        "https://gitlab.gnome.org/Archive/atk/-/archive/$(version)/atk-$(version).tar.bz2",
        "https://gitlab.gnome.org/Archive/atk.git")

    add_versions("2.38.0",
                 "469313d28bd22bcbf7b7ea300dddb9b6c13854455d297f4d51a944e378b0a9d7")
    ...
    on_install("windows", "macosx", "linux", "cross", function(package)
        ...
        table.insert(configs, "-Dintrospection=" ..
                         (package:config("introspection") and "true" or "false"))
