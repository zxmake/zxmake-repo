package("automake", function()
    ...
    add_versions("1.16.4",
                 "8a0f0be7aaae2efa3a68482af28e5872d8830b9813a6a932a2571eac63ca1794")
    add_versions("1.16.1",
    ...
    add_versions("1.9.6",
                 "e6d3030dd3f7a07ee2075da5f77864a3cc3e78c5bf76bb48df23dbe3d6ba13b9")
    add_versions("1.9.5",
                 "68712753fcb756f3707b7da554917afb348450eb8530cae3b623a067078596fd")
    ...
    on_install("@macosx", "@linux", "@bsd", function(package)
        ...
        io.writefile(
            path.join(package:installdir("share", "aclocal"), "dirlist"), [[
